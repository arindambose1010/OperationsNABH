		...
		if(patientId !=null && !"".equalsIgnoreCase(patientId))
			{
				try
					{
						StringBuffer query=new StringBuffer();
						query.append("select ecd.crtDt as CRTDT,ecd.ahcId as ID,ecd.sno as COUNT, ecd.consultationSpec as UNITTYPE, ecd.consultDoctor as UNITNAME, ecd.remarks as REMARKS, ecd.consultFilePath as PATH from EhfAhcConsultationDtls ecd where ecd.ahcId = '"+patientId+"' order by ecd.crtDt " );
