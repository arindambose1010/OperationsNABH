...
public class ClaimsConstants {
    ...
    public static final String EO_TG_ADMIN_USER_ID= "USR96721";
    ...
    public static final String MITHRA_GRP="GP1";
    public static final String MEDCO_GRP="GP2";
	...
	public static final String DATAOP="GP789";
	public static final String REFDOC="GP790";
	public static final String AYURVEDA_DOC="GP791";
	public static final String HOMEOPATHY_DOC="GP792";
	public static final String UNANI_DOC="GP793";
	...
	public static final String NOT_Auth_MSG = "Claim not initiated for this case";
	...
	public static final String CLAIM_SP_HOSP_SUSPENSION_MSG="Claims process and Payments have been blocked as the hospital is subjected to stop payments";
	...
	public static final String[] followUpStatus={"CD62","CD63","CD64","CD65","CD66","CD67","CD68","CD69","CD70","CD104","CD105","CD106","CD107","CD131","CD132","CD511","CD512","CD513","CD514","CD520","CD523"};
	...
	public static final String[] followUpStatuesCH = {"CD106","CD65"};
	...
	//Preauth Surgical Constants
	public static final String PREAUTH_SURGICAL="S";
	public static final String KNEE_REPLACEMENT_CODE="TKR";
	public static final String HIP_REPLACEMENT_CODE="THR";
	...
	public static final String[] holdSentBackStatuses= {"CD5241","CD5242","CD5243"};
