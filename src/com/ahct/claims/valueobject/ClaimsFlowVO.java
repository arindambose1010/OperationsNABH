...
public class ClaimsFlowVO implements Serializable {	
	...
	private Double claimInitiatedAmt;
	...
	private List<LabelBean> cexVerifiedDtls = null;
	private List<LabelBean> drugDetails = null;
	private Number totalConsumableAmount;
	private Number cexVerifiedTotConsAmt;
	private Number totalDrugAmt;
	private String sennBackRole;
	private double dedctedAmount;
	private double claimableAmt;
	private double actualClamt;
	private String emailToHosp;
	private String emailId;
	private String cmsRiseFlag;
	private String cmsRemarks;
	private String cmsEORemarks;
	private String cmsId;
	private String crDesc;
	private List<ClaimsFlowVO> attachlist;
    ...
    private String claimPanelRemarkOrg;
	    ...
	    private String surgFlg;
	
	
	public String getSurgFlg() {
			return surgFlg;
		}

		public void setSurgFlg(String surgFlg) {
			this.surgFlg = surgFlg;
		}
	...
	private String CR_REMARKS;
	private String CR_ACTION_TAKEN;
	private String EMP_FULL_NAME;
	private String REMARKS_ENTRYTIME;
	private String DSGN_NAME;
	private String EMPCODE;
	private String PHONE_NUMBER;
	private String ATTACH_EXISTS;
	private Number LINEITEMNO;
	public String getCR_REMARKS() {
		return CR_REMARKS;
	}

	public void setCR_REMARKS(String cR_REMARKS) {
		CR_REMARKS = cR_REMARKS;
	}

	public String getCR_ACTION_TAKEN() {
		return CR_ACTION_TAKEN;
	}

	public void setCR_ACTION_TAKEN(String cR_ACTION_TAKEN) {
		CR_ACTION_TAKEN = cR_ACTION_TAKEN;
	}
	...
	public String getREMARKS_ENTRYTIME() {
		return REMARKS_ENTRYTIME;
	}

	public void setREMARKS_ENTRYTIME(String rEMARKS_ENTRYTIME) {
		REMARKS_ENTRYTIME = rEMARKS_ENTRYTIME;
	}
	...
	public String getATTACH_EXISTS() {
		return ATTACH_EXISTS;
	}

	public void setATTACH_EXISTS(String aTTACH_EXISTS) {
		ATTACH_EXISTS = aTTACH_EXISTS;
	}

	public Number getLINEITEMNO() {
		return LINEITEMNO;
	}

	public void setLINEITEMNO(Number lINEITEMNO) {
		LINEITEMNO = lINEITEMNO;
	}

	public String getCmsRiseFlag() {
		return cmsRiseFlag;
	}

	public void setCmsRiseFlag(String cmsRiseFlag) {
		this.cmsRiseFlag = cmsRiseFlag;
	}

	public String getCmsRemarks() {
		return cmsRemarks;
	}

	public void setCmsRemarks(String cmsRemarks) {
		this.cmsRemarks = cmsRemarks;
	}

	public double getDedctedAmount() {
		return dedctedAmount;
	}

	public void setDedctedAmount(double dedctedAmount) {
		this.dedctedAmount = dedctedAmount;
	}

	public double getClaimableAmt() {
		return claimableAmt;
	}

	public void setClaimableAmt(double claimableAmt) {
		this.claimableAmt = claimableAmt;
	}

	public double getActualClamt() {
		return actualClamt;
	}

	public void setActualClamt(double actualClamt) {
		this.actualClamt = actualClamt;
	}
	...
	public List<LabelBean> getCexVerifiedDtls() {
		return cexVerifiedDtls;
	}

	public void setCexVerifiedDtls(List<LabelBean> cexVerifiedDtls) {
		this.cexVerifiedDtls = cexVerifiedDtls;
	}
	public Double getClaimInitiatedAmt() {
		return claimInitiatedAmt;
	}

	public void setClaimInitiatedAmt(Double claimInitiatedAmt) {
		this.claimInitiatedAmt = claimInitiatedAmt;
	}
	public Number getCexVerifiedTotConsAmt() {
		return cexVerifiedTotConsAmt;
	}
	public void setCexVerifiedTotConsAmt(Number cexVerifiedTotConsAmt) {
		this.cexVerifiedTotConsAmt = cexVerifiedTotConsAmt;
	}
	...
	public String getEmailToHosp() {
		return emailToHosp;
	}

	public void setEmailToHosp(String emailToHosp) {
		this.emailToHosp = emailToHosp;
	}
	...
	public String getCmsEORemarks() {
		return cmsEORemarks;
	}

	public void setCmsEORemarks(String cmsEORemarks) {
		this.cmsEORemarks = cmsEORemarks;
	}
	...
	public List<ClaimsFlowVO> getAttachlist() {
		return attachlist;
	}

	public void setAttachlist(List<ClaimsFlowVO> attachlist) {
