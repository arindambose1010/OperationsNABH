...
public class ClaimsFlowForm extends ActionForm{
	...
	private List<LabelBean> cexVerifiedDtls;
	...
	private List<ClaimsFlowVO> cmsAuditDtls;
	...
	public String getCexVerifiedAmt() {
		return cexVerifiedAmt;
	}

	public void setCexVerifiedAmt(String cexVerifiedAmt) {
		this.cexVerifiedAmt = cexVerifiedAmt;
	}
	...
	public List<ClaimsFlowVO> getCmsAuditDtls() {
		return cmsAuditDtls;
	}

	public void setCmsAuditDtls(List<ClaimsFlowVO> cmsAuditDtls) {
		this.cmsAuditDtls = cmsAuditDtls;
	}
