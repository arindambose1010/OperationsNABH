...
public interface ClaimsFlowService {
	...
	int getErroneousClaimOrNot(String caseId);
	...
	List<ClaimsFlowVO> getCmsRemarks(String caseId);
		public List<LabelBean> getCheckBill(ClaimsFlowVO claimFlowVO);
			public String getorgFlag(String caseId);

			String checksurgFlag(String patientId);

			String checksurgFlagNew(String patientId);
}
