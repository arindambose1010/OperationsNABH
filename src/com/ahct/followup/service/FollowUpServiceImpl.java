	...
	try
		{
			...
			query.append( " select b.firstName||' '||b.lastName as CRTUSR,a.crtDt as crtDate  ");
...
public List<ClaimsFlowVO> getAuditTrail(FollowUpVO followUpVO) {
	...
	try{
		StringBuffer query = new StringBuffer();
		query.append(" select au.firstName ||''|| au.lastName as auditName ,a.remarks as cexRemark ,a.id.actOrder as test,");
...
public List<LabelBean> getFPCasesForPayments(FollowUpVO followUpVO) {
	...
	try{
		...
		query.append(" and EL.id.locId=EP.districtCode and EHB.hospId=EH.hospId and ECF.caseId=EC.caseId and EH.hospActiveYN in ('Y','S','C','D','E','CB') ");
		 	...
		 	try
		 		{
				 	...
				 	query.append(" b.followUpStatus as statusId,b.caseId as caseId,a.crtDt as crtDate,a.cochlearFollowupCount as cochlearCountStr  ");
	 ...
	 public List<FollowUpVO> getCochlearClaimWorkFlow(String caseId,String followUpId)
		 {
		 	...
		 	try
		 		{
				 	StringBuffer query=new StringBuffer();
				 	query.append(" select a.remarks as remarks , a.id.caseType as caseType ,a.id.actOrder as test, ");
		 	...
		 	try
		 		{
				 	...
				 	query.append(" , a.userRemarks as sendBackRmrks,a.crtDt as crtDate ");
