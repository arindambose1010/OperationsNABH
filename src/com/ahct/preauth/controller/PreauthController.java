		...
		try
		{
			...
			request.setAttribute("caseId", lStrCaseId);	
			 ...
			 {		    
				  ...
				  String roles[]={"preauth_medco_role","preauth_ch_role","preauth_ctd_role","PTD_Grp","PAO_Grp","PPD_Grp","CPD_Grp","EO_Grp","preauth_org_exe_role","preauth_org_comt_role","preauth_org_ctd_role","preauth_mithra_role"};
			 ...
			 */
			 ...
			 //cpd ctd and ch and eo committee
			   ...
			   if(lStrActionFlag!=null && ("commonDtls".equalsIgnoreCase(lStrActionFlag)|| "patCommonDtls".equalsIgnoreCase(lStrActionFlag)))
			{
				...
				if(commonDtls!= null &&  !commonDtls.isEmpty())
				{
					...
					if(lStrUserRole != null && (lStrUserRole.equalsIgnoreCase(config.getString("preauth_medco_role")) && commonDtls.get(0).getCASESTAT().equalsIgnoreCase(config.getString("preauth_inpatient_caseReg")))
				    		...
				    		||(lStrUserRole != null && lStrUserRole.equalsIgnoreCase(config.getString("preauth_medco_role")) && commonDtls.get(0).getCASESTAT().equalsIgnoreCase(config.getString("ehf_clinical_surgeryUpdate")))
				    		 ){
					...
					if(lStrUserRole != null && lStrUserRole.equalsIgnoreCase(config.getString("preauth_org_exe_role")))
					{
						request.setAttribute("loggedInRole", "orgexe");		
					}
					if(lStrUserRole != null && lStrUserRole.equalsIgnoreCase(config.getString("preauth_org_comt_role")))
					{
						request.setAttribute("loggedInRole", "orgcomt");		
					}
					if(lStrUserRole != null && lStrUserRole.equalsIgnoreCase(config.getString("preauth_org_ctd_role")))
					{
						request.setAttribute("loggedInRole", "orgctd");		
					}
...
//					System.out.println("Patient Commnn Dtls line 266-------");
				...
				if("commonDtls".equalsIgnoreCase(lStrActionFlag))
				{
					...
					if(caseStartTime !=null && !"".equalsIgnoreCase(caseStartTime) && lStrCaseId !=null && !"".equalsIgnoreCase(lStrCaseId) && caseEndTime !=null && !"".equalsIgnoreCase(caseEndTime) && lStrEmpId !=null && !"".equalsIgnoreCase(lStrEmpId))
					{
					...
					{
					loggingService.logTime("CaseLoadingTime", lStrCaseId, caseStartTime, caseEndTime, lStrEmpId, "EHS_OperationsNABH");
        			}
					}
		 ...
		 {	
			 ...
			 String dentalrntdbvalue=patientService.getTreatmentDntlvalue(lStrCaseId);
				List<CommonDtlsVO> commonDtls = preauthService.getPatientCommonDtls(lStrCaseId);
				if(commonDtls!= null &&  !commonDtls.isEmpty())
				{
					int lstSize=commonDtls.size();
...
//					System.out.println("caseScheme is "+caseScheme);
			  ...
			  List<LabelBean> intraoraldtls=null;
				...
				preauthVO.setIntraoraldtls(intraoraldtls);
			  ...
			  if(dentalrntdbvalue!=null && dentalrntdbvalue.equalsIgnoreCase("yes")){
				  lStrResultPage="Preauth/DentalPatientOPDtls";
			  }
//			  else if(dentalrntdbvalue==null || dentalrntdbvalue.equalsIgnoreCase("")){
			  else{
