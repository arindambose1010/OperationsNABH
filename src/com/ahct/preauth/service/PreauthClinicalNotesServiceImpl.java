...
public class PreauthClinicalNotesServiceImpl implements PreauthClinicalNotesService {
	...
	public List<PreauthClinicalNotesVO> getClinicalNotesForCase(String pStrCaseId,String pStrNotesType) throws Exception{
		...
		try{
			...
			query.append(" select c.bpSystolic as BLOODPRESSURE , c.clinicalId as CLINICALID,c.pulse as PULSE, c.wardInTime as WARDINTIME,to_char(c.crtDt,'DD-MM-YYYY') as crtDt ");
...
//			System.out.println("case id ehfCase" + ehfTelephonicRegn);
	...
	public List<DrugsVO> getIPDrugs(String pStrCaseId,String pStrPrePostFlag)
	{
		...
		try
		{
			...
			query.append(" to_date(EPD.crtDt,'dd/mm/yyyy hh24:mi:ss') as CRTDT, EDM.mainGrpName as drugTypeName,EDM.therMainGrpName as drugSubTypeName,EDM.pharSubGrpName as pSubGrpName,EDM.cheSubGrpName as cSubGrpName,EDM.chemicalName as drugName, ");
	...
	public List<CasesSearchVO> getDopDtls(String caseId)
	{
		...
		query.append(" from EhfCaseTherapy ect,EhfmMainTherapyNabh etpm,EhfCase ec where ");
