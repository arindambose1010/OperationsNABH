...
public class PreauthVO implements java.io.Serializable
{
 ...
 private String amountLockedFor; 
...
private String actId;
   ...
   private String attachPathNew;
   public String getAttachPathNew() {
	return attachPathNew;
}
public void setAttachPathNew(String attachPathNew) {
	this.attachPathNew = attachPathNew;
}
...
public void setMedSeq(Long medSeq) {
	...
	private List<PreauthVO> dispnsryList;
	private String TESTKNOWN;
    private String TEST;
    private String NAME;
    private String SPLINVSTID;
	...
	private String DISPTESTKNOWN;
	private String DISPTEST;
	private String DISPNAME;
	private String DISPSPLINVSTID;
	private String DISPROUTE;
	private String DISPPRICE;
	
	private String holdRemarks;
	private String organTransYN;
	private String nextStatusMedical;
	private String consumableFlg;
	...
	public String getDISPTESTKNOWN() {
		return DISPTESTKNOWN;
	}
	public void setDISPTESTKNOWN(String dISPTESTKNOWN) {
		DISPTESTKNOWN = dISPTESTKNOWN;
	}
	public String getDISPTEST() {
		return DISPTEST;
	}
	public void setDISPTEST(String dISPTEST) {
		DISPTEST = dISPTEST;
	}
	...
	public String getDISPSPLINVSTID() {
		return DISPSPLINVSTID;
	}
	public void setDISPSPLINVSTID(String dISPSPLINVSTID) {
		DISPSPLINVSTID = dISPSPLINVSTID;
	}
	public String getDISPROUTE() {
		return DISPROUTE;
	}
	public void setDISPROUTE(String dISPROUTE) {
		DISPROUTE = dISPROUTE;
	}
	...
	public List<PreauthVO> getDispnsryList() {
		return dispnsryList;
	}
	public void setDispnsryList(List<PreauthVO> dispnsryList) {
...
/**
   ...
   private String CASEID;
    ...
    private String newConsumableFlg;
    private String medAsriCode;
    private String medCatCode;
    private String icdProcName;
   
   public String getMedAsriCode() {
		return medAsriCode;
	}
	public void setMedAsriCode(String medAsriCode) {
		this.medAsriCode = medAsriCode;
	}
	public String getMedCatCode() {
		return medCatCode;
	}
	public void setMedCatCode(String medCatCode) {
		this.medCatCode = medCatCode;
	}
	public String getIcdProcName() {
		return icdProcName;
	}
	public void setIcdProcName(String icdProcName) {
		this.icdProcName = icdProcName;
	}
...
//Start 019
   ...
   public String getAuditComboRole() {
	...
	public String getRobotSurgery() {
		return robotSurgery;
	}
	public void setRobotSurgery(String robotSurgery) {
		this.robotSurgery = robotSurgery;
	}
	...
	public String getTotCycles() {
		return totCycles;
	}
	public void setTotCycles(String totCycles) {
	...
	public void setPATIENTCONSENTNAME(String pATIENTCONSENTNAME) {
		PATIENTCONSENTNAME = pATIENTCONSENTNAME;
	}
	...
	public void setPATIENTCONSENTPATH(String pATIENTCONSENTPATH) {
		PATIENTCONSENTPATH = pATIENTCONSENTPATH;
	}
	...
	public String getAmountLockedFor() {
		return amountLockedFor;
	}
	public void setAmountLockedFor(String amountLockedFor) {
		this.amountLockedFor = amountLockedFor;
	}
	public String getNextStatusMedical() {
		return nextStatusMedical;
	}
	public void setNextStatusMedical(String nextStatusMedical) {
		this.nextStatusMedical = nextStatusMedical;
	}
	public String getConsumableFlg() {
		return consumableFlg;
	}
	public void setConsumableFlg(String consumableFlg) {
		this.consumableFlg = consumableFlg;
	}
	public String getNewConsumableFlg() {
		return newConsumableFlg;
	}
	public void setNewConsumableFlg(String newConsumableFlg) {
		this.newConsumableFlg = newConsumableFlg;
	}
