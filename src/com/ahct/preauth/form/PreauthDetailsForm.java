...
private List<PreauthVO> dailysisList;
private List<BioMetricVo> captureList;
...
private FormFile patientPhoto[]= new FormFile[12];
private FormFile consentDoc[]= new FormFile[12];
...
private FormFile editId[]= new FormFile[300];
public FormFile getEditId(int index) {
	return editId[index];
}
public void setEditId(int index,FormFile value) {
	this.editId[index] = value;
}
public FormFile[] getEditId() {
	return editId;
}
public void setEditId(FormFile[] editId) {
	this.editId = editId;
}
...
public void setIcdProcName1(String icdProcName1) {
	this.icdProcName1 = icdProcName1;
}
...
private List<PreauthVO> enhamcementListNew;
public List<PreauthVO> getEnhamcementListNew() {
	return enhamcementListNew;
}
public void setEnhamcementListNew(List<PreauthVO> enhamcementListNew) {
	this.enhamcementListNew = enhamcementListNew;
}
...
private String drugQuant;

private String drugPrice;
private String oldDrugAmt;
private String oldConsumableAmt;
private String oldTotalAmt;
private Long  amountLockedFor;
private Long  nextAmountLocked;
private Long  maxAmountAllowed;

public Long getAmountLockedFor() {
	return amountLockedFor;
}
public void setAmountLockedFor(Long amountLockedFor) {
	this.amountLockedFor = amountLockedFor;
}
public Long getNextAmountLocked() {
	return nextAmountLocked;
}
public void setNextAmountLocked(Long nextAmountLocked) {
	this.nextAmountLocked = nextAmountLocked;
}

private String drugSearch;
private String holdRejectFlag;
...
public String getOldDrugAmt() {
	return oldDrugAmt;
}
public void setOldDrugAmt(String oldDrugAmt) {
	this.oldDrugAmt = oldDrugAmt;
}
public String getDrugQuant() {
	return drugQuant;
}
public void setDrugQuant(String drugQuant) {
	this.drugQuant = drugQuant;
}
...
public FormFile getPatientPhoto(int index) {
	return patientPhoto[index];
}
public void setPatientPhoto(int index,FormFile value) {
	this.patientPhoto[index] = value;
}
...
public FormFile getConsentDoc(int index) {
	return consentDoc[index];
}
public void setConsentDoc(int index,FormFile value) {
	this.consentDoc[index] = value;
}

public FormFile[] getConsentDoc() {
	return consentDoc;
}
public void setConsentDoc(FormFile[] consentDoc) {
...
public List<PreauthVO> getDailysisList() {
	return dailysisList;
}
public void setDailysisList(List<PreauthVO> dailysisList) {
	this.dailysisList = dailysisList;
}
public List<BioMetricVo> getCaptureList() {
	return captureList;
}
public void setCaptureList(List<BioMetricVo> captureList) {
...
public String getDiaProcCode() {
	return diaProcCode;
}
public void setDiaProcCode(String diaProcCode) {
	this.diaProcCode = diaProcCode;
}
...
public Long getDaysDone() {
	return daysDone;
}
public void setDaysDone(Long daysDone) {
...
public String getOldConsumableAmt() {
	return oldConsumableAmt;
}
public void setOldConsumableAmt(String oldConsumableAmt) {
	this.oldConsumableAmt = oldConsumableAmt;
}
public String getOldTotalAmt() {
	return oldTotalAmt;
}
public void setOldTotalAmt(String oldTotalAmt) {
	this.oldTotalAmt = oldTotalAmt;
}
public String getHoldRejectFlag() {
	return holdRejectFlag;
}
public void setHoldRejectFlag(String holdRejectFlag) {
	this.holdRejectFlag = holdRejectFlag;
}
public Long getMaxAmountAllowed() {
	return maxAmountAllowed;
}
public void setMaxAmountAllowed(Long maxAmountAllowed) {
