...
public class PreauthVO implements java.io.Serializable
{
    ...
    private String LABRPTSUBMIT;
    private List<DrugsVO> otherDrugsList;
	...
	public String getLABRPTSUBMIT() {
		return LABRPTSUBMIT;
	}
	public void setLABRPTSUBMIT(String lABRPTSUBMIT) {
		LABRPTSUBMIT = lABRPTSUBMIT;
	}
	public List<DrugsVO> getOtherDrugsList() {
		return otherDrugsList;
	}
	public void setOtherDrugsList(List<DrugsVO> otherDrugsList) {
		this.otherDrugsList = otherDrugsList;
	}
	...
	public void setNEWCONTACTNO(String nEWCONTACTNO) {
	 ...
	 public String getRATIONCARD() {
		...
		public void setINDENTDT(String iNDENTDT) {
			INDENTDT = iNDENTDT;
		}
