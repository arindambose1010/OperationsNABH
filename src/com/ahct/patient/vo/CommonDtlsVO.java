...
private String PASTCASEID;
private String PASTPATIENTID;
...
public String getPASTCASEID() {
	return PASTCASEID;
}
public void setPASTCASEID(String pASTCASEID) {
	PASTCASEID = pASTCASEID;
}
public String getPASTPATIENTID() {
	return PASTPATIENTID;
}
public void setPASTPATIENTID(String pASTPATIENTID) {
...
//Chandana - 8251 - new variable
public String SNo;
public Date ExpiryDate;
public String drugCode;
public Number phyQtnToday;
...
public Number getPhyQtnToday() {
	return phyQtnToday;
}
public void setPhyQtnToday(Number phyQtnToday) {
	this.phyQtnToday = phyQtnToday;
}
