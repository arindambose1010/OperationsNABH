...
public class casesSearchRecordVO implements Serializable {
	...
	private String preauthAprvDt;
	private String csDisDt;
	private String csDeathDt;
	private String claimInit;
	...
	public void setWapNo(String wapNo) {
		...
		public String getClaimInit() {
		return claimInit;
	}
	public void setClaimInit(String claimInit) {
		this.claimInit = claimInit;
	}
	...
	public void setInpatientCaseSubDt(String inpatientCaseSubDt) {
		this.inpatientCaseSubDt = inpatientCaseSubDt;
	}
	public String getCsPreauthDt() {
		return csPreauthDt;
	}
	public void setCsPreauthDt(String csPreauthDt) {
		this.csPreauthDt = csPreauthDt;
	}
	
	public String getPreauthAprvDt() {
		return preauthAprvDt;
	}
	public void setPreauthAprvDt(String preauthAprvDt) {
	...
	public String getEstimAmt() {
		return estimAmt;
	}
	public void setEstimAmt(String estimAmt) {
