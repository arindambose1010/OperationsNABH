...
public class MedicalAuditSchedular {
	...
	try{
		...
		for(int i=0;i<EhfCaseTherapy.size();i++)
		{
			 ...
			 for(EhfCase ehfCase:ehfCaseLst)
			 {
			 if(ehfCase==null)
				 continue;
			 criteriaList.removeAll(criteriaList);
			...
			ehfMedicalAuditSampleCases.setPatientId(ehfCase.getCasePatientNo());
			...
			ehfMedicalAuditSampleCases.setClaimPaidAmt(ehfCase.getCsClAmount());
