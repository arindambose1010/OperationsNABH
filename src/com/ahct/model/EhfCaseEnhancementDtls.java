...
public String getNewAttachpath() {
	return newAttachpath;
}
public void setNewAttachpath(String newAttachpath) {
	this.newAttachpath = newAttachpath;
}
@Column(name="NEW_PATH_NAME")
...
@Column(name="new_consumable_flg")
...
public EhfCaseEnhancementDtls(Long sno, String caseId, String type,
		...
		String crtUser, Date crtDt, String lstUpdUser, Date lstUpdDt,String activeYN,String attachPath,String attachName, String newConsumableFlg) {
	super();
	this.sno = sno;
	this.caseId = caseId;
	this.type = type;
