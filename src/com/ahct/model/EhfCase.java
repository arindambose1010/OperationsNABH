...
public class EhfCase implements Serializable {
	...
	private String holdPd;
	private String secFlag;
	
	//NABH hospital flag by  teja
	...
	@Column(name="FRWD_FLG")
	 public String getFrwdFlg() {
		return frwdFlg;
	}

	public void setFrwdFlg(String frwdFlg) {
		this.frwdFlg = frwdFlg;
	}
	...
	@Column(name="HOLD_PD")
	public String getHoldPd() {
		return holdPd;
	}

	public void setHoldPd(String holdPd) {
		this.holdPd = holdPd;
	}
