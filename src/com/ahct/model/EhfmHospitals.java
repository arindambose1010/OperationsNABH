...
private String hospGroup;
private String officialMailId;

@Column(name="HOSP_GROUP")
public String getHospGroup() {
	return hospGroup;
}
public void setHospGroup(String hospGroup) {
	this.hospGroup = hospGroup;
}
@Column(name="scheme")
...
@Column(name="treat_type", nullable=true)
...
@Column(name="Official_email_id", nullable=true)
...
public EhfmHospitals(String hospId, String hospName, String hospDispCode,
		...
		Date crtDt, String lstUpdUser, Date lstUpdDt,String stateCode,String taashaHosp, String treatType,String officialMailId) {
	super();
	this.hospId = hospId;
	this.hospName = hospName;
	this.hospDispCode = hospDispCode;
