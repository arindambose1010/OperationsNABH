...
@Entity
@Table(name = "ehfm_disp_designation")
public class EhfmDispDesignation implements Serializable {
	...
	private EhfmDispDesignationId id;
	...
	public EhfmDispDesignationId getId() {
		return id;
	}

	public void setId(EhfmDispDesignationId id) {
		this.id = id;
	}
