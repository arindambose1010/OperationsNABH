...
@Entity
@Table(name="EHFM_HOSP_quantity_Nabh")
public class EhfmHospQuantityNabh implements java.io.Serializable{
...
public EhfmHospQuantityNabh() {
	super();
}
public EhfmHospQuantityNabh(String quantId, String quantName, Integer amount,
