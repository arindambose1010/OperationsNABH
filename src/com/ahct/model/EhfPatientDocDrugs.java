...
@Entity
@Table(name="EHF_PATIENT_DOC_DRUGS")

public class EhfPatientDocDrugs implements Serializable {
	...
	public EhfPatientDocDrugs() {
		super();
	}
	
	public EhfPatientDocDrugs(Long drugId, String patientId, String caseId,
			...
			String strengthType,String activeYn) {
		super();
		this.drugId = drugId;
