...
@Entity
@Table(name="EHF_WC_INDENT_VNDR_GST_AUDIT")
public class EhfWcIndentVndrGstAudit implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private EhfWcVndrId id;
   ...
   @Column(name="SEQ_ID")
   @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "VNDR_SEQ_ID")
   @SequenceGenerator(name = "VNDR_SEQ_ID", sequenceName = "VNDR_SEQ_ID", allocationSize = 1)
   private Long seqId;
	...
	public EhfWcVndrId getId() {
	return id;
	}
	
	public void setId(EhfWcVndrId id) {
		this.id = id;
	}
