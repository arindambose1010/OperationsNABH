...
@Embeddable
public class EhfmDispDesignationId implements Serializable {
	...
	public EhfmDispDesignationId() {
		super();
		// TODO Auto-generated constructor stub
	}

	public EhfmDispDesignationId(String dsgnId, String langId) {
		super();
		this.dsgnId = dsgnId;
		this.langId = langId;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EhfmDispDesignationId other = (EhfmDispDesignationId) obj;
		if (dsgnId == null) {
