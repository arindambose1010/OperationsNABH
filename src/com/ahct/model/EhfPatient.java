...
@Column(name="PATIENT_ID", nullable = false)
	...
	@Column(name="DRUG_DISP_FLAG")
	public String getDrugDispFlag() {
		return drugDispFlag;
	}
	public void setDrugDispFlag(String drugDispFlag) {
		this.drugDispFlag = drugDispFlag;
	}
	@Column(name="PHARMA_VIEW")
	public String getPharmaView() {
		return pharmaView;
	}

	public void setPharmaView(String pharmaView) {
		this.pharmaView = pharmaView;
	}
	...
	@Column(name="DTO_DRUG")
	public String getDtoDrug() {
		return dtoDrug;
	}

	public void setDtoDrug(String dtoDrug) {
		this.dtoDrug = dtoDrug;
	}
	@Column(name="mobile_app_apntmnt")
	...
	@Column(name="pharm_drug_save")
	public String getPharmDrugSave() {
		return pharmDrugSave;
	}

	public void setPharmDrugSave(String pharmDrugSave) {
		this.pharmDrugSave = pharmDrugSave;
	}
	...
	//Chanadana - 8443 - Added below column to store the abha number if the user search using abha and trying to register patient
	@Column(name="ABHA_NO")
