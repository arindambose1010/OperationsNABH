...
public class EhfmCmbDtls implements Serializable {
	...
	@Column(name = "AIS_MARITAL_FLG", nullable = true)
	private String aisMarital;
	...
	public String getAisMarital() {
		return aisMarital;
	}

	public void setAisMarital(String aisMarital) {
		this.aisMarital = aisMarital;
	}
