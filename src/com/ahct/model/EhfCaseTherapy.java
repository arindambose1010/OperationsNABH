...
public class EhfCaseTherapy implements java.io.Serializable{
	...
	private String roboticSurgery;
	private String hospstayAmt;
	private String commonCatAmt;
	private String icdAmt;
	private String ipOtherMed;
	//private String criticalFlg;
	
    //private Set<EhfmHospSurgPer> ehfmHospSurgPer = new HashSet<EhfmHospSurgPer>(0);
	@Column(name="IPMED_OTHER")
     public String getIpOtherMed() {
		return ipOtherMed;
	}
	public void setIpOtherMed(String ipOtherMed) {
		this.ipOtherMed = ipOtherMed;
	}
@Id
@Column(name="case_therapy_id")
	...
	@Column(name="ROB_SURG")
	public String getRoboticSurgery() {
		return roboticSurgery;
	}
	public void setRoboticSurgery(String roboticSurgery) {
		this.roboticSurgery = roboticSurgery;
	}
	...
	public EhfCaseTherapy(Long caseTherapyId, String caseId, String icdCatCode,
			...
			String docQual, String docMobileNo, String procUnits,String surgProcUnits,
			String toothedUnits,String medcoProcUnits,String ctdProcUnits,String chProcUnits, String hospstayAmt, String commonCatAmt,
			String icdAmt,String unitsPartial) {
		super();
		this.caseTherapyId = caseTherapyId;
		this.caseId = caseId;
		this.icdCatCode = icdCatCode;
