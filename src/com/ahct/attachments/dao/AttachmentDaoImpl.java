 ...
 */
	...
	SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
	 ...
	 if(lparamMap.get("drugsBreakFlag")!=null ){
	drugsBreakFlag=(String)lparamMap.get("drugsBreakFlag");
	 }else{
		...
		try{
	       ...
	       /* query =  new StringBuffer();
            ...
            if(drugsBreakFlag!=null&&drugsBreakFlag.equals("Y")){

				query.append(" and ac.cmbDtlId  in ('CD1263')");
			...
			if( attachType!= null && attachType.equalsIgnoreCase(config.getString("preauth_main_attachType"))&&!drugsBreakFlag.equals("Y"))
			{
			lstNames = new ArrayList<AttachmentVO>();
			/**
	...
	public Map getPayResponseAttachment(HashMap<String, Object> hParamMap) {
		...
		if (toDatePay == null || toDatePay.equalsIgnoreCase("")) {
			...
			query.append(" select a.fileName as fileName,a.filePath as filePath,a.crtDate as crtDt from EhfClaimUploadFile a ");
