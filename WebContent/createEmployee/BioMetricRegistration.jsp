	...
	var loginName=document.getElementById('userId').value;
	 ...
	 if(loginName==null ||loginName==""){
		 alert("Please enter any search criteria");
		    ...
		    document.forms[0].action='bioMetricAction.do?actionFlag=searchEmployee&loginName='+loginName;
...
<c:if test="${resMsg eq 'N'}">
<script>
alert("No data found with Employee Id.Please check Employee Id and Search Again.");
</script>
</c:if>
  	...
  	<h2><span class="glyphicon glyphicon-hand-right"></span>&nbsp;&nbsp;&nbsp;Welcome To Biometric Enrollment Screen&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-hand-left"></span>&nbsp;</h2>
				...
				<div class="row">
				                        	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" align="right">
				                        	                <label style="color:black"  ><span> </span>Employee Id :</label>		                         
				                        	
				                      </div>
                        	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
                           <html:text property="userId" name="bioMetricForm" styleId="userId" styleClass="form-control" title="Login Name of Employee">
							</html:text>
							</div>
...
<%-- 								<html:text name="bioMetricForm"  styleClass="form-control" property="mobNumber" title="Mobile Number" styleId="mobNumber"></html:text>
 --%>								<bean:write name="bioMetricForm" property="mobNumber"></bean:write>
							</label>
						...
						<div class="form-group col-xs-12 col-sm-2 col-md-2 col-lg-2  " >
							<span class="glyphicon glyphicon-map-marker"></span><label>&nbsp;Email Id:<font color="red"> *</font></label>
						</div>
						
						<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group   " >	
							<label > 
<%-- 							<html:text name="bioMetricForm"  styleClass="form-control" property="emailId" title="Email Id" styleId="emailId"></html:text>
 --%>							<bean:write name="bioMetricForm" property="emailId"></bean:write>	
							</label>
         ...
         <button type="button" class="btn but" value="Submit"  onclick="javascript:fn_enroll();" align="center" style=" margin-right: 141px;">Enroll&nbsp;<span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;</button>
  ...
  <html:hidden name="bioMetricForm" property="hospId"></html:hidden>
   ...
   <html:hidden name="bioMetricForm" property="fingerPrint"></html:hidden>
    <html:hidden name="bioMetricForm" property="photoUrl"></html:hidden>
        <html:hidden name="bioMetricForm" property="mobNumber"></html:hidden>
    
        <html:hidden name="bioMetricForm" property="emailId"></html:hidden>
...
$('#bioMetricForm').formValidation({
    ...
    else
    {
        ...
        //if(x){
document.forms[0].action="bioMetricAction.do?actionFlag=uploadPhoto";
document.forms[0].submit();
        //}
    }
    }
...
if(fingerPrint!=null && fingerPrint!='' && x )
{


	document.forms[0].action="bioMetricAction.do?actionFlag=enrollDispUser";
	document.forms[0].submit();
