		...
		if(x)
			{
				...
				if(confirm("Confirm,Are you sure you want to create a new employee with the details provided?"))
					{
					document.forms[0].action='createEmployee.do?actionFlag=saveCreateEmp';
...
function getBankName(arg){
	 ...
	 var ifscCode=document.getElementById(arg).value;  
	  ...
	  xmlhttp.onreadystatechange=function()
	  {
	   ...
	   url= '/<%=context%>/createEmployee.do?actionFlag=getBankName&ifscCode='+ifscCode;
	   xmlhttp.open("Post",url,true);
	   xmlhttp.send(null);
	  }
...
function fn_showAlert()
	{
		...
		{
			jqueryAlertMsg("Alert","Employee Created Successfully with the given login name "+loginName);
		}
		resetPage();
	}
function resetPage()
	{
	   ...
	   document.getElementById('vacPosTR').style.display="none";
	    ...
	    document.getElementById('vacPos1').style.display="none";
		document.getElementById('vacPos2').style.display="none";	
		document.getElementById('level1').style.display="none";
		document.getElementById('level2').style.display="none";
		  
		
		//document.getElementById("bankName-input").text=document.getElementById("bankName").options[0].text;   
...
<body onload="fn_showAlert();">
	<html:form action="/createEmployee.do" method="POST" enctype="multipart/form-data" styleId="createEmployeeForm">
		<div class="container-fluid center-block">
			<div class="tbheader col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group" style="width:100%;">		
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group"><div align="center"><b>Personal Details</b></div>
           		...
           		<div class="row"> 
           			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
           				...
           				<html:text styleClass="form-control" property="empNumber" maxlength="25" title="Enter Employee Number" styleId="empNumber" onchange="myFunction('empNumber');UserNo('empNumber')" name="createEmployeeForm"/>
           			</div>
           			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
           				Login Name<font color="Red">*</font>
           				<html:text styleClass="form-control" property="loginName" maxlength="25" title="Enter login Name" styleId="loginName" onchange="myFunction('loginName');LoginName('loginName')" name="createEmployeeForm"/>
           			</div>
           			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
           		...
           		<div class="row">
           			...
           			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
           				Zimbra Mail<font color="Red">*</font>&nbsp;&nbsp;&nbsp;<br>Required:
           				<html:radio  title="Select Zimbra Mail Required" name="createEmployeeForm" property = "zimbraReq"  styleId="zimbraReq"  value = "Y"/>Yes &nbsp;&nbsp;
						<html:radio title="Select Zimbra Mail Required" name="createEmployeeForm" property = "zimbraReq"  styleId="zimbraReq"  value = "N" />No
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group"><div align="center"><b>Other Details</b></div>
				<div class="row">
					...
					<div id="vacPos1" style="display:none" class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
           				Vacant Position<font color="Red">*</font>
           				<div id="vacPos2" class="tbcellBorder" style="display:none;">
           					<html:select  styleClass="form-control" property="vacPosName" name="createEmployeeForm" styleId="vacPosName" onmouseover="addTooltip('vacPosName');"  onchange="fn_getVacantPositionDetails()" title="Select Vacant Position">
							<option value="">--------Select---------</option>
							 <html:options collection="vacNamesList" labelProperty="VALUE" property="ID"/>
							</html:select>
						</div>
					</div>
           			<div id="level1" style="display:none" class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
           				Level<font color="Red">*</font>
           				<div id="level2" class="tbcellBorder" style="display:none;">
           					<html:text styleClass="form-control" property="level" maxlength="10" title="Level" styleId="level" name="createEmployeeForm" readonly="true"/>		
           				</div> 
           			</div>	
				</div>
				<div class="row" id="vacPosTR" style="display:none;" >
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
						Designation
						<html:text styleClass="form-control" property="desgName"  title="Designation Name" styleId="desgName" name="createEmployeeForm" readonly="true"/>		 
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
						Reporting Person:
						<html:text styleClass="form-control" property="repPerson" title="Reporting Person" styleId="repPerson" name="createEmployeeForm" readonly="true"/>
					</div>		 
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
						Group Name:
						<html:textarea styleClass="form-control" rows="3" property="groupName" title="Group Name" styleId="groupName" name="createEmployeeForm" readonly="true"/>
					</div>		 
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
						Biometric Login&nbsp;&nbsp;&nbsp;<br>Required:
						<html:radio title="Select Biometric Login Required" name="createEmployeeForm" property = "bioMetricReq"  styleId="bioMetricReq"  value = "Y"/>Yes &nbsp;&nbsp;
						<html:radio title="Select Biometric Login Required" name="createEmployeeForm" property = "bioMetricReq"  styleId="bioMetricReq"  value = "N" />No
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group bottom-margin tbcellCss">
						Digital Certificate&nbsp;&nbsp;&nbsp;<br>Required:
						<html:radio title="Select Digital Certificate Required" name="createEmployeeForm" property = "digiSignReq"  styleId="digiSignReq"  value = "Y"/>Yes &nbsp;&nbsp;
						<html:radio title="Select Digital Certificate Required" name="createEmployeeForm" property = "digiSignReq"  styleId="digiSignReq"  value = "N"/>No
					</div>
				</div>
			</div>
