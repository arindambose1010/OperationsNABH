...
if(fingerPrint!=null && fingerPrint!='')
{
	...
	document.forms[0].action="bioMetricAction.do?actionFlag=recordAttendance&otherUserId="+otherUserId;
...
var otherUser=document.forms[0].otherUser.value;
	...
	url = "bioMetricAction.do?actionFlag=validateAttendance&userType="+userType+"&attendType="+attendType+"&hospId="+hospId+"&otherUser="+otherUser;
