...
// 		{
	...
	fn_loadImage();
	document.forms[0].action="bioMetricAction.do?actionFlag=bioMetricReport&searchFlag=Y";
...
function fn_getDesignations()
{
	...
	var url='bioMetricAction.do?actionFlag=getDsgns&deptId='+deptId;
...
function fn_viewAttendance(userId,present,absent)
{
	...
	fn_loadImage();
	document.forms[0].action="bioMetricAction.do?actionFlag=getAttendanceReport&userId="+userId+"&fromDate="+fromDate+"&toDate="+toDate;
	document.forms[0].method="post";
	document.forms[0].submit();
}
...
function fn_csv()
{
	...
	document.forms[0].action="bioMetricAction.do?actionFlag=bioMetricReport&searchFlag=Y&csvFlag=Y";
	document.forms[0].method="post";
	document.forms[0].submit();
}
// end of procedures
...
<table  width="98%"  cellpadding="1" cellspacing="1" align="center" style="padding-top:0px;margin:0px auto;" class="tb">
 ...
 <!-- 	<th class="tbheader1" width="10%" valign="top">Hospital Name</th> -->
	...
	<td  class="tbcellBorder" style="word-wrap:break-word;padding:3px;" align="center"><b><a href="javascript:fn_viewAttendance('<bean:write name="result" property="userId"/>' ,'<bean:write name="result" property="loginDays" />','<bean:write name="result" property="notLoginDays" format="######"/>')" title="Click Here To View detailed Report"><bean:write name="result" property="loginDays" /></a></b></td>
