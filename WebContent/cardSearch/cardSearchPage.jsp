	...
	function fn_search()
		{
			empRadio="";
			 ...
			 if(empRadio=="" && cardNo=="")
				 ...
				 {
					 document.forms[0].action='cardSearchAction.do?actionFlag=searchCardDetails&cardNo='+cardNo+'&empRadio='+empRadio;
		...
		empRadio="";
		 ...
		 if(empRadio!=null && empRadio == "J")
			 {
				...
				document.getElementById("cardPage").src='cardSearchAction.do?actionFlag=printCard&enrolId='+enrolId+'&seqNo='+seqNo+'&langId='+langId+'&empRadio='+empRadio;
				if(usrId!=null && usrId!='')
					document.getElementById("cardPage").src='cardSearchAction.do?actionFlag=printCard&enrolId='+enrolId+'&seqNo='+seqNo+'&langId='+langId+'&usrId='+usrId+'&empRadio='+empRadio;
		 ...
		 if(empRadio!=null && empRadio == "E")
			 ...
			 if(seqNo!=""){
					...
					var usrId='${empUsrId}';	
				document.getElementById("cardPage").style.display="";
				document.getElementById("cardPage").src='cardSearchAction.do?actionFlag=printCardEmployee&enrolId='+enrolId+'&seqNo='+seqNo+'&langId='+langId+'&empRadio='+empRadio;
				if(usrId!=null && usrId!='')
					document.getElementById("cardPage").src='cardSearchAction.do?actionFlag=printCardEmployee&enrolId='+enrolId+'&seqNo='+seqNo+'&langId='+langId+'&usrId='+usrId+'&empRadio='+empRadio;
				}
			 }
