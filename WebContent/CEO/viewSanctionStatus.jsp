...
function viewSancStatus(sanctionId){
	fn_loadImage();
	document.forms[0].action ='adminSanction.do?actionFlag=viewDetailsById&sanctionId='+sanctionId+'&printFlag=no';
...
function searchSancReq(){
	...
	fn_loadImage();
	document.forms[0].action = 'adminSanction.do?actionFlag=searchSancStatus&sanctionId='+sanctionId+'&reqStatus='+reqStatus+'&strtdate='+strtdate+'&endDate='+endDate;
	document.forms[0].submit();
}
...
<table id="Search" align="center"  width="90%" cellpadding="0" cellspacing="0" class="tb" style="padding-top:0px;margin:0px auto;">
						...
						<img id="eraImg"  title="Click here to erase" src="images/erase37.jpg" alt="click to clear" onclick="javascript:eraser('reqRaisedDtFrm');" >
					    </td>
					   <td style="padding-left:5px" class="labelheading1 tbcellCss">Request Raised Date:TO</td>
						...
						<img id="eraImg"  title="Click here to erase" src="images/erase37.jpg" alt="click to clear" onclick="javascript:eraser('reqRaisedDtTo');" >
					   </td>
                       </tr>
                       <tr class="NormalRow">
                       <td></td>
