...
function showStatus(sanctionId){
	fn_loadImage();
	document.forms[0].action ='adminSanction.do?actionFlag=getSanctionDetails&sanctionId='+sanctionId;
...
{		
	 document.forms[0].action = 'adminSanction.do?actionFlag=submitAdminSancDetailsCEO&sancId='+sancId+'&buttonValue='+buttonValue;
		document.forms[0].submit();
...
<li ><a href="javascript:showinSetsOf('<c:out value="${set}" />')"> <c:out value="${set}" /></a></li>
						...
						<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table  b-t text-small"  style="padding-left:1em;" border="0">
							...
							<a href="javascript:fn_SubmitSingleRow('${rowId.SANCTIONID}','Approve')" id="approveS" data-toggle="class" title="Click to Approve" width="75">
							...
							<a href="javascript:fn_SubmitSingleRow('${rowId.SANCTIONID}','Reject')" id="" data-toggle="class" title="Click to Reject" >
