...
<!-- 	<th class="tbheader1" width="10%" valign="top">Hospital Name</th> -->
	...
	<td align="center" class=" tbcellBorder"  width="100">
							...
							<a href="javascript:fn_SubmitSingleRow('<fmt:message key='EHF.Button.Approve' />','Approve','<bean:write name="result" property="caseId"/>')" id="approveS" data-toggle="class" title="Click to Approve" width="75">
							<span class=" glyphicon glyphicon-ok text-success text-active"></span>
							<span class=" glyphicon glyphicon-ok text-danger text"></span>
							</a>&nbsp;
						
							
							<a href="javascript:fn_SubmitSingleRow('<fmt:message key='EHF.Button.Reject' />','Reject','<bean:write name="result" property="caseId"/>')" id="RejectS" data-toggle="class" title="Click to Reject" >
	 ...
	 url = 'casesSearchAction.do?actionFlag=setViewFlag&CaseId='+caseId+'&flag=Y';
		 ...
		 xmlhttp.onreadystatechange=function()
		{
		    if(xmlhttp.readyState==4)
		    {
		    	...
		    	url='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+arg+'&caseSearchType='+searchType+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&ipOpType='+ipOpType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&ceoFlag=Y';	
...
function caseSearch()
{
	...
	document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&ceoFlag=Y';
			...
			if(count==0)
{
	...
	return false;
	    	...
	    	document.forms[0].action="casesSearchAction.do?actionFlag=submitNextLvlCeo&viewType=ceo&buttonVal="+buttonId;
		    document.forms[0].submit();
...
{	
	 var url1="preauthDetails.do?actionFlag=preauthDetailsCeo&caseId="+caseId+"&patientId="+patientId+"&caseApprovalFlag=Y";
		$(function () { $('#progressBar').modal({
			backdrop : 'static',
			keyboard : false,
			show: true
