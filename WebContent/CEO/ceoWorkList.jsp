...
{	
	...
	if(hospid.indexOf("HSIN") != -1 ){
		...
		var newwindow = window.open(url,'Application','width=900, height=600, top=60,left=70,resizable=yes,titlebar=yes,status=yes,scrollbars=yes,menubar=no,toolbar=no');	
		newwindow.focus();	*/
		/*document.forms[0].action="onlineEmpnlApplication.do?actionVal=ONLINEAPPFORMSIGNIN&hospInfoId="+hospid+"&frmPage=mainlogin&workFlowType=Y";
		...
		var newwindow = window.open(url,'Application','width=900, height=600, top=60,left=70,resizable=yes,titlebar=yes,status=yes,scrollbars=yes,menubar=no,toolbar=no');	
		newwindow.focus();*/	/*document.forms[0].action="dentalApplication.do?actionVal=DENTALBASICINFO&hospInfoId="+hospid+"&dentalAppType=C&frmPage=mainlogin&workFlowType=Y";
		document.forms[0].method="post";
	   document.forms[0].submit();*/
	}
		...
		var newwindow = window.open(url,'Application','width=900, height=600, top=60,left=70,resizable=yes,titlebar=yes,status=yes,scrollbars=yes,menubar=no,toolbar=no');	
		newwindow.focus();	*/
		/*document.forms[0].action="dentalApplication.do?actionVal=DENTALBASICINFO&hospInfoId="+hospid+"&dentalAppType=H&frmPage=mainlogin&workFlowType=Y";
		document.forms[0].method="post";
	   document.forms[0].submit();*/
	}
		...
		var newwindow = window.open(url,'Application','width=900, height=600, top=60,left=70,resizable=yes,titlebar=yes,status=yes,scrollbars=yes,menubar=no,toolbar=no');	
		newwindow.focus();	*/
		/*document.forms[0].action="psychiatryApplication.do?actionVal=PSYCHIATRYBASICINFO&hospInfoId="+hospid+"&workFlowType=Y";
		document.forms[0].method="post";
	   document.forms[0].submit();*/
	}
}	
		...
		<logic:greaterThan name="size" value="0">
			...
			<logic:iterate name="ceoWorkListForm" property="workList" id="empanelHospVO" indexId="cnt">
				<tr id="chkBoxTr${cnt}">
					...
					<a href="javascript:fn_saveRow('<bean:write name="empanelHospVO" property="HOSPID" />','Approve')" id="approveS" data-toggle="class" title="Click to Approve" width="75">
							<span class=" glyphicon glyphicon-ok text-success text-active"></span>
							<span class=" glyphicon glyphicon-ok text-danger text"></span>
							</a>&nbsp;&nbsp;
					
					<a href="javascript:fn_saveRow('<bean:write name="empanelHospVO" property="HOSPID" />','Reject')" id="" data-toggle="class" title="Click to Reject" >
