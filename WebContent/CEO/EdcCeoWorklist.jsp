		...
		<logic:greaterThan name="size" value="0">
			...
			<logic:iterate name="ceoWorkListForm" property="edcCeoWorklist" id="edcCeoWorklist" indexId="cnt">
				<tr id="chkBoxTr${cnt}">
					...
					<a href="javascript:saveCEODtls('Approve','<bean:write name="edcCeoWorklist" property="actionId" />','<bean:write name="edcCeoWorklist" property="hospId" />')" id="approveS" data-toggle="class" title="Click to Approve" width="75">
							<span class=" glyphicon glyphicon-ok text-success text-active"></span>
							<span class=" glyphicon glyphicon-ok text-danger text"></span>
							</a>&nbsp;&nbsp;
					
					<a href="javascript:saveCEORejDtls('Reject','<bean:write name="edcCeoWorklist" property="actionId" />','<bean:write name="edcCeoWorklist" property="hospId" />')" id="" data-toggle="class" title="Click to Reject" >
