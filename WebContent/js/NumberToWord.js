...
{  
    ...
    {   
		...
		{
		    document.getElementById('container2').innerHTML=obStr+''+'Rupees Zero Only';
		}
        return false;   
    }   
	...
	j=0;
	if(document.getElementById('show') != null && document.getElementById('show').value=='amount')
        var finalWord="( "; 
	else
        var finalWord="";   
    ...
    {   
        ...
        case 3:   
			...
			else if(actnumber[i]==0 || actnumber[i+1]==0)
			{
				inWords[j]='';
			}
            else  
	...
	if(document.getElementById('container2') != null)
	{
	    document.getElementById('container2').innerHTML=finalWord;
	}
}  



function test_skillnewPayment(amt,divid)   
{  
    var junkVal = amt;
