...
function validateMobile(input)
{
	...
	if(!(a.trim().charAt(0)=="6" || a.trim().charAt(0)=="7" || a.trim().charAt(0)=="8" || a.trim().charAt(0)=="9"))
		{
...
{
	resetPatientData();//Chandana - 8133 - added to resolve Existing issue
	...
	if (document.forms[0].card_type[1].checked)
		...
		//	document.getElementById("label_newBorncard").style.display='none';
			document.getElementById("label_abhaCard").style.display='none';//Chandana - 8443 - Added this to not showing the abha text filed when the card type is selscted as Pensioner
		}
	else if (document.forms[0].card_type[0].checked)
		{
			document.getElementById("head").checked=false;
			...
			document.getElementById("label_Rjoucard").style.display='none';
			//document.getElementById("label_newBorncard").style.display='none';
			document.getElementById("label_abhaCard").style.display='none';//Chandana - 8443 - Added this to not showing the abha text filed when the card type is selscted as employee
		}
	else if (document.forms[0].card_type[2].checked)
		{
			document.getElementById("head").checked=false;
			...
			document.getElementById("label_Rjoucard").style.display='none';
			//document.getElementById("label_newBorncard").style.display='none';
			document.getElementById("label_abhaCard").style.display='none';//Chandana - 8443 - Added this to not showing the abha text filed when the card type is selscted as journalist
		}
	else if (document.forms[0].card_type[3].checked)//Chandana - 8443 -- card type 3
	{
		document.getElementById("head").checked=false;
		document.getElementById("head").disabled=false;
		for(var i=0;i<=13;i++)
...
function addSpecialities()
{
	...
	if(investigations.length>0)
	{
		for (var x=0;x<investigations.length;x++)
		{
			if (investigations[x].selected)
			{
				...
				var curr =document.getElementById("ICDProcName").options[document.getElementById("ICDProcName").selectedIndex].value;
				checkProc += curr+"~";
				
				if((tempList.indexOf("N18.1") >=0 || tempList.indexOf("N18.2") >=0  || tempList.indexOf("N19.1") >=0 || tempList.indexOf("N19.2") >=0 ))
				{
						alert('Cannot add any Procedure at this time');
						return false;
				}
				if(tempList.length >1 && (curr == "N18.1" || curr == "N18.2" || curr ==  "N19.1" || curr == "N19.2" ))
					{
						alert('Cannot add any other Procedure with dialysis');
						return false;
					}
				
				 tempList += document.getElementById("ICDProcName").options[document.getElementById("ICDProcName").selectedIndex].value+"~";
				if(checkProc.indexOf("81.54") >=0 || checkProc.indexOf("81.55") >=0 || tempList.indexOf("81.54") >=0 || tempList.indexOf("81.55") >=0)
				{
					if(document.getElementById("ICDProcName").options[document.getElementById("ICDProcName").selectedIndex].value=='81.56')
					{
						alert('Cannot add Bilateral Procedure at this time');
						return;
					}	
				}
				if(checkProc.indexOf("81.56") >=0 || tempList.indexOf("81.56") >=0 )
				{
					if(document.getElementById("ICDProcName").options[document.getElementById("ICDProcName").selectedIndex].value=='81.54'
						|| document.getElementById("ICDProcName").options[document.getElementById("ICDProcName").selectedIndex].value=='81.55')
					{
						alert('Cannot add Right or Left Knee Procedure at this time');
						return;
					}	
				}
		/*		
			for(var i=0;i<tempArr.length; i++)
				{
				if(tempArr[i] == '81.54' || tempArr[i] == '81.55'  || tempArr[i] == '81.56' )
					{
							if(tempArr[length-1] == '81.56')
							{
							alert('Cannot add Bilateral Procedure at this time');
							return;
							}
						
						if((tempArr[length-1] == '81.54' || tempArr[length-1] == '81.55') && tempArr[i] == '81.56')
							{
								alert('Cannot add Rign Procedure at this time');
								return;
							}
					}
				}*/
				...
				if(document.getElementById("roboticId") !=null && document.getElementById("roboticId").style.display=='')
				{
					newcell.innerHTML='<td width="5%">'+document.getElementById("robotSurg").value+'</td>';
				}
				else if(document.getElementById("roboticId") !=null && document.getElementById("roboticId").style.display=='none')
				{
					newcell.innerHTML='<td width="5%">-NA-</td>';
				}
				...
				if(spec.length>0)
				{
					...
					for(var i=0;i<spec.length;i++)
					{
						...
						if(specValues[2]==document.getElementById("ICDProcName").value)
						{
							...
							speciality=" "+"~"+" "+"~"+document.getElementById("ICDProcName").value+'~'+otherDocStr+'~'+investigations[x].value+'~'+investigations[x].text+"~"+document.getElementById("procUnits").value+"~"+document.getElementById("robotSurg").value;
							else
								speciality=" "+"~"+" "+"~"+document.getElementById("ICDProcName").value+'~'+otherDocStr+'~'+investigations[x].value+'~'+investigations[x].text+"~"+document.getElementById("procUnits").value+"~N";	
						}
						else
						{
							if(document.getElementById("robotSurg") != null)
							speciality=document.getElementById("asriCatName").value+"~"+document.getElementById("ICDCatName").value+"~"+document.getElementById("ICDProcName").value+'~'+otherDocStr+'~'+investigations[x].value+'~'+investigations[x].text+"~"+document.getElementById("procUnits").value+"~"+document.getElementById("robotSurg").value;
							else
								speciality=document.getElementById("asriCatName").value+"~"+document.getElementById("ICDCatName").value+"~"+document.getElementById("ICDProcName").value+'~'+otherDocStr+'~'+investigations[x].value+'~'+investigations[x].text+"~"+document.getElementById("procUnits").value+"~N";	
	...
	else
	{
		...
		if(document.getElementById("robotSurg") != null)
			speciality=document.getElementById("asriCatName").value+"~"+document.getElementById("ICDCatName").value+"~"+document.getElementById("ICDProcName").value+'~'+otherDocStr+'~NA~NA'+"~"+document.getElementById("procUnits").value+"~"+document.getElementById("robotSurg").value;
		else
			speciality=document.getElementById("asriCatName").value+"~"+document.getElementById("ICDCatName").value+"~"+document.getElementById("ICDProcName").value+'~'+otherDocStr+'~NA~NA'+"~"+document.getElementById("procUnits").value+"~N";	
...
function confirmPatientTypeReset()
{
	...
	/*if(schemeId!='CD202' && hospType!='G')
		{*/
	if(document.forms[0].patientType[1].checked || document.forms[0].patientType[2].checked)
	{
...
function getIcdCategoryCodes()
{
	...
	var procType = $('input[name="patientType"]:checked').val();
	document.getElementById("asriCatCode").value="";
	document.forms[0].investigations.options.length=0;
	...
	else
	{
		...
		if(document.getElementById('speciality').value!=null && document.getElementById('speciality').value!=''
				&& document.getElementById('speciality').value!=' ' )
			{
				...
				if(specOld!=null && specOld!='' && specOld!=' ')
					specLstCur.concat(specOld.toString().split(','));
			}
						...
						for(loc2=0;loc2<specDtls.length;loc2++)
							{
								if(specDtls[loc2]!=null)
									{
										/*if(document.getElementById("asriCatName").value=='S16' || document.getElementById("asriCatName").value=='S19')
											{
		...
		url = "./patientDetails.do?actionFlag=getICDCatByAsriCode&callType=Ajax&lStrAsriCatId="+asriCatCode+"&hospId="+hospId+"&treatType="+treatType+"&procType="+procType;
		xmlhttp.open("Post",url,true);
		xmlhttp.send(null);
	}
}
function getTherapyICDProcedureListMed(param)
{
	...
	url = "./patientDetails.do?actionFlag=getProcByCat&callType=Ajax&lStrICDCatId="+icdCatCode+"&lStrAsriCode="+asriCode+"&patientId="+patientId+"&hospId="+hospId+"&hosType="+hosType+"&treatType="+treatType;
	xmlhttp.open("Post",url,false);
	xmlhttp.send(null);
		}
}
...
function getMedicalCategoryList(id)
{
	...
	$("#otherRemarks").hide();
		...
		var	url = "./patientDetails.do?actionFlag=getICDCatByAsriCode&callType=Ajax&lStrAsriCatId="+medicalSpclty+"&critical="+critical+"&hospId="+hospId+"&treatType="+treatType+"&procType="+procType;

		 //var url="patientDetails.do?actionFlag=getMedicalSubCat&callType=Ajax&medicalSpclty="+medicalSpclty+"&critical="+critical;
		 xmlhttp.open("Post",url,false);
			xmlhttp.send(null);
}
...
function getProcedureCodesMed()
{
	...
	alert(anyOtherText);*/
	var x=$("#ICDProcName1 option:selected").text();
		...
		if(icdProcCode!=null && icdProcCode!='' && schemeId!=null && schemeId!='' && arg!=null && arg!='')
			{
				...
				var url="patientDetailsNew.do?actionFlag=getAllDentalConditions&callType=Ajax&icdProcCode="+icdProcCode+"&patSchemeId="+schemeId+"&patientId="+patientId+"&deleteProc="+deleteProc;
				xmlhttp.open("post",url,true);
				xmlhttp.send(null);
			}
	}
