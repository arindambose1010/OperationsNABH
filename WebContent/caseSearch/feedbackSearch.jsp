...
function fn_reset()
	...
	document.forms[0].action="casesSearch.do?actionFlag=feedbackSearch";
...
function fn_caseSearch()
{
	...
	var fr ='';
		...
		if(document.getElementById("feedbackId").value=='' &&
				...
				document.getElementById("toDate").value=='' 
				 ...
				 document.forms[0].action='casesSearch.do?actionFlag=feedbackSearch&searchFlag=Y&feedbackId='+document.getElementById("feedbackId").value+'&fromdate='+document.getElementById("fromDate").value+'&todate='+document.getElementById("toDate").value;
			     document.forms[0].submit();
	...
	function showinSetsOf(num)
	{
	 ...
	 document.forms[0].action='casesSearch.do?actionFlag=feedbackSearch&rowsperpage='+num+'&feedbackId='+document.getElementById("feedbackId").value+'&fromdate='+document.getElementById("fromDate").value+'&todate='+document.getElementById("toDate").value;
     document.forms[0].submit();
	...
	function fn_issueWorklist()
	    {
		fn_loadImage();
	  document.getElementById("middleFrame").src='casesSearch.do?actionFlag=issueWorklist'; 
		}

	function showPagination(num,rows)
   {
	document.forms[0].action='casesSearch.do?actionFlag=feedbackSearch&showpage='+num+'&rowsperpage='+rows+'&fromdate='+document.getElementById("fromDate").value+'&todate='+document.getElementById("toDate").value;
    document.forms[0].submit();
	}	
	function fn_feedbackid(FEEDBACKID)
	{
	
	var url='viewFeedbackAction.do?actionFlag=feedbackdetails&viewFeedbackid='+FEEDBACKID;
