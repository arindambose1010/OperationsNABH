...
{		
	document.forms[0].action='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+arg+'&caseSearchType='+searchType;	
...
function caseSearch()
	{
		 document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType;
         document.forms[0].submit();
	}
	function fn_reset()
	{
	...
	document.forms[0].wapNo.value='';	
	 document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=N&caseSearchType="+searchType;
     document.forms[0].submit();
	}
</script>
<style>
