...
function viewNextPages(pageNo,noOfPages,selectedPage,end_index)
{
	...
	{	
		...
		{	
			...
			document.forms[0].action="casesSearchAction.do?actionFlag=viewDeathCases&searchFlag=Y";
			caseSearchURl= 'casesSearchAction.do?actionFlag=viewDeathCases&searchFlag=Y&claimId='+trim(document.forms[0].claimId.value)+
	...
	{ 
		if(parent.parent.globalURl==''){
			 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType;
			 parent.setGlobalUrl(caseSearchURl);
		}
		//parent.fn_resizePage2(470);
		document.forms[0].action='casesApprovalAction.do?actionFlag=getCaseDtls&casesForApproval=N&CaseId='+caseId+'&status='+arg+'&caseSearchType='+searchType+'&ipOpType='+ipOpType;	
		document.forms[0].submit(); 
	}
	function exportToCSV()
	{
		...
		id.onclick=null;
		document.forms[0].action="casesSearchAction.do?actionFlag=viewDeathCases&csvFlag=Y&searchFlag=Y";
		document.forms[0].method="post";
		document.forms[0].submit();
	}
...
<c:if test="${end_index eq 100}"><li class="active"><span>100</span></li></c:if>
	...
	<table width="100%" border="0" align="center">
				...
				<tr>
				<td class="tbcellBorder"><a href="javascript:fn_caseApproval('${deathCasesList.caseId}','','${deathCasesList.patIpOp}')">
