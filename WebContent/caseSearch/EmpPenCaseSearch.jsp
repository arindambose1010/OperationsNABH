...
top: 100px;
				...
				var newwindow;
					...
					{
						document.forms[0].action='empPenCaseSearch.do?actionFlag=searchFormPagin&employeeNo=${employeeNo}&fromPastHistory=${fromPastHistory}&paginStatus='+res;
					...
					if(caseId=="" && caseStatus=="-1" && fromDate=="" && toDate=="")	
					{
						...
						document.forms[0].action='empPenCaseSearch.do?actionFlag=caseSearchCriteria&employeeNo=${employeeNo}&fromPastHistory=${fromPastHistory}';
						document.forms[0].submit();
					  } 
