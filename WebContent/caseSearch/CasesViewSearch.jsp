...
{ 
	if(parent.parent.globalURl==''){
		 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value;
		 parent.setGlobalUrl(caseSearchURl);
	}
	fn_loadImage();
	//parent.fn_resizePage2(470);
	document.forms[0].action='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+arg+'&caseSearchType='+searchType+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&ipOpType='+ipOpType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&ceoFlag=Y';	
	 ...
	 xmlhttp.onreadystatechange=function()
		{
		    if(xmlhttp.readyState==4)
		    {
		    	...
		    	document.forms[0].action='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+arg+'&caseSearchType='+searchType+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&ipOpType='+ipOpType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module;	
		    	document.forms[0].submit();    	
...
function caseSearch()
	{
		document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module;
         document.forms[0].submit();
	}
function exportToExcel()
{
	document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&excelFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module;
    document.forms[0].submit();
}
function exportToCSV()
{
	document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&excelFlag=Y&csvFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module;
    document.forms[0].submit();
}
