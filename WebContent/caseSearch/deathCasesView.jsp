	...
	<table width="100%" border="0" align="center">
				...
				<%--	</thead>
				 ...
				 <display:column class="tbcellBorder" title="Case Number" >
					<a href="javascript:fn_caseApproval('${rowId.caseId}','','${rowId.patIpOp}')" onclick="">
				...
				<tr>
				<td class="tbcellBorder"><a href="fn_caseApproval('${deathCasesList.caseId}','','${deathCasesList.patIpOp}')" >
