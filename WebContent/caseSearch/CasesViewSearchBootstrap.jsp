...
{ 
	...
	if(parent.parent.globalURl==''){
		 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errDentalSearchType='+denErrSearchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value;
		 parent.setGlobalUrl(caseSearchURl);
	}
	//parent.fn_resizePage2(470);
	document.forms[0].action='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+arg+'&caseSearchType='+searchType+'&errDentalSearchType='+denErrSearchType+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&ipOpType='+ipOpType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module;	
	document.forms[0].submit(); 
}
function fn_caseApprovalAjax(caseId,arg,ipOpType)
{	
	var exceedFlg = '${exceedFlg}';
	fn_loadImage();
	if(parent.parent.globalURl==''){
		 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&errDentalSearchType='+denErrSearchType+'&disSearchType='+disSearchType+'&module='+module+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&exceedFlg='+exceedFlg;
		 parent.setGlobalUrl(caseSearchURl);
	}
	//parent.fn_resizePage2(470);
	var flag = null;
...
function caseSearch()
	{
		var exceedFlg='${exceedFlg}';
		var disallFlag='${disallFlag}';
document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errDentalSearchType='+denErrSearchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&patientScheme='+patientScheme+'&exceedFlg='+exceedFlg+'&nimsFlag='+nimsFlag+'&disAllowance='+disallFlag;
...
function exportToExcel()
	{
		...
		document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&excelFlag=Y&caseSearchType="+searchType+'&errDentalSearchType='+denErrSearchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&patientScheme='+patientScheme;
...
function exportToCSV()
	{
		...
		if(ajaxFlag=='Y')
			{
				var url="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&excelFlag=Y&csvFlag=Y&caseSearchType="+searchType+'&errDentalSearchType='+denErrSearchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&patientScheme='+patientScheme+'&ajaxFlag=Y'+'&exceedFlg='+exceedFlg+'&nimsFlag='+nimsFlag+'&disAllowance='+disallFlag;
		...
		else
			{
				...
				document.forms[0].action="casesSearchAction.do?actionFlag=casesSearchCSV&searchFlag=Y&excelFlag=Y&csvFlag=Y&caseSearchType="+searchType+'&errDentalSearchType='+denErrSearchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&patientScheme='+patientScheme+'&ajaxFlag=N'+'&exceedFlg='+exceedFlg+'&nimsFlag='+nimsFlag+'&disAllowance='+disallFlag;
			    document.forms[0].submit();
			}
	}
function fn_caseSearch()
{
	...
	var claimType = document.forms[0].claimType.value;
	var exceedFlg = '${exceedFlg}'; 
	disallFlag='${disallFlag}';
	nimsFlag='${nimsFlag}';
	if(errSearchType=='Y'){
		...
		if(document.forms[0].errStatusId.value=='' &&
				...
				document.forms[0].claimType.value=='' && 
				(document.forms[0].schemeType && document.forms[0].schemeType.value==''))
				 ...
				 document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&patientScheme='+patientScheme+'&exceedFlg='+exceedFlg+'&disAllowance='+disallFlag;
				 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&nimsFlag='+nimsFlag+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&errDentalSearchType='+denErrSearchType+'&module='+module
				 ...
				 '&catName='+document.forms[0].catName.value+'&procName='+document.forms[0].procName.value+'&telephonicId='+document.forms[0].telephonicId.value+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&patientScheme='+patientScheme+'&exceedFlg='+exceedFlg+'&claimType='+claimType+'&disAllowance='+disallFlag;
	...
	(document.forms[0].schemeType && document.forms[0].schemeType.value==''))
	 ...
	 document.forms[0].showPage.value ="1";
	 document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&errDentalSearchType='+denErrSearchType+'&disSearchType='+disSearchType+'&module='+module+'&patientScheme='+patientScheme+'&exceedFlg='+exceedFlg+'&disAllowance='+disallFlag;
	 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module
				...
				document.forms[0].telephonicId.value=='')
			     ...
			     if(document.forms[0].showScheme.value=='show'){
			    	 if(document.forms[0].schemeType.value==''){
			    		 ...
			    		 document.forms[0].showPage.value ="1";
						 document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module+'&patientScheme='+patientScheme+'&exceedFlg='+exceedFlg+'&disAllowance='+disallFlag;
						 caseSearchURl="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=Y&caseSearchType="+searchType+'&errDentalSearchType='+denErrSearchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module
						 ...
						 '&catName='+document.forms[0].catName.value+'&procName='+document.forms[0].procName.value+'&telephonicId='+document.forms[0].telephonicId.value+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&schemeType='+document.forms[0].schemeType.value+'&patientScheme='+patientScheme+'&exceedFlg='+exceedFlg+'&claimType='+claimType+'&disAllowance='+disallFlag;
						 parent.setGlobalUrl(caseSearchURl);
					     document.forms[0].submit();}
				}else{
					jqueryAlertMsg('Cases Search','Please select any search criteria');
	...
	document.forms[0].wapNo.value='';
	document.forms[0].telephonicId.value='';	
	 //document.forms[0].action="casesSearchAction.do?actionFlag=OnloadCaseSearch&searchFlag=N&caseSearchType="+searchType+'&errSearchType='+errSearchType+'&disSearchType='+disSearchType+'&module='+module;
     //document.forms[0].submit();
	}
...
{
	var url="./patientDetails.do?actionFlag=casePrintForm&caseId="+caseId;
...
function fn_getICDCatList()
{
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getIcdCatList&catId='+document.forms[0].mainCatName.value+'&callType=Ajax';
...
function fn_getProcedures()
{
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getProcList&IcdcatId='+document.forms[0].catName.value+'&asriCode='+document.forms[0].mainCatName.value+'&callType=Ajax+';
	 if(document.forms[0].hospId)
		url=url+'&hospId='+document.forms[0].hospId.value;
	 xmlhttp.onreadystatechange=function()
		{
...
var elements=document.getElementsByTagName("input");
	...
	if(pagNo>1 && document.getElementById("checkAll").checked==true){
...
return false;
		...
		if(confirm("Do You Wish to Verify Selected Cases ?"))
		{
			...
			fn_loadImage();
        document.forms[0].action="casesSearchAction.do?actionFlag=ClaimsBulkApproval&acoFlag=Y&module=claim&errFlag="+errFlag+"&actionDone="+buttonId+"&cases="+cases+"&patientScheme="+patientScheme;
...
<body onload="fn_removeLoadingImage();disbleBtn();">
    ...
    <div class="tbheader">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" title="Click to search" style="color:#fff; display:block;">
         <span class="glyphicon glyphicon-plus"></span>
			...
			<c:if test="${module eq 'claim' && disallFlag ne 'Y'  }">
			...
			<c:if test="${module eq 'drugbreakup'}">
			<span><b>Drug Breakup Cases For Approval</b></span>
			</c:if>
			<c:if test="${module eq 'preauthJournal'}">
			<span><b>Journalists Preauth Cases For Approval</b></span>
			</c:if>
			<c:if test="${module eq 'hold'}">
			<span><b>CEO Hold Pending Cases For Approval</b></span>
			</c:if>
			<c:if test="${disallFlag eq 'Y'}">
			<span><b>Claim Cases for Disallowance</b></span>
			</c:if>
			</logic:equal>
...
<tr><td>
	...
	<tr>
		...
		<c:if test="${errSearchType ne 'Y' && disSearchType ne 'Y' && module ne 'drugbreakup' }">
		<td width="16%" class="labelheading1 tbcellCss"><b><fmt:message key="label.caseSearch.claimStatus" /></b></td>
		<td width="16%" class="tbcellBorder"><html:select  name="casesSearchFormClaims" property="claimId" styleId="claimId" style="width:200px; " onmousemove="javascript:getTitles('claimId')" title="Please select claim status">
		<option  value="">----Select----</option>
	...
	<tr>	 
		<c:if test="${errSearchType ne 'Y'}">	
		        ...
		        <td width="16%" class="tbcellBorder"><html:text name="casesSearchFormClaims" property="telephonicId" style="width:90%" maxlength="50" title="Please enter Telephonic Intimation Id" onchange="javascript:checkBlankSpaces('telephonicId','Telephonic Id');" /></td>	
		            <c:if test="${errSearchType eq 'Y' && disSearchType ne 'Y'}"> 
		         <td width="16%" class="labelheading1 tbcellCss"><b>Claim Type</b></td>
		<td width="16%" class="tbcellBorder"><html:select property="claimType"  styleId="claimType"  name="casesSearchFormClaims" style="width:150px;" onmousemove="javascript:getTitles('claimType')" title="Please select Case Type">
						<html:option value="ALL" key="ALL">---Select----</html:option>
    			        <html:option value="IPM">Medical Cases</html:option>
		                <html:option value="IP">Surgical Cases</html:option>
		                <html:option value="IPD">DayCare Cases</html:option>
						</html:select></td>	
						 </c:if> 
	</tr>
	<tr>
	...
	<tr>	 
	 ...
	 <tr>
	<c:if test="${errSearchType eq 'N' && disSearchType ne 'Y' && module ne 'drugbreakup' }">
	  <td width="16%" class="labelheading1 tbcellCss"><b>Claim Type</b></td>
		<td width="16%" class="tbcellBorder"><html:select property="claimType"  styleId="claimType"  name="casesSearchFormClaims" style="width:150px;" onmousemove="javascript:getTitles('claimType')" title="Please select Case Type">
						<%-- <html:option value="">----Select----</html:option>
						<html:option value="M">Medical Cases</html:option>
						<html:option value="S">Surgical Cases</html:option> 
						<html:option value="D">DayCare Cases</html:option>  --%>
						<html:option value="ALL" key="ALL">---Select----</html:option>
    			        <html:option value="IPM">Medical Cases</html:option>
		                <html:option value="IP">Surgical Cases</html:option>
		                <html:option value="IPD">DayCare Cases</html:option>
						...
						<c:if test="${module eq 'drugbreakup'}">
						<td width="16%" class="labelheading1 tbcellCss"><b>Claim Type</b></td>
		                <td width="16%" class="tbcellBorder"><html:select property="claimType"  styleId="claimType"  name="casesSearchFormClaims" style="width:150px;" onmousemove="javascript:getTitles('claimType')" disabled="true" title="Please select Case Type">
						<%-- <html:option value="">----Select----</html:option>
						<html:option value="M">Medical Cases</html:option>
						<html:option value="S">Surgical Cases</html:option> 
						<html:option value="D">DayCare Cases</html:option>  --%>
...
<tr>
<td>
<img style="border:1px solid black;" src="images/medical.png" width="12" height="12"></img>
 &nbsp;&nbsp;IP Medical Case
</td>
<td>
<img style="border:1px solid black;" src="images/surgical.png" width="12" height="12"></img>
 &nbsp;&nbsp;IP Surgical Case
</td>
<td>
<img style="border:1px solid black;" src="images/daycare.png" width="12" height="12"></img>
 &nbsp;&nbsp;Day Care
</td>
</tr>
</table>
</c:if>
<c:if test="${exceedFlg eq 'N'}">
<table width="95%" border="0" align="center" style="padding-top:0px;margin:0px auto;">
<tr>
<td>
<img  style="border:1px solid black;" src="images/g1.png" width="12" height="12"></img>
 &nbsp;&nbsp; 2 - 4 Lakhs
</td>
<td>
<img style="border:1px solid black;"  src="images/y1.png" width="12" height="12"></img>
 &nbsp;&nbsp; 4 - 5 Lakhs
</td>
<td>
<img style="border:1px solid black;" src="images/o1.png" width="12" height="12"></img>
 &nbsp;&nbsp; 5 - 6 Lakhs
</td>
<td>
...
<tr>
<td>
<img  style="border:1px solid black;" src="images/a3.png" width="12" height="12"></img>
 &nbsp;&nbsp; 7 - 8 Lakhs
</td>
<td>
<img style="border:1px solid black;"  src="images/a5.png" width="12" height="12"></img>
 &nbsp;&nbsp; 8 - 9 Lakhs
</td>
<td>
<img style="border:1px solid black;" src="images/a7.png" width="12" height="12"></img>
 &nbsp;&nbsp; 9 - 10 Lakhs
</td>
 <td>
<img  style="border:1px solid black;" src="images/r1.png" width="12" height="12"></img>
 &nbsp;&nbsp;  10 Lakhs and Above 
</td> 
...
if(minVal>=10)
	{
		...
		<li><a href="javascript:viewPreviousPages(<%=minVal%>,<%=noOfPages%>,<%=selectedPage%>)"><span class="glyphicon glyphicon-backward" style="cursor: pointer;"></span></a></li>
...
<td>
<c:if test="${disallFlag eq 'Y'}">
<b><font style="color:red;font-weight: bold;padding-left: 500px;">Note: Contest for Amount can not  be raised Beyond 7 days from the Deduction Date  </font></b>
</c:if>
</td>
</tr>
</table>
...
<!-- 	<th class="tbheader1" width="10%" valign="top">Hospital Name</th> -->
	...
	<tr  class="surgical" >
	 ...
	 <c:if test="${acoFlag eq 'Y'  && casesForApprovalFlag eq 'Y'}">
      ...
      <%-- <label><input type="checkbox" class="selectableCheckbox" value="<bean:write name="result" property="caseId"/>" onclick="javascript:checkOrUncheckCase();"></input></label> --%>
    </td>
      </c:if> 
...
<%-- 	</logic:notEqual> --%>
	<td class="tbcellBorder" align="center">
 	<c:if test="${result.caseStatusId=='CD2' || result.caseStatusId=='CD213' }">
 	<button class="btn-danger"  type="button" title="Click to Cancel Registration" onclick="javascript:cancelPatient('<bean:write name="result" property="caseId" />')">Cancel</button>
 	</c:if>
 	</td>
	</tr>
	</c:if>
	<c:choose>
	<c:when test="${exceedFlg eq 'N' && (result.enhAmounts <200000 )}">
		<c:set var="colorCode" value="medical"/>
	</c:when>
	<c:when test="${exceedFlg eq 'N' && (result.enhAmounts >200000 && result.enhAmounts <400000 )}">
		<c:set var="colorCode" value="green"/>
	</c:when>
	<c:when test="${exceedFlg eq 'N' && (result.enhAmounts >400000 && result.enhAmounts <500000 )}">
		<c:set var="colorCode" value="yellow"/>
	</c:when>
	<c:when test="${ exceedFlg eq 'N' && (result.enhAmounts >500000 && result.enhAmounts <600000 )}">
		<c:set var="colorCode" value="orange"/>
	</c:when>
	<c:when test="${ exceedFlg eq 'N' && (result.enhAmounts >600000 && result.enhAmounts <700000 )}">
		<c:set var="colorCode" value="seagreen"/>
	</c:when>
	<c:when test="${ exceedFlg eq 'N' && (result.enhAmounts >700000 && result.enhAmounts <800000 )}">
		<c:set var="colorCode" value="blue"/>
	</c:when>
	<c:when test="${ exceedFlg eq 'N' && (result.enhAmounts >800000 && result.enhAmounts <900000 )}">
		<c:set var="colorCode" value="purple"/>
	</c:when>
	<c:when test="${ exceedFlg eq 'N' && (result.enhAmounts >900000 && result.enhAmounts <1000000 )}">
		<c:set var="colorCode" value="pink"/>
	</c:when>
	<c:when test="${ exceedFlg eq 'N' && (result.enhAmounts >1000000 )}">
		<c:set var="colorCode" value="red"/>
	</c:when>
	 <c:otherwise>
		<c:set var="colorCode" value="medical"/>
	</c:otherwise> 
</c:choose>
	    <c:if test="${result.patIpOp=='IPM'}">
	<tr  class="${colorCode}">
...
<%-- 	<logic:equal value="IP" name="result" property="patIpOp" > --%>
<c:if test="${result.patIpOp=='IP' or result.patIpOp=='DOP' or result.patIpOp=='IPM' || result.patIpOp=='IPD' }">
		<td class="tbcellBorder" width="4%"><a href="javascript: generateCasePrint('<bean:write name="result" property="caseNo" />')"><span class="glyphicon glyphicon-print"></span></a></td>
		<td class="tbcellBorder" width="4%"><a href="javascript: printprfForm('<bean:write name="result" property="caseId" />','<bean:write name="result" property="caseStatusId" />','<bean:write name="result" property="patientId" />','<bean:write name="result" property="pendingFlag" />','<bean:write name="result" property="inpatientCaseSubDt" />')"><span class="glyphicon glyphicon-print"></span></a></td>
</c:if>
<%-- 	</logic:equal> --%>
...
<td class="tbcellBorder" align="center">
 	...
 	<button class="btn-danger"  type="button" title="Click to Cancel Registration" onclick="javascript:cancelPatient('<bean:write name="result" property="caseId" />')">Cancel</button>
	   ...
	   <c:if test="${result.patIpOp !='IPM' and result.patIpOp != 'IP' and result.patIpOp !='IPD'}">
...
function cancelPatient(caseId)
{
	 bootbox.confirm("Are you sure you want to cancel registration ? ", function(result) {
		 	if(result)
			{
					 document.forms[0].action="./casesSearchAction.do?actionFlag=cancelPatient&caseId="+caseId;
...
function fn_getPatFullDetails(caseIdd){
	var url='patCommonDtls.htm?actionFlag=getCaseDetails&CaseId='+caseIdd;
