...
var ipOtherRemarks2='${ipOtherRemarks2}';
...
<td><input type="text" style="width:20px;text-align:center" maxlength=1 id="probeDepth21" name="probeDepth" onchange="javascript:fn_checkprobingdepth(this.id,this.value);"></td></tr>
		...
		<tr><td colspan="4">
		   <table width="100%">
				...
				<td   class="tbcellBorder"><bean:write name="patientForm" property="newProc" /></td>
			    </tr>
			 <c:if test="${patientForm.critical ne null && preauthDetailsForm.critical ne '' }">
    		<tr>
    		<td   class="labelheading1 tbcellCss"><b>Procedure</b></td>
				<td   class="tbcellBorder" style="word-wrap:break-word;width:25%"><bean:write name="patientForm" property="medicalCat" /></td>
			    
    		
    		
    		<td  style="word-wrap:break-word;width:25%" class="labelheading1 tbcellCss"><b>Case Type</b></td>
    		<c:if test="${patientForm.critical eq 'Y'}">
    		<td  class="tbcellBorder" style="word-wrap:break-word;width:25%">CRITICAL </td>
    		</c:if>
    		<c:if test="${patientForm.critical eq 'N'}">
    		...
    		<td  style="word-wrap:break-word;width:25%" > &nbsp; </td> -->
    			 ...
    			 <c:if test="${ipOtherRemarks2 ne null && ipOtherRemarks2 ne '' }">
    		...
    		<td  class="tbcellBorder" style="word-wrap:break-word;width:25%">${ipOtherRemarks2} </td>
