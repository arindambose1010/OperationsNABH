...
<!-- 	</td></tr> -->
	...
	<logic:notEmpty name="patientForm" property="investList">
<logic:iterate id="investNames" name="patientForm" property="investList" indexId="cnt1">
		<table border="0" width="100%" align="center" >
		
			<tr class="tbheader print_heading"><td><bean:write name="investNames" property="VALUE"/></td></tr>
	...
	<table border="0" width="100%" align="center" >
		...
		<c:if test='${invId eq repoInvId}'></c:if>
		<logic:equal name="labelsItem" property="INVESTID" value="${patientForm.investList[cnt1].ID}">
	...
	<logic:empty name="patientForm" property="investList">
	<table border="0" width="100%" align="center" >
	<tr>
	<td style="text-align: center;font-size: 14px;font-weight: bold;">Your test reports have not been generated yet.</td>
	</tr>
	</table>
	</logic:empty>
