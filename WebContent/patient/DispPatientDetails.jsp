...
<script type="text/javascript" src="js/DispPatientscripts.js?v=1"></script>
...
if(hospGovu!=null && hospGovu!="G")
{
	if((schemeId=='CD201' && opIP == 'OP' && '${dentalFlg}'!='Y' )||(opIP=='IP')||(hospType!='G'))
	{
			...
			/* //Sravan Changes
			if(document.getElementById("drugTypeCode").value=="-1" || document.getElementById("drugTypeCode").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Drug Type ";
				   }
			        if(lField=='')
			        lField='drugTypeCode'; 
			}
			if(document.getElementById("drugSubTypeName").value=="-1" || document.getElementById("drugSubTypeName").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Drug Name ";
				   }
			        if(lField=='')
			        lField='drugSubTypeName'; 
			}
			if(document.getElementById("routeType").value=="-1" || document.getElementById("routeType").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Route ";
				   }
			        if(lField=='')
			        lField='routeType'; 
			}
			if(document.getElementById("route").value=="-1" || document.getElementById("route").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Route ";
				   }
			...
			if(document.getElementById("strengthType").value=="-1" || document.getElementById("strengthType").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Strength Type";
				   }
			        if(lField=='')
			        lField='strengthType'; 
			}
			if(document.getElementById("strength").value=="-1" || document.getElementById("strength").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Strength";
				   }
			        if(lField=='')
			        lField='strength'; 
			}
			if(document.getElementById("dosage").value=="-1" || document.getElementById("dosage").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Dosage per day";
				   }
			        if(lField=='')
			        lField='dosage'; 
			}
			if(document.getElementById("medicatPeriod").value=="-1" || document.getElementById("medicatPeriod").value=="")
			{
				if(lErrorMsg==''){
			       lErrorMsg=lErrorMsg+"Select Medication Period";
				   }
			        if(lField=='')
			        lField='medicatPeriod'; 
			}
			 */
...
function redirecttodental(input)
{
    ...
    if(input=="yes")
	 {
	bootbox.confirm("do wish to redirect  to the dental case sheet ?", function(result) {
	if(result)
		{
	if(caseId=='NA' || caseId== "")
		{
...
$(document).ready(function()
	...
	if(labGrp == 'GP797'){
		...
		jq('#medicalDetailsTable,#genInvestList,#ipOpTable,#diagnosisData,#OPHead2,#OPDoctor,#remarksDivIP,#btnsTable, .notDisplayLab, #IPHead2, #genTestTableID, #allReportsViewTr').css('display','none');
	}
	else{
...
//	var reportType ="Haematology Report";
	...
	window.open(url,"",'width=1000,height=600,resizable=yes,top=100,left=110,titlebar=no,menubar=no,toolbar=no,scrollbars=yes');
	/*document.forms[0].action=url;
	document.forms[0].method="post";
	document.forms[0].submit();*/
