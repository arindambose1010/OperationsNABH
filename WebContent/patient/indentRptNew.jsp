...
function generate()
{
		...
		fn_loadImage();
		document.forms[0].action="patientDetailsNew.do?actionFlag=getIndentReportsNew&dispname="+dispname+"&drugName="+drugName;
...
function fn_reset()
{
	...
	document.forms[0].action="patientDetailsNew.do?actionFlag=getIndentReportNew";
	document.forms[0].submit();
...
function newexportToCsv()
{
	var dispname=document.getElementById('dispname').value;
	var drugName=document.getElementById('dispDrugID').value;
	document.forms[0].action = "patientDetailsNew.do?actionFlag=getIndentReportsCsvNew&dispname="+dispname+"&drugName="+drugName;
	document.forms[0].submit();  
...
{	
  ...
  var drugName=document.getElementById('dispDrugID').value;
  fn_loadImage();
  var url="patientDetailsNew.do?actionFlag=getIndentReportsNew&dispname="+dispname+"&pageId="+pageId+"&endIndex="+endIndex+"&drugName="+drugName;
...
<table style="width:80%;margin:1% auto">
	<tr>
		<th colspan="8" class="tbheader">Indent Report (2019-2020)</th>
	</tr>
	<tr>
