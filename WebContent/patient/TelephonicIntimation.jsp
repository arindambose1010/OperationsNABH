...
{		
	document.forms[0].action='patientDetails.do?actionFlag=telephonicDirectReg&telephonicId='+caseId+'&cardNo='+arg+'&cardType='+cardType;
...
function caseSearch()
{
	 document.forms[0].action='telephonicAction.do?actionFlag=telephonicIntimationSearch&searchFlag=Y';
     document.forms[0].submit();
}
function fnSearch()
{
