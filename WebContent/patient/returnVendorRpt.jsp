...
function generate()
{
	if(validate())
	{
		...
		var dstrName=document.getElementById('dstrName').value;
		fn_loadImage();
		document.forms[0].action="patientDetailsNew.do?actionFlag=getReturnVendorReports&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&dstrName="+dstrName;
...
function fn_reset()
{
	...
	document.forms[0].action="patientDetailsNew.do?actionFlag=getReturnVendorReport";
	document.forms[0].submit();
...
function newexportToCsv()
{
	...
	var dispname=document.getElementById('dispname').value;
	var dstrName=document.getElementById('dstrName').value;
	document.forms[0].action = "patientDetailsNew.do?actionFlag=getReturnVendorReportsCsv&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&dstrName="+dstrName;
	document.forms[0].submit();  
...
{	
  ...
  var dstrName=document.getElementById('dstrName').value;
  fn_loadImage();
  var url="patientDetailsNew.do?actionFlag=getReturnVendorReports&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&pageId="+pageId+"&endIndex="+endIndex+"&dstrName="+dstrName;
...
<table style="width:80%;margin:1% auto">
	<tr>
		<th colspan="4" class="tbheader">Return to Vendor Report</th>
	</tr>
	<tr>
...
<html:select  property="dispname" name="patientForm" styleId="dispname"   title="Select Wellness Center">
	...
	<td colspan="1" class="labelheading1 tbcellCss" align="left" ><b>	Distributor Name</b>&nbsp;</td>
	<td align="left"  class="tbcellBorder"  >

<html:select  property="dstrName" name="patientForm" styleId="dstrName"   style="width:70%" title="Select Distributor Name">
...
<logic:present name="patientForm" property="returnVendorList">
<bean:size id="size" name="patientForm" property="returnVendorList"/>
...
<tr>
<th class="tbheader1 tbcellBorder" >S NO</th>
<th class="tbheader1 tbcellBorder" >WELLNESS CENTER NAME</th>
<th class="tbheader1 tbcellBorder" >RETURN DATE</th>
<th class="tbheader1 tbcellBorder" >DRUG TYPE</th>
<th class="tbheader1 tbcellBorder" >DRUG NAME</th>
<th class="tbheader1 tbcellBorder" >MANUFACTURER NAME</th>
<th class="tbheader1 tbcellBorder" >DISTRIBUTER NAME</th>
<th class="tbheader1 tbcellBorder" >BATCH NO</th>
<th class="tbheader1 tbcellBorder" >EXPIRY DATE</th>
<th class="tbheader1 tbcellBorder" >PURCHASE INVOICE NO</th>
<th class="tbheader1 tbcellBorder" >PURCHASE INVOICE DATE</th>
<th class="tbheader1 tbcellBorder" >RETURNED QUANTITY</th>
<th class="tbheader1 tbcellBorder" >REMARKS</th>

</tr>
<logic:iterate name="patientForm" property="returnVendorList" id="labelBean" indexId="cnt">
<tr>
...
<logic:empty name="labelBean" property="DISP_NAME">
 ...
 <logic:notEmpty name="labelBean" property="RETURN_DATE">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="RETURN_DATE"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="RETURN_DATE">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty> 
...
<logic:empty name="labelBean" property="EXPDT">
 ...
 <logic:notEmpty name="labelBean" property="INV_NUM">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="INV_NUM"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="INV_NUM">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty>  
 
  <logic:notEmpty name="labelBean" property="INV_DT">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="INV_DT"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="INV_DT">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty>  
...
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="REMARKS"/></td>
</logic:notEmpty>
...
<logic:empty name="patientForm" property="returnVendorList">
