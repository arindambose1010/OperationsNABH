...
{
	if(document.getElementById("SubmitNew").style.display=="")
	{
			alert("Please click on Save Button Before Issuing the Drugs");
			return false;
	}
	var z=0;
	if(document.getElementById("drugInfo")!=null && document.getElementById("drugInfo")!="")
	z=  document.getElementById("drugInfo").rows.length;
    if(z<2)
    {
    	alert("Please Add Drugs");
    	return false;
	...
	var x = "Y";
	var bbb=document.getElementById("SubmitNew").disabled;
 ...
 */	document.getElementById("Back").disabled = true;
	...
	if(x!=null && x=='Y')
		{
	var url="./patientDetailsNew.do?actionFlag=savePharmacydrugsNims&fromDisp=Y&saveFlg="+saveFlg+"";
		}
	else
		{
...
<html:select name="patientForm" property="drugSubTypeCode"  onchange="checkDrug();checkDrug1()" styleId="drugSubTypeCode" style="width:17em;" title="Select Drug Sub type"  onmouseover="addTooltip('drugSubTypeCode')">
		<html:option value="-1">Select</html:option>
...
<td class="tbcellBorder"> 
 		<html:text name="patientForm" property="quantity" styleId="quantity"  maxlength="3" style="WIDTH:17em" onchange="validateNumber('Quantity',this);"  title="Enter Quantity" /> 
</td> 
<td>
...
<br/>
 <table  width="95%"  id="drugsTable" style="display:none;margin: 0 auto !important" border="1">
      ...
      <%--   <logic:present name="patientForm" property="drugLt">
        ...
        <tr>
        <td >
		<button class="btn btn-primary has-spinner"   type="button" id="SubmitNew" style="display:none;margin-left: 540px;"  onclick="javascript:fn_submitDrugs()">Save</button>
		</td>
		</tr>
        </table>
...
<th width="20%" class="labelheading2 tbcellCss"><b>DRUG TYPE</b></th>
<th width="20%" class="labelheading2 tbcellCss"><b>DRUG NAME</b></th>
<th width="10%" class="labelheading2 tbcellCss"><b>DEO/MO/PO QUANTITY</b></th>
<!-- <th width="20%" class="labelheading1 tbcellCss"><b>Manufacturer Name</b></th>
<th width="20%" class="labelheading1 tbcellCss"><b>Distributer Name</b></th> -->
<!-- <th width="10%" class="labelheading2 tbcellCss"><b>AVAILABLE QUANTITY</b></th> 
 --><c:if test="${saveFlag eq 'Y'}">
...
<tr>
<td  >
<button class="btn btn-primary has-spinner" style="text-align:center" type="button" id="Submit"  onclick="javascript:fn_saveDrgs(<c:out value = "${drgCount}"/>,'Submit')">Issue Drugs&nbsp;</button>
</td>
<td  >
