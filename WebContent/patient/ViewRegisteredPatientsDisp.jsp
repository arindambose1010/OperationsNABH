...
function openCase(patientId,caseId)
{
	...
	if(fromPharma!=null && fromPharma!='' && fromPharma == 'Y' ){
		...
		//sai krishna:CR#8134:API Integration.
			 ...
			 document.forms[0].action="./patientDetailsNew.do?actionFlag=viewTdLabInvestgestions&patientId="+patientId+"&caseId="+caseId+"&fromDisp="+fromDisp;
			}
		else
...
function fn_pagination(pageNo,actionType)
{
	...
	var url="./patientDetails.do?actionFlag=ViewRegisteredPatients&actionType="+actionType+"&pageNo="+pageNo+"&fromDispnsry="+fromDisp+"&tdLabflg="+tdLabflg+"&x="+x;
