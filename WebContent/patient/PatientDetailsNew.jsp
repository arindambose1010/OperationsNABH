...
function fn_showSpeciality(args)
  {
	  var critical='N';
	  if(args!=null && args!='')
		  {
		 ...
		 xmlhttp.onreadystatechange=function()
		{
			 if(xmlhttp.readyState==4)
		        {
		            ...
		            else
		            {
		            	if(resultArray!=null)
		            	{
		                	...
		                	{  
		                		document.getElementById("medicalSpclty").options.length=0;
		                		document.getElementById("medicalSpclty").options[0]=new Option("---select---","-1");
		                		
		                		document.getElementById("asriCatCode1").value="";
		                		document.getElementById("medicalCat").options.length = 1;
		                		document.getElementById("ICDCatCode1").value = "";
		                		document.getElementById("ICDProcName1").options.length = 1;
		                		
		                		document.getElementById("ICDProcCode1").value = "";
		                		document.getElementById("ipOtherRemarks").value= "";
		               		 	...
		               		 	{	
		                     		...
		                     		if(arr[1]!=null && arr[0]!=null)
		                     		{
		                         		...
		                         		var val2 = arr[0].replace(/^\s+|\s+$/g,"");
		                       	 		document.getElementById("medicalSpclty").options[i+1] =new Option(val1,val2);
		                     		}
		                		}
		            		}
		            	}
		 ...
		 var url="patientDetails.do?actionFlag=getMedSpecility&callType=Ajax&critical="+critical;
  ...
  function fn_showAllSpecialities()
  {
		 ...
		 xmlhttp.onreadystatechange=function()
		{
		 ...
		 var url="patientDetails.do?actionFlag=getAllSpecility&callType=Ajax&critical="+critical;
		 xmlhttp.open("Post",url,true);
			xmlhttp.send(null);
  ...
  function fn_showCritical()
  {
		//Added for critical and non critical cases
		if (document.getElementById('patientTypeM').checked==true) {
			document.getElementById("diagnosisData").style.display="none";
			document.getElementById("IPHead2").style.display="none";
			document.getElementById('medicalSpclty').options.length = 0;
			document.getElementById("critcalCondition").style.display="";
			
			}
		if (document.getElementById('patientTypeM').checked==false) {
			document.getElementById("critcalCondition").style.display="none";
			document.getElementById('critical').checked==false;
			document.getElementById('nonCritical').checked==false;
			fn_showAllSpecialities();
			}
  }
  
  function fn_showCriticalOnLd()
  {
	  if (document.getElementById('patientTypeM').checked==true) 
		  {
		  document.getElementById("critcalCondition").style.display="";
		 ...
		 /*  if(document.getElementById('critical').checked==true)
			  {
			  fn_showSpeciality('critical');
			  }
		  else if(document.getElementById('nonCritical').checked==true)
			  {
			  fn_showSpeciality('nonCritical');
			  } */
		  }
...
<body onload="fn_loadProcessImage();fn_ipop();fn_showCriticalOnLd();">
...
<td width="5%">&nbsp;</td>
<logic:equal  name="patientForm" property="telephonicReg" value="Yes"><td width="15%" class="labelheading1 tbcellCss"><b>Telephonic ID</b></td>
...
<table class="tbheader">
<tr><td class="blinkMe"><b>REFERRED DETAILS</b> <img src="images/new-icon.gif" alt="New" height="18" width="35"></td></tr>
</table>
<table width="100%" class="medicalDetailsTable" border="0">
<tr>
<td width="15%" class="labelheading1 tbcellCss">Wellness Center</td>
<td width="15%" class="labelheading1 tbcellCss">Speciality</td>
</tr>
 <logic:iterate id="inv" name="patientForm" property="referalDtls">
<tr>
<td  width="15%" class="tbcellBorder"><bean:write name="inv" property="HOSPNAME"/></td>
<td  width="15%" class="tbcellBorder"><bean:write name="inv" property="DISNAME"/></td>
</tr>
</logic:iterate>
     </table>	      
</logic:greaterThan>
...
<tr><td colspan="4" >
 <logic:present name="patientForm" property="dispGenInvList">
        <bean:size  id="genInvSizeDisp" name="patientForm" property="dispGenInvList"/>
        <logic:greaterThan value="0" name="genInvSizeDisp">

  <table  width="100%"   border="1">
   <tr><td colspan="4" class="labelheading1 tbcellCss">Wellness Center Added Investigations</td></tr>
     	<tr>
		...
		<%int j = 1;%>
        <logic:iterate id="gnInvlstDisp" name="patientForm" property="dispGenInvList" indexId="sno" >
        <tr>  
      	<td width="30%" ><bean:write name="gnInvlstDisp" property="ACTION" /></td>       
        <td width="25%"><bean:write name="gnInvlstDisp" property="VALUE" /></td> 
       <!-- <td width="20%"><a href="javascript:fn_openLabReport('Haematology Report');"></a>EHF.LabReport</td>-->
		<logic:notEmpty  name="gnInvlstDisp" property="LVL">
       	<td width="25%"><a href="javascript:fn_openAtachment('<bean:write name="gnInvlstDisp" property="LVL" />','<bean:write name="gnInvlstDisp" property="LVL" />');" onclick="">View</a></td>
		</logic:notEmpty>
      <%--  	<td width="20%"><button class="btn btn-warning" type="button" value="Delete" name=<bean:write name="gnInvlstDisp" property="ID" /> id=<bean:write name="gnInvlstDisp" property="ID" /> onclick="javascript:confirmRemoveGenInvest(this,'geninvestigations','<bean:write name="gnInvlstDisp" property="ID" />');">Delete&nbsp;<i class="fa fa-times"></i></button></td> --%>
        </tr>
        </logic:iterate>
   </table>
  ...
  <table  width="100%"  id="genTestTableID" style="display:none" border="1">
   <tr><td colspan="4" class="labelheading1 tbcellCss">Previously Added Investigation</td></tr>
		...
		<logic:notEmpty  name="gnInvlst" property="LVL">
       	<td width="20%"><a href="javascript:fn_openAtachment('<bean:write name="gnInvlst" property="LVL" />','<bean:write name="gnInvlst" property="LVL" />');" >View</a></td>
		</logic:notEmpty>
		<script>rowNo++;</script>
...
<tr><td colspan="4" >
  <table  width="100%"  id="genTestTable" style="display:none" border="1">
     	<tr>
        	...
        	<!--<td width="10%"><b><fmt:message key="EHF.LabReport"/></b></td>-->
        	<td width="20%">&nbsp;</td></tr> 
  </table>
</td></tr>
...
<td id="patientType2" class="medTD" width="15%"><html:radio name="patientForm" property="patientType" value="IPM" title="Out Patient" styleId="patientTypeM" onclick="fn_showCritical()" /><b>IP Medical</b></td>
<td id="patientType1" class="surgTD" width="10%" ><html:radio name="patientForm" property="patientType" value="IP" title="In Patient" styleId="patientTypeS" disabled="true" onclick="fn_showCritical();enableIPOP()"/><b>IP Surgical</b></td>
<td id="patientType3" class="surgTD" width="15%"><html:radio name="patientForm" property="patientType" value="IPD" title="Day Care" styleId="patientTypeD" onclick="fn_showCritical();enableIPOP()" /><b>Day Care</b></td>
...
<tr id="critcalCondition"  style="display:none;">
<td colspan="6" class="labelheading1 tbcellCss">
<table width="100%">
<tr>
<td  >
<html:radio name="patientForm" property="critical" value="Y" title="Critical" styleId="critical" onclick="fn_showSpeciality(this.id);enableIPOP()" /><b>Critical</b>

<html:radio name="patientForm" property="critical" value="N" title="NonCritical" styleId="nonCritical" onclick="fn_showSpeciality(this.id);enableIPOP()"/><b> Non Critical</b>
</td>
</tr>
</table>
</td>
...
<td   width="50%" class="labelheading1 tbcellCss" id="roboticId1" style="display: none;"><b>Is Robotic Surgery</b> <font color="red" class="onlyAp">*</font></td>
<td>&nbsp;</td>
</tr>
<tr>
...
<td width="50%" class="tbcellBorder" id="roboticId" style="display: none;">
<html:select name="patientForm" property="robotSurg" styleId="robotSurg" style="WIDTH:17em" title="Robotic Surgery" onmouseover="addTooltip('robotSurg')">
<html:option value="-1"><fmt:message key="EHF.Select"/></html:option>
...
<tr><td colspan="4" >
  ...
  <tr><td colspan="8" class="labelheading1 tbcellCss">Previously Added Speciality</td></tr>
      <tr>  
		...
		<td width="15%" ><b><fmt:message key="EHF.TestName"/></b></td>   
       	<td width="15%"><b><fmt:message key="EHF.Attachment"/></b></td> 
       	<td width="5%"><b>Robotic Surgery</b></td>      	
        <td width="5%">&nbsp;</td>
        </tr>
		...
		<c:if test="${investLst.name eq 'NA'}">
       	<td width="15%"><bean:write name="investLst" property="name" /></td>
       	</c:if>
       	<c:if test="${investLst.name eq 'View'}">
       	<td width="15%"><a href="javascript:fn_openAtachment('<bean:write name="investLst" property="filePath" />','<bean:write name="investLst" property="filePath" />');" ><bean:write name="investLst" property="name" /></a></td>
       	</c:if>
       	 <td width="5%"><bean:write name="investLst" property="robotSurgery" /></td>
...
<td width="50%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.Remarks"/></b> <font color="red">*</font></td>
</tr>
...
<table width="100%">
<tr>
<!-- Added For Robotic Surgery yes or no -->

<!-- End of Robo Surgery -->
<%-- <td width="50%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.IPNumber"/></b> <font color="red">*</font></td> --%>
<td width="50%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.AdmissionType"/></b> <font color="red">*</font></td>
<td>&nbsp;</td>
</tr>
<tr>
...
<table width="100%">
<tr style ="display:none"><td><font ><b><fmt:message key="EHF.Prescription"/>:</b></font></td></tr>
...
<td class="tbcellBorder"><html:text name="patientForm"  property="asriCatCode1" styleId="asriCatCode1" title="Category Code" maxlength="10" style="WIDTH:17em" onkeydown="validateBackSpace(event)" readonly="true"/></td>
<td class="tbcellBorder"><html:select name="patientForm" property="medicalCat" styleId="medicalCat" style="WIDTH: 17em" title="Select ICD Category " onchange="javascript:getTherapyICDProcedureListMed(1);" onmouseover="addTooltip('medicalCat')">
<html:option value="-1"><fmt:message key="EHF.Select"/></html:option>
<logic:notEmpty name="ICDcategoryList">
<html:options property="ID" collection="ICDcategoryList" labelProperty="VALUE"/>
</logic:notEmpty>
</html:select></td>
<td class="tbcellBorder"><html:text name="patientForm"  property="ICDCatCode1" styleId="ICDCatCode1" title="ICD Category Code" maxlength="10" style="WIDTH:17em" onkeydown="validateBackSpace(event)" readonly="true"/></td>
</tr>
...
<tr>
<td class="tbcellBorder"><html:select name="patientForm" property="ICDProcName1" styleId="ICDProcName1" style="WIDTH:17em" title="Select ICD Procedure" onchange="getProcedureCodesMed();" onmouseover="addTooltip('ICDProcName1')">                        
            <html:option value="-1"><fmt:message key="EHF.Select"/></html:option>
<logic:notEmpty name="ICDprocedureList">
<html:options property="ID" collection="ICDprocedureList" labelProperty="VALUE"/>
</logic:notEmpty>           
    </html:select></td>
<td class="tbcellBorder"><html:text name="patientForm"  property="ICDProcCode1" styleId="ICDProcCode1" title="ICD Procedure Code" maxlength="10" style="WIDTH:17em" onkeydown="validateBackSpace(event)" readonly="true"/></td>
<td class="tbcellBorder" id="unitsTd" style="display:none">
<html:select name="patientForm" property="procUnits" styleId="procUnits" style="WIDTH:17em" title="Select No of Units" onchange="javascript:getDentalConditions('','','','unitsCond')"onmouseover="addTooltip('procUnits')">
<html:option value="-1"><fmt:message key="EHF.Select"/></html:option>
<%-- <html:options property="ID" collection="dentalUnitsList" labelProperty="VALUE"/> --%>
...
<html:textarea name="patientForm" property="ipOtherRemarks" styleId="ipOtherRemarks" title="Enter Medical Remarks" style="width:18em;;height:3em"  onkeydown="return maxLengthPress(this,3000,event)" onkeypress="return validateSplKeyCodes(event);" onchange="validateSpaces(this,'OP Remarks');blockConsecutiveChars('OP Remarks',this,this.value)"/>
</td>
<%-- <td class="tbcellBorder"><html:select name="patientForm" property="docSpecReg" styleId="docSpecReg" style="WIDTH:17em" title="Select Treating Doctor" onmouseover="addTooltip('docSpecReg')" onchange="fn_getIPDoctorsDetails()">                        
            <html:option value="-1"><fmt:message key="EHF.Select"/></html:option>     
</html:select></td> --%>
...
<tr>
<!-- <td  class="labelheading1 tbcellCss"><b>IP NO</b> <font color="red">*</font></td> -->
<td  class="labelheading1 tbcellCss"><b><fmt:message key="EHF.RegistrationDate"/></b> <font color="red">*</font></td>
<td  class="labelheading1 tbcellCss"><b><fmt:message key="EHF.Remarks"/></b> <font color="red">*</font></td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td width="25%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.PatientDiagnosedby"/></b> </td>
<td width="25%" id="docName" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.DoctorName"/></b></td>
...
<table width="95%" style="margin: auto;"><tr>
...
// 	}
	...
	else
	{
		...
		if('${PatientOpList.ipOpFlag}'!=null){
			...
			else if ('${PatientOpList.ipOpFlag}'=='IPD')
				{
	        ...
	        else if ('${PatientOpList.ipOpFlag}'=='IPM')
	        	{
...
<html:hidden name="patientForm" property="patientNo"  styleId="patientNo" ></html:hidden>
