...
function retrieveDetails()
{
 ...
 if(wapFamilyNo!=false)
	 {
 document.forms[0].action="./patientDetails.do?actionFlag=retrieveCardDetails&cardNo="+wapFamilyNo+"&SelOper=TELE&aisFlag=N";
...
function getTherapyCategoryList(param)
{
	...
	url = "./patientDetailsNew.do?actionFlag=getTherapyCategory&callType=Ajax&lStrHospId="+document.forms[0].hospitalId.value;
...
function getIcdCategoryCodes()
{
	...
	url = "./patientDetails.do?actionFlag=getICDCatByAsriCode&callType=Ajax&lStrAsriCatId="+asriCatCode+"&hospId="+document.forms[0].hospitalId.value;
	xmlhttp.open("Post",url,true);
	xmlhttp.send(null);
	}
}
...
<tr>
<td class="tbcellBorder"><html:select name="patientForm" property="hospitalId" styleId="hospitalId" style="WIDTH: 12em" title="Select Hospital" onchange="javascript:getTherapyCategoryList(1);" onmouseover="addTooltip('hospitalId')">
               <html:option value="-1"><fmt:message key="EHF.Select"/></html:option>
