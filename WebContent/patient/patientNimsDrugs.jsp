...
$(document).ready(function(){
	...
	var fromPharmaNims='${fromPharmaNims}';
	var fromPharmaMo='${fromPharmaMo}';
	var fromPharmaPo='${fromPharmaPo}';
	var fromPharmaPick='${fromPharmaPick}';
	if((deoFlg != '' && deoFlg == 'Y' && fromPharma!='Y') || (fromPharma != '' && fromPharma == 'Y')  || (fromPharmaPo != '' && fromPharmaPo == 'Y') || (fromPharmaMo != '' && fromPharmaMo == 'Y') || (fromPharmaPick != '' && fromPharmaPick == 'Y') )
	{
		 myVar = setTimeout(generateCasePrint,300);
	}
/* 	if(fromPharmaNims != '' && fromPharmaNims == 'Y')
		{
		alert("Drugs have been issued successfully");
...
/* 	if(fromPharmaNims != '' && fromPharmaNims == 'Y')
	{
		...
		parent.fn_addDrugsMo();	
	} */
	if(fromPharmaMo != '' && fromPharmaMo == 'Y')
	{
		
		parent.fn_addDrugsNims();	
	}
	else if(fromPharmaPick != '' && fromPharmaPick == 'Y')
	{
		
		parent.fn_pickDrugsNims();	
	}
	else if(fromPharmaPo != '' && fromPharmaPo == 'Y')
	{
		
		parent.fn_addDrugsPo();	
	}
	else if(fromDisp != '' && fromDisp == 'Y' && fromPharma!='Y')
	{
