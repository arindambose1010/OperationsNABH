...
<!-- 				<td rowspan="4" width="30%"class="labelheading1 tbcellCss print_cell"><strong>ix) Extra Oral Examinations</strong> </td> -->
		      ...
		      <table width="100%">
		      <tr><td width="30%"class="labelheading1 tbcellCss print_cell"><strong>Soft Tissue Examinations</strong> </td></tr>
		      ...
		      <tr><td width="100%" class="labelheading1 tbcellCss print_cell"><strong>Hard Tissue examinations</strong></td></tr>
