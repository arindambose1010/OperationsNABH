...
{	
  ...
  var toDate =document.forms[0].toDate.value;
   fn_loadImage();
  var url="patientDetailsNew.do?actionFlag=viewAppointents&fromDate="+fromDate+"&toDate="+toDate+"&dispname="+dispname+"&pageId="+pageId+"&endIndex="+endIndex+"&from=Y";
...
function retrieveDetails1(cardNo,appDate,scheme)
{
	...
	var fromDisp = '${fromDisp}';
	 ...
	 {
 		document.forms[0].action="./patientDetails.do?actionFlag=openPatRegForm&aisFlag=N&cardNo="+wapFamilyNo+"&appntDate="+appDate+"&patDispScheme="+scheme+"&fromDispnsry=Y&mobileApp=Y";
...
<table style="width:90%;margin:1% auto">
	<tr>
		<th colspan="8" class="tbheader">Doctor Appointments Through Mobile App</th>
	</tr>
...
<td  class="tbcellBorder"><html:text name="patientForm"  property="cardNo" styleId="cardNo" maxlength="21" title="Enter Health Card No" onchange="validateHealthCard('Health Card No',this)" style="WIDTH: 15em;"/></td>
 --%>
 <tr>
<td class="labelheading1 tbcellCss">Appointments : From Date</td>
...
<td class="labelheading1 tbcellCss">To Date</td>
...
<tr align="center" >
<td  colspan="4" align="center" >  <button class="but"  type="button" style="margin-top:12px ! important;" onclick="javascript:fnSearch()">Search</button>
 <button class="but"  type="button" onclick="resetSearch()">Reset</button></td>
</tr>
</table>
...
<th class="tbheader1" >MOBILE NUMBER</th>
<th class="tbheader1" >APPOINTMNET DATE</th>
<th class="tbheader1" >TIME SLOT</th>
<th class="tbheader1" >SPECIALITY</th>
<th class="tbheader1" >CONSULTATION NAME</th>
...
<td align="left" class="tbcellBorder" >${startIndex+cnt+1}</td>
 ...
 <td align="center" class="tbcellBorder" > <a href="javascript:" onclick="javascript:retrieveDetails1('<bean:write name="labelBean" property="PAT_CARD_NUMBER" />','<bean:write name="labelBean" property="APP_DATE"/>' ,'<bean:write name="labelBean" property="PATIENTSCHEME" />')"><bean:write name="labelBean" property="PAT_CARD_NUMBER"/></a></td>
...
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="PAT_NAME"/></td>
</logic:notEmpty>
...
<td align="center" class="tbcellBorder" ><bean:write name="labelBean" property="MOBILE_NO"/></td>
</logic:notEmpty>
...
<td align="center" class="tbcellBorder" ><bean:write name="labelBean" property="APP_DATE"/></td>
</logic:notEmpty>
...
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="TIME_SLOT"/></td>
</logic:notEmpty>
...
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="GRP_NAME"/></td>
</logic:notEmpty>
