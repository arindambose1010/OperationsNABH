...
{		
	window.open('patientDetails.do?actionFlag=ViewTelephonicDtls&telephonicId='+caseId,'TelephonicRegisteredDetails','scrollbars=1,left=20,top=20,width=1000,height=650');
}
...
function caseSearch()
{
	document.forms[0].action='telephonicAction.do?actionFlag=telephonicIntimationRaised&searchFlag=Y';
     document.forms[0].submit();
}
function fnSearch()
{
	if( document.forms[0].telephonicId.value=="" &&
		document.forms[0].healthCardNo.value=="" &&
...
function resetSearch()
{
	...
	document.getElementById("healthCardNo").value="";
...
<table width="100%">
<tr>
<td width="25%" class="labelheading1 tbcellCss"><b>Telephonic ID</b></td>
<td width="25%" class="tbcellBorder"><html:text name="telephonicForm" property="telephonicId" styleId="telephonicId" maxlength="12" onchange="validateNumber('Telephonic ID',this)" title="Enter Telephonic ID" style="WIDTH: 20em;border:0;box-shadow:none;"/></td>
<td width="25%" class="labelheading1 tbcellCss"><b>Health Card No</b></td>
<td width="25%" class="tbcellBorder"><html:text name="telephonicForm" property="healthCardNo" styleId="healthCardNo"   title="Enter Health Card No" style="WIDTH: 20em;border:0;box-shadow:none;"/></td>
</tr>
<tr>
<td width="25%" class="labelheading1 tbcellCss"><b>Registered From Date</b></td>
<td width="25%" class="tbcellBorder"><html:text name="telephonicForm" property="fromDate" styleId="fromDate" title="Enter From Date" onkeydown="validateBackSpace(event)" readonly="true" style="WIDTH:18em;border:0;box-shadow:none;"/></td>
<td width="25%" class="labelheading1 tbcellCss"><b>Registered To Date</b></td>
<td width="25%" class="tbcellBorder"><html:text name="telephonicForm" property="toDate" styleId="toDate" title="Enter To Date" onkeydown="validateBackSpace(event)" readonly="true" style="WIDTH:18em;border:0;box-shadow:none;"/></td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
