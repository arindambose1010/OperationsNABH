...
$(document).ready(function() {
	$('#fromDate').datepicker({
		...
		endDate:new Date(new Date(new Date().getTime() - 60*60*24*1000)),
 });	
...
function generate()
{
	if(validate())
	{
		...
		fn_loadImage();
		document.forms[0].action="patientDetailsNew.do?actionFlag=getExpiredReports&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname;
...
function fn_reset()
{
	...
	document.forms[0].action="patientDetailsNew.do?actionFlag=getExpiredReport";
	document.forms[0].submit();
...
function newexportToCsv()
{
	...
	document.forms[0].action = "patientDetailsNew.do?actionFlag=getExpiredReportsCsv&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname;
	document.forms[0].submit();  
...
{	
  ...
  var dispname=document.getElementById('dispname').value;
   ...
   fn_loadImage();
  var url="patientDetailsNew.do?actionFlag=getExpiredReports&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&pageId="+pageId+"&endIndex="+endIndex;
...
<table style="width:80%;margin:1% auto">
	<tr>
		<th colspan="4" class="tbheader">Expired Drugs Report</th>
	</tr>
	<tr>
