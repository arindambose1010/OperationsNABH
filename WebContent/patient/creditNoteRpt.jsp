...
function generate()
{
	if(validate())
	{
		...
		fn_loadImage();
		document.forms[0].action="patientDetailsNew.do?actionFlag=getCreditNoteReports&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&dstrName="+dstrName;
...
function fn_reset()
{
	...
	document.forms[0].action="patientDetailsNew.do?actionFlag=getCreditNoteReport";
	document.forms[0].submit();
...
function newexportToCsv()
{
	...
	var dispname=document.getElementById('dispname').value;
	var dstrName=document.getElementById('dstrName').value;
	document.forms[0].action = "patientDetailsNew.do?actionFlag=getCreditNoteReportsCsv&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&dstrName="+dstrName;
	document.forms[0].submit();  
...
{	
  ...
  var dstrName=document.getElementById('dstrName').value;
  fn_loadImage();
  var url="patientDetailsNew.do?actionFlag=getCreditNoteReports&destDate="+destDate+"&fromDate="+fromDate+"&dispname="+dispname+"&pageId="+pageId+"&endIndex="+endIndex+"&dstrName="+dstrName;
...
<table style="width:80%;margin:1% auto">
	<tr>
		<th colspan="4" class="tbheader">Credit Note Report</th>
	</tr>
	<tr>
...
<logic:present name="patientForm" property="creditNoteList">
<bean:size id="size" name="patientForm" property="creditNoteList"/>
...
<th class="tbheader1 " >CREDIT NOTE ENTERED DATE</th>
...
<logic:iterate name="patientForm" property="creditNoteList" id="labelBean" indexId="cnt">
<tr>
...
<logic:empty name="labelBean" property="DISP_NAME">
 ...
 <logic:notEmpty name="labelBean" property="CRT_DATE">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="CRT_DATE"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="CRT_DATE">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty> 
...
<logic:empty name="labelBean" property="INV_DT">
 <td align="left" class="tbcellBorder" >-NA-</td>
     ...
     <logic:notEmpty name="labelBean" property="RETURN_INV_NUM">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="RETURN_INV_NUM"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="RETURN_INV_NUM">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty>  
 
 
     <logic:notEmpty name="labelBean" property="RETURN_INV_DT">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="RETURN_INV_DT"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="RETURN_INV_DT">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty>  
 
 
 <logic:notEmpty name="labelBean" property="AMOUNT">
<td align="left" class="tbcellBorder" ><bean:write name="labelBean" property="AMOUNT"/></td>
</logic:notEmpty>
<logic:empty name="labelBean" property="AMOUNT">
 <td align="left" class="tbcellBorder" >-NA-</td>
 </logic:empty>  
...
<logic:empty name="patientForm" property="creditNoteList">
