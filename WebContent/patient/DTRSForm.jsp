			...
			<logic:empty name="patientForm" property="investigationLt">
				<tr><td colspan="3" class="labelheading1 tbcellCss print_cell">
					<strong>No Investigations Added</strong>
			          ...
			          <!-- pravalika -->
		          	<tr><td style="text-align:left;" class="tbheader print_heading"><b>3.&nbsp;Investigation&nbsp;Name</b></td></tr>
		<tr><td>
    <c:choose>
      <c:when test="${not empty investigationList}">
        <table width="100%">
          <thead>
            <tr>
              <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>S.No</strong></td>
              <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>Investigation Name</strong></td>
            </tr>
          </thead>
          <tbody>
            <c:forEach var="inv" items="${investigationList}" varStatus="loop">
              <tr>
                <td class="tbcellBorder print_cell">${loop.index + 1}</td>
                <td class="tbcellBorder print_cell">${inv.testName}</td>
              </tr>
            </c:forEach>
          </tbody>
        </table>
      ...
      <c:otherwise>
        <div style="text-align:center;">No Investigations Found</div>
      </c:otherwise>
    </c:choose>
  </td></tr>
		...
		<!-- Drugs list -->
		<tr><td style="text-align:left;" class="tbheader print_heading"><b>4.&nbsp;Drug&nbsp;Details</b></td></tr>
		<tr><td>
		<c:choose>
		 <c:when test="${not empty drugList1}">
			<table width="100%">
			<thead>
				 <tr>
            <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>S.No</strong></td>
            <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>Drug Name</strong></td>
            <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>Dosage</strong></td>
            <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>Medication Period</strong></td>
            <td width="15%" class="labelheading1 tbcellCss print_cell"><strong>Quanity</strong></td>
        </tr>
			</thead>
			<tbody>
       
             <c:forEach var="drug" items="${drugList1}" varStatus="status">
               
                    <tr>
                        <td class="tbcellBorder print_cell">${drug.SNO}</td>
                        <td class="tbcellBorder print_cell">${drug.DRUGNAME}</td>
                        <td class="tbcellBorder print_cell">${drug.DOSAGE}</td>
                        <td class="tbcellBorder print_cell">${drug.MEDICATIONPERIOD}</td>
                        <td class="tbcellBorder print_cell">${drug.UNITAMOUNT}</td>
                    </tr>
              </c:forEach>
             </tbody>
        	</table>
      	...
      	<c:otherwise>
        	<div style="text-align:center;">No Drugs Found</div>
      	</c:otherwise>
    	</c:choose>
		</td></tr>
