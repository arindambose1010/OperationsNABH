...
<tr><td align="left"><b>&nbsp;&nbsp;&nbsp;<fmt:message key="EHF.Title.PatientRegistration"/></b></td>
<!-- <td>
...
<img id="topImage" src="images/back.jpg" width="30" height="20" style=cursor:hand; title="Back" alt="Back" align="top" onclick="javascript:fn_backDrugs()" ></img>
</td>
</tr>
</table>
<br>
...
<tr>
<td width="25%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.ComplaintType"/></b></td>
<td width="25%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.ComplaintCode"/></b></td>
<td width="25%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.PatientComplaint"/></b></td>
<td width="25%" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.PatientComplaintCode"/></b></td>
</tr>
<tr>
...
<tr>
<td colspan="2" valign="top" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.HistoryOfPresentIllness"/></b></td>
<td colspan="2" valign="top" rowspan="3"  class="tbcellBorder">
	<fieldset style="width:98%">
 		<legend class="legendStyle"><b><fmt:message key="EHF.ExaminationFindings"/></b></legend>
		<table width="100%">
...
<tr><td colspan="2" class="tbcellBorder">
 <fieldset style="width:98%">
 		<legend class="legendStyle"><b><fmt:message key="EHF.PersonalHistory"/></b></legend>
 		<table width="100%" >
...
<tr>
<td class="labelheading1 tbcellCss mainSymptoms"><b><fmt:message key="EHF.MainSymptomName"/></b></td>
<td class="labelheading1 tbcellCss mainSymptoms"><b><fmt:message key="EHF.MainSymptomCode"/></b></td>
<td class="labelheading1 tbcellCss mainSymptoms"><b><fmt:message key="EHF.SubSymptomName"/></b></td>
<td class="labelheading1 tbcellCss mainSymptoms"><b><fmt:message key="EHF.SubSymptomCode"/></b></td>
</tr>
<tr>
...
<tr>
<td class="labelheading1 tbcellCss mainSymptoms"><b><fmt:message key="EHF.SymptomName"/></b></td>
<td class="labelheading1 tbcellCss mainSymptoms"><b><fmt:message key="EHF.SymptomCode"/></b></td>
</tr>
<tr>
...
<tr><td colspan="4" class="tbcellBorder">
  <table  width="100%" id="genTestTableID" style="display:none;border-collapse:collapse;border:1px solid #c5f7de" border="1">
     	...
     	<tr>
        	...
        	<th class="tbheader1"width="20%" ><b><fmt:message key="EHF.TestName"/></b></th>   
        	<th class="tbheader1"width="20%"><b><fmt:message key="EHF.Attachment"/></b></th>
...
<!-- <td id="toDispatchTd" class="labelheading1 tbcellCss"><button class="btn btn-success" id="toDispatch"  type="button" onclick="javascript:fn_enablePharma()" disabled>Dispatch Drugs</button></td> --></logic:notEqual>
</tr>
</table>
</td></tr>
...
<logic:present name="patientForm" property="pastDrugHist">
        ...
        <thead><tr>
        <th colspan='12' class="tbheader existDrugs" style="text-align: center;"><b>Dispatched Drug History (Past 10 days)</b></th></tr>
        </thead>
        <tbody style="display: block;max-height: 300px;overflow-y: auto;overflow-x: hidden;">  
        <tr>
      	<th width="5%" class="tbheader1 existDrugs">S.NO</th>
      	<th width="10%" class="tbheader1 existDrugs">PAST PATIENT NO</th>
		<th width="10%" class="tbheader1 existDrugs">PAST CASE NO</th>      	        
        <th width="10%" class="tbheader1 existDrugs">DRUG TYPE</th>   
       	<th width="10%" class="tbheader1 existDrugs">DRUG NAME</th>
       	<th width="5%" class="tbheader1 existDrugs">ROUTE</th> 
       	<th width="5%" class="tbheader1 existDrugs">STRENGTH</th>
       	<th width="5%" class="tbheader1 existDrugs">DOSAGE</th>  
       	<th width="5%" class="tbheader1 existDrugs">MEDICATION PERIOD</th> 
       	<th width="5%" class="tbheader1 existDrugs">QUANTITY</th>
       	<th width="20%" class="tbheader1 existDrugs">DISPENSARY NAME</th>
       	<th width="10%" class="tbheader1 existDrugs">ISSUED DATE</th>
        </tr>
		<%int k = 1;%>
...
<tr class="existDrugsHead"><td colspan="4" class="existDrugsHead" style="display:none" class="labelheading1 tbcellCss"><font size="2px">Existing Drugs</font></td></tr>
<tr class="existDrugsHead"><td colspan="4" class="tbcellBorder">
...
<tr>
<td width="25%" class="tbheader1 existDrugs"><b>Drug Type</b> <font color="red" >*</font></td>
<td width="25%" class="tbheader1 existDrugs"><b>Drug Name</b><font color="red" >*</font></td>
<td width="25%" class="tbheader1 existDrugs" id="otherDrugLabel" style="display:none;"><b>Other Drug Name</b><font color="red" >*</font></td>
<td width="25%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.Route"/></b></td>
</tr>
<tr>
<td valign="top" class="tbcellBorder existDrugs">
...
<tr>
<td width="25%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.Strength"/></td>
<td width="25%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.Dosage"/></b></td>
<td width="25%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.MedicationPeriod"/></b></td>
<!-- <td width="25%" class="tbheader1 existDrugs"><b>Quantity</b><font color="red" >*</font> </td> -->
</tr>
...
<div id='drugsContent' style="overflow:auto; overflow-y:hidden"> 
  <table  width="95%"  id="drugsTable" style="display:none;margin: 0 auto !important;text-align:center" border="1">
      <tr>  
      	<td width="5%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.SNO"/></b></td>        
        <td width="10%" class="tbheader1 existDrugs"><b>Drug Type</b></td>   
        <td width="10%" class="tbheader1 existDrugs"><b>Drug Name</b></td> 
        <td width="5%" class="tbheader1 existDrugs"><b>Route Type</b></td>
        <td width="10%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.Route"/></b></td>
        <td width="5%" class="tbheader1 existDrugs"><b>Strength Type</b></td>
        <td width="10%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.Strength"/></b></td>
        <td width="5%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.Dosage"/></b></td>
        <td width="5%" class="tbheader1 existDrugs"><b><fmt:message key="EHF.MedicationPeriod"/></b></td>
        <td width="5%" class="tbheader1 existDrugs"><b>Quantity</b></td>
        <td width="5%" class="tbheader1 existDrugs"><b>Issuing Set</b></td>
...
{
	var =document.getElementById('asriCatName');
...
var addition='${PatientOpList.test}';var additionKnown='${PatientOpList.testKnown}';
	...
	else
	{
		...
		function OtherDrugValid(){
			if($("#drugSubTypeCode option:selected").text()=="Others"){
...
// 		alert("Please select Drug Type");
		$("#drugSubTypeCode, #routeType, #route, #strengthType, #strength, #dosage").val('-1');
		document.getElementById("medicatPeriod").value="";
		$("#drugSubTypeCode, #routeType, #route, #strengthType, #strength, #dosage").select2().val('');
...
$(document).ready(function(){
  ...
  if(jq("#ipOpTable:visible").is(":visible") == false)	
	jq("#ipOpTable").parent().css({"border":"0px","background-color":"white"});
  if(jq("#genTestTableID").find('table:visible').is(":visible")== false)	
		jq("#genTestTableID").parent().css({"border":"0px","background-color":"white"});
  if(jq("#genTestTable").is(":visible")== false)	
		jq("#genTestTable").parent().css({"border":"0px","background-color":"white"});
  if(jq("#drugsTable:visible").is(":visible") == false)	
		jq("#drugsTable").parent().parent().css({"border":"0px","background-color":"white"});
  if(jq("#drugInfo:visible").is(":visible") == false)	
		jq("#drugInfo").parent().css({"border":"0px","background-color":"white"});
});
</script>
