...
function fn_generateFiles(){
	...
	var url = "attachmentAction.do?actionFlag=onload&UpdType="+UpdType+"&caseAttachmentFlag=CP&fromDatePay="+document.forms[0].fromDate.value+"&toDatePay="+document.forms[0].toDate.value+"&flag="+flag+"&folderFlag="+folderFlag;
...
<c:if test="${(loopCount % 3) eq 1}">
 ...
 <a href="javascript:this.style.color = 'brown';fn_openAtachment('${attMap.filePath}');return false;" title="${attMap.fileName}">${attMap.fileName}&nbsp;&nbsp;</a>
 </td>
