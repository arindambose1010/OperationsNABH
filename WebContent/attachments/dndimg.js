...
for(i=0;i<count;i++)
{
	...
	if(isExeCorrect==true && isSizeCorrect==true)
	{
     ...
     xhr.open("POST","dataentry?actionFlag=uploadPreauthAttachments&docType="+docType+"&caseId="+caseId+"&attachType="+cmbDtlId, true);
     ...
     xhr.onload = function(e) {
         ...
         if (this.status == 200) {
        	 ...
        	 alert(result);
        	 url="attachmentAction.do?actionFlag=onload&UpdType=ehfPreauth&caseId="+caseId+"&caseAttachmentFlag=Y";      
