...
<link href="css/themes/<%=themeColour%>/commonEhfCss.css" rel="stylesheet" type="text/css" media="screen">
		 <script src="Preauth/autoComplete/jquery.js"></script> 
	<script src="Preauth/autoComplete/jquery-ui-autocomplete.js"></script> 
	 <script src="Preauth/autoComplete/jquery.select-to-autocomplete.min.js"></script>
...
function fn_getICDCatList()
{
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getIcdCatList&catId='+document.forms[0].category.value;
