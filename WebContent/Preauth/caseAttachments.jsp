...
function right(e) 
{
	...
	function validate()
	{
         ...
         if(falg=='success')
           {
        	 document.CaseAttachments.action="preauthDetails.do?actionFlag=uploaddCaseAttach&caseId=${caseId}&surgId=${surgeryId}&splinvestid=${investId}&spltype=${spltType}";
	...
	function fn_delete1(sno,filename)
	{
	 ...
	 document.CaseAttachments.action="preauthDetails.do?actionFlag=deleteSplInvstAttch&caseId=${caseId}&surgId=${surgeryId}&splinvestid=${investId}&spltype=${spltType}&sno="+sno;
     document.CaseAttachments.submit(); 
...
<tr><td >
<a href="javascript:" onclick="javascript:this.style.color = 'brown';fn_openAtachment('<bean:write name="result" property="savedName"/>','<bean:write name="result" property="savedName"/>');return false;"><bean:write name="result" property="fileName"/></a>
