...
parent.parent.parent.fpInitPage = window.open('followUpAction.do?actionFlag=followUpinit&caseId=${caseId}','followUpWin','toolbar=no,resize=yes,scrollbars=yes,width=925, height=500, top=50,left=50');	
}
function fn_openCochlearFollowUp()
	{
		parent.parent.parent.cochFpInitPage = window.open('followUpAction.do?actionFlag=cochFollowUpinit&caseId=${caseId}','cochFollowUpWin','toolbar=no,resize=yes,scrollbars=yes,width=1000, height=500, top=50,left=10');		
	}
...
/* 	alert('addClinicNotesFlag---'+'${addClinicNotesFlag}');
	...
	/*if('${addClinicNotesFlag}' != null && '${addClinicNotesFlag}' !=''&& '${addClinicNotesFlag}'=='Y')
		{
		$(function() {
...
function chkDate()
{
	...
	if(x!=null && x!="")
	{
	 ...
	 var z =y[2].split(" ");
	 var u = z[1].split(":");
	 var selDt=new Date(z[0], y[1]-1, y[0], u[0], u[1]);
	
	if(selDt> lCurentDtTime){
		alert("please select date less than current date & time");
...
function fn_savePostClinicalNotes(flag)
{
	...
	{		
		...
		/* else
		{
			...
			{
				document.getElementById("SavePostNotesBut").disabled=true;
				document.forms[0].action="clinicalNotesAction.do?actionFlag=saveClinicalNotes&caseId=${caseId}&prePostFlag="+flag;
				document.forms[0].submit();
			}
			else
			{
...
if(attachType != null && attachType =='surgery')
	...
	if(	(document.forms[0].deathDate != null && document.forms[0].deathDate.value != null && document.forms[0].deathDate.value != ''))
		{
		url = "attachmentAction.do?actionFlag=onload&UpdType=ehfClinicalSugeryDeath&caseId=${caseId}&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&caseApprovalFlag=Y";
		}
	else
		url = "attachmentAction.do?actionFlag=onload&UpdType=ehfClinicalSugery&caseId=${caseId}&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&caseApprovalFlag=Y";
	}
if(attachType != null && attachType =='discharge')
{
		url = "attachmentAction.do?actionFlag=onload&UpdType=ehfClinicaldischarge&caseId=${caseId}&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&caseApprovalFlag=Y";
			
}
if(attachType != null && attachType =='death')
{
		url = "attachmentAction.do?actionFlag=onload&UpdType=ehfClinicaldischargeDeath&caseId=${caseId}&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&caseApprovalFlag=Y";	
}
...
function fn_saveClinicalNotes(flag)
{
	...
	{		
		...
		{
			document.forms[0].action="clinicalNotesAction.do?actionFlag=saveClinicalNotes&caseId=${caseId}&prePostFlag="+"PRE";
			document.forms[0].submit();
		}			
	} */
...
if(confirm("Do you Wish To Print Discharge Summary Form ?"))
{
	...
	var url="clinicalNotesAction.do?actionFlag=printDischargeForm&caseId=${caseId}";	
	...
	if((document.getElementById("discharge").checked!='' && document.getElementById("discharge").checked==true))
{
	...
	var url='clinicalNotesAction.do?actionFlag=dischSumryUpdate&saveSubmitFlag='+flag+'&disDeathFlag='+dischargeDeathFlag;
	var surgerySelDate=document.forms[0].surgStartDt.value;
	...
	{				
		 ...
		 if((document.getElementById("discharge").checked!='' && document.getElementById("discharge").checked==true))
		{
			...
			else if(document.forms[0].ipNum.value=='')
			{
				if(errMsgF=='')
					errMsgF=errMsgF+"Please enter IP No.  "; 
				if(lField=='')
			        lField='ipNum'; 
				//alert('Please enter consult room No.');	
				//document.forms[0].disroomNo.focus();
	...
	else if((document.getElementById("death").checked!='' && document.getElementById("death").checked==true))
	{
...
function fn_testMandatoryAttach(varType,attachType,dischargeUrl)
	{
		...
		else
		{
		 ...
		 url = 'preauthDetails.do?actionFlag=checkMandatoryAttch&caseId='+caseId+'&attachType='+attachType;
...
function saveSurgeryConfirm()
{
			document.getElementById("SaveSurgeryBut").disabled=true;
			document.getElementById('addViewAttachSur').disabled=true;
			document.forms[0].action="clinicalNotesAction.do?actionFlag=saveSurgeryDate&caseId=${caseId}&medicalFlag=${medicalFlag}";
			document.forms[0].submit();
	}
...
{
	parent.fn_ipRefresh();
	var url="clinicalNotesAction.do?actionFlag=clinicalNotes&caseId=${caseId}&notesType=PRE";
	document.forms[0].action=url;
...
{
	var url="clinicalNotesAction.do?actionFlag=generateSatisfactionLetter&caseId=${caseId}";
	childWindow=window.open(url, '_blank','toolbar=no,resizable=yes,scrollbars=yes,width=960, height=600, top=100,left=50');
}
						...
						<table border="0" width="100%" cellpadding="1" cellspacing="1"
							...
							<tr>
								<td class="tbcellBorder"><html:text style="width:85px"
										...
										styleId="invesgtnDate"  readonly="true" title="Please select date" value="${currDt}"></html:text> <!--   <img src="images/calend.gif" align="absmiddle" width="21" height="21" onclick="javascript:window_open('invesgtnDate','150','470')" alt="Calendar" title="Calendar"></img> -->
								</td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="infsnStrtDtC" styleId="infsnStrtDtC" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('infsnStrtDtC','150','470')" alt="Calendar"></img></td>
<td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="infsnEndDtC" styleId="infsnEndDtC" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('infsnEndDtC','150','470')" alt="Calendar"></img></td>
<td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="infsnStrtDtB" styleId="infsnStrtDtB" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('infsnStrtDtB','150','470')" alt="Calendar"></img></td>
<td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="infsnEndDtB" styleId="infsnEndDtB" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('infsnEndDtB','150','470')" alt="Calendar"></img></td>
<td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="infsnStrtDtR" styleId="infsnStrtDtR" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('infsnStrtDtR','150','470')" alt="Calendar"></img></td>
<td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="infsnEndDtR" styleId="infsnEndDtR" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('infsnEndDtR','150','470')" alt="Calendar"></img></td>
<td>
...
<td><html:text style="width:80px" name="clinicalNotesForm" property="fieldDt" styleId="fieldDt" readonly="true"></html:text>
            <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('fieldDt','150','470')" alt="Calendar"></img></td>
<td>
...
-->
 ...
 <html:text style="width:70px" name="clinicalNotesForm" property="treatSurgStartDt" styleId="treatSurgStartDt" readonly="true"></html:text>
           <c:if test="${lStrTrmtMedicalSubmitFlag !='Y' }" >   <!-- <img src="images/calend.gif" onclick="javascript:window_open('treatSurgStartDt','150','470')" alt="Calendar" title="Calendar"></img> -->
           </c:if>
</td> --%>
								</tr>
								<!--<tr>
 ...
 <html:text style="width:70px" name="clinicalNotesForm" property="treatDeathDate" styleId="treatDeathDate" readonly="true"></html:text>
      <c:if test="${lStrTrmtMedicalSubmitFlag !='Y' }" >    <!--  <img src="images/calend.gif" onclick="javascript:window_open('treatDeathDate','150','470')" alt="Calendar" title="Calendar"></img> -->
      </c:if>
</td> </tr>--%>
								...
								<c:if test="${medMgmtFlag== 'Y'}">
									...
									<tr>
										<td class="tbcellBorder">&nbsp; <html:text
											...
											<!--   <img src="images/calend.gif" onclick="javascript:window_open('surgStartDt','150','470')" alt="Calendar" title="Calendar"></img> -->
										</td>
										<td class="tbcellBorder">&nbsp; <html:text
											...
											<!--   <img src="images/calend.gif" onclick="javascript:window_open('deathDate','150','470')" alt="Calendar" title="Calendar"></img> -->
										</td>
									</tr>
								</c:if>
								<!--  If surgery -->
										...
										<c:if
											...
											<tr>
												<td class="tbcellBorder">&nbsp; <html:text
														...
														readonly="true"></html:text> <!--   <img src="images/calend.gif" onclick="javascript:window_open('surgStartDt','150','470')" alt="Calendar" title="Calendar"></img> -->
												</td>
...
<td>&nbsp;Ward Out Time</td> -->
									...
									<tr>
										...
										<td class="tbcellBorder"><html:text style="width:80px"
												...
												styleId="invesgtnDate1"  readonly="true"></html:text> <!-- <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('invesgtnDate1','150','470')" alt="Calendar" title="Calendar"></img> -->
										</td>
						...
						<td colspan="4">
							<div id="dischargeDiv" style="display:none">
								<table border="0" width="100%" cellpadding="1" cellspacing="1"
									...
									<tr>
										<td class="tbcellBorder"><html:text style="width:140px"
												...
												<!--   <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('disDate','150','470')" alt="Calendar" title="Calendar"></img> -->
											</c:if></td>
										<td class="tbcellBorder"><html:text style="width:80px"
												...
												test="${DischargeSumryButFlag!='N'}">
												<!--  <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('nxtFollUpDt','150','470')" alt="Calendar" title="Calendar"></img> -->
											</c:if></td>
										<td class="tbcellBorder"><html:text
									...
									<td class="labelheading1 tbcellCss">&nbsp;Room No.<span
											...
											<td class="labelheading1 tbcellCss">&nbsp;IP No.<span
											class="mandatory">*</span>
										</td>
									</tr>
									<tr>
									<td class="tbcellBorder"><html:text title="Please enter room no"
										...
										<td class="tbcellBorder"><html:text title="Please enter Ip no"
												name="clinicalNotesForm" styleId="ipNum" maxlength="40"
												property="ipNum"
												onchange="javascript:chkAlphaNumeric('ipNum','IP No');"  />
										</td>
								...
								<table border="0" width="100%" cellpadding="1" cellspacing="1"
									...
									<tr>
										<td class="tbcellBorder"><html:text style="width:80px"
												...
												<!--   <img src="images/calend.gif" align="absmiddle" onclick="javascript:window_open('disDeathDate','150','470')" alt="Calendar" title="Calendar"></img> -->
											</c:if></td>
										<td class="tbcellBorder"><html:textarea rows="2" cols="20"
