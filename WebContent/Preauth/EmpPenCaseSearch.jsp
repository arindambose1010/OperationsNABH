...
background-color: #B8E6E6;
				...
				<script>
					...
					{
						var caseId='${casesSearchForm.caseId}';
						document.forms[0].action='casesApprovalAction.do?actionFlag=searchFormPagin&employeeNo=${employeeNo}&fromPastHistory=${fromPastHistory}&paginStatus='+res+'&caseId='+caseId;
					...
					function search()
					{
						...
						document.forms[0].action='casesApprovalAction.do?actionFlag=caseSearchCriteria&employeeNo=${employeeNo}&fromPastHistory=${fromPastHistory}';
						document.forms[0].submit();
					} 
						...
						else
						{
							...
							if(caseStatus!=null && caseStatus!='' && caseStatus=='CD2')
							{
								if(pastHistory!=null && pastHistory!='' && pastHistory=='Y')
									{								
									url='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&casesForApproval=N&ipOpType='+ipOp;
								...
								url="preauthDetails.do?actionFlag=casePrintForm&patientId="+patientId+"&caseId="+caseNo+"&decFlag=N";
							//	url='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+""+'&casesForApproval=N&ipOpType='+ipOp;
					...
					{
						attachmentWin= window.open("attachmentAction.do?actionFlag=onload&UpdType=ehfPreauth&caseId="+caseId+"&caseAttachmentFlag=Y&openWin=Y", 'window1','toolbar=no,resize=no,scrollbars=yes,width=800, height=600, top=100,left=50');
					}
					</script>
			</head>
			<body>
