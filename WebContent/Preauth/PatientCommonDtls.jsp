...
function CasesView()  
{	
     var url='casesSearchAction.do?actionFlag=OnloadCaseSearch&caseSearchType=ipTab&CaseId=${caseId}&flag=N&casesForApproval='+parent.caseApprovalFlag+'&errSearchType='+parent.errSearchType+'&disSearchType='+parent.disSearchType+'&module='+parent.module+'&exceedFlg='+exceedFlg;
...
function fn_showQuestionnaire(caseId){
	...
	var url='medicalAudit.do?actionFlag=getQuestionnaire&caseId='+caseId+'&purpose=show';      
	   document.forms[0].action=url;   
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
}
...
function fn_viewQuestionnaire(caseId,fromPage){
	...
	var url='medicalAudit.do?actionFlag=getQuestionnaire&caseId='+caseId+'&purpose=view&fromPage='+fromPage;       
	   document.forms[0].action=url;   
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
}
function fn_PastData()
{
   ...
   var url="casesApprovalAction.do?actionFlag=getPastHistory&employeeNo=${patCommonDtls.EMPLOYEENO}&fromPastHistory=Y&caseId=${caseId}";
   document.forms[0].action=url;   
   document.forms[0].target="bottomFrame";
   document.forms[0].submit();	
}
function fn_newUser()
{
	var url="casesApprovalAction.do?actionFlag=getnewUser&patientId=${patCommonDtls.PATID}&cardNo=${patCommonDtls.CARDNO}&caseId=${caseId}&employeeNo=${patCommonDtls.EMPLOYEENO}&fromPastHistory=Y";
	 document.forms[0].action=url;   
	 document.forms[0].target="bottomFrame";
	 document.forms[0].submit();	
}
function fn_attachments()
{
	...
	var url="attachmentAction.do?actionFlag=onload&UpdType=ehfPreauthNabh&caseId=${caseId}&caseAttachmentFlag=Y&caseApprovalFlag="+parent.caseApprovalFlag+'&errSearchType='+parent.errSearchType+'&disSearchType='+parent.disSearchType+'&module='+parent.module;
	//alert(url);
	   document.forms[0].action=url;   
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
...
{
	var url="preauthDetails.do?actionFlag=getOnlineCaseSheet&caseId=${caseId}&patientId=${patCommonDtls.PATID}&caseSheetFlag="+caseSheetFlag+"&dentalFlg="+dentalFlg;;      
	   document.forms[0].action=url;   
	  // alert(url);
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
...
function raiseIssue()
{	
	var url="raiseIssueAction.do?flag=raiseCms&caseId=${caseId}&hospId=${patCommonDtls.INTIID}&hospName=${patCommonDtls.HOSPNAME}";
