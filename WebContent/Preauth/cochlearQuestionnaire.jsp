...
return false;
	...
	var caseId='${caseId}';
	document.forms[0].action='preauthDetails.do?actionFlag=saveCochlearQuestionnaire&caseId='+caseId;
...
document.forms[0].action='preauthDetails.do?actionFlag=cochlearQuestionnaire&type=enable&CaseId='+caseId;
