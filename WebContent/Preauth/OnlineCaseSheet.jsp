...
if('${dentalDtls}' !=''){
	var softTissue=document.forms[0].softTissue;
	var softTissueVal;
	if('${dentalDtls.softTissue}'!='')
	{
		softTissueVal='${dentalDtls.softTissue}'.split("~");
		for(var i=0;i<softTissue.length;i++)
	    {
			for(var j=0;j<softTissueVal.length;j++)
			{
				if(softTissue[i].value==softTissueVal[j])
				{
					softTissue[i].checked=true;
				}
			}
		} 
	}

	var deciduosDentition=document.forms[0].deciduosDentition;
	var deciduosDentitionVal;
	if('${dentalDtls.deciduosDentition}'!='')
	{
		deciduosDentitionVal='${dentalDtls.deciduosDentition}'.split("~");
		for(var i=0;i<deciduosDentition.length;i++)
	    {
			for(var j=0;j<deciduosDentitionVal.length;j++)
			{
				if(deciduosDentition[i].value==deciduosDentitionVal[j])
				{
					deciduosDentition[i].checked=true;
				}
			}
		} 
	}
	var missing=document.forms[0].missingTeeth;
	var missingVal;
	if('${dentalDtls.missing}'!='')
	{
		missingVal='${dentalDtls.missing}'.split("~");
		for(var i=0;i<missing.length;i++)
	    {
			for(var j=0;j<missingVal.length;j++)
			{
				if(missing[i].value==missingVal[j])
				{
					missing[i].checked=true;
				}
			}
		} 
	}
	var caries=document.forms[0].caries;
	var cariesVal;
	if('${dentalDtls.caries}'!='')
	{
		cariesVal='${dentalDtls.caries}'.split("~");
		for(var i=0;i<caries.length;i++)
	    {
			for(var j=0;j<cariesVal.length;j++)
			{
				if(caries[i].value==cariesVal[j])
				{
					caries[i].checked=true;
				}
			}
		} 
	}
	var decayed=document.forms[0].decayed;
	var decayedVal;
	if('${dentalDtls.decayed}'!='')
	{
		decayedVal='${dentalDtls.decayed}'.split("~");
		for(var i=0;i<decayed.length;i++)
	    {
			for(var j=0;j<decayedVal.length;j++)
			{
				if(decayed[i].value==decayedVal[j])
				{
					decayed[i].checked=true;
				}
			}
		} 
	}
	...
	var mobileVal;
	if('${dentalDtls.mobile}'!='')
	{
		mobileVal='${dentalDtls.mobile}'.split("~");
		for(var i=0;i<mobile.length;i++)
	    {
			for(var j=0;j<mobileVal.length;j++)
			{
				if(mobile[i].value==mobileVal[j])
				{
					mobile[i].checked=true;
				}
			}
		} 
	}

	var attrition=document.forms[0].attrition;
	var attritionVal;
	if('${dentalDtls.attrition}'!='')
	{
		attritionVal='${dentalDtls.attrition}'.split("~");
		for(var i=0;i<attrition.length;i++)
	    {
			for(var j=0;j<attritionVal.length;j++)
			{
				if(attrition[i].value==attritionVal[j])
				{
					attrition[i].checked=true;
				}
			}
		} 
	}
	...
	var probeDepthVal;
	if('${dentalDtls.probeDepth}'!='')
	{
		probeDepthVal='${dentalDtls.probeDepth}'.split("~");
		for(var i=0;i<probeDepth.length;i++)
	    {
			for(var j=0;j<probeDepthVal.length;j++)
			{
				if(probeDepth[i].value==probeDepthVal[j])
				{
					probeDepth[i].checked=true;
				}
			}
		} 
	}
...
function fn_Print()
{
	...
	{
		url="preauthDetails.do?actionFlag=getOnlineCaseSheet&caseId=${caseId}&patientId=${patientId}&caseSheetFlag=Y&closeBut=Y&forPrint=Y&dentalFlg="+'${dentalFlg}';     
...
{  
    ...
    var url = "attachmentAction.do?actionFlag=viewAttachment&filePath="+filepath+"&fileName="+fileName;
...
<c:if test="${fn:length(dentalDtls) > 0}">					
<tr id="dopBlock" >
<tr><td colspan="6" class="tbheader print_heading"><b>DENTAL EXAMINATIONS</b></td></tr>
<tr><td colspan="6">
<table width="100%">
<tr><td colspan="6" class="labelheading1 tbcellCss print_cell"><b>INTRA ORAL EXAMINATIONS</b></td></tr>
<tr><td><table width="100%">
<tr><td class="labelheading1 tbcellCss print_cell" colspan="6"><b>Soft Tissue Examination</b></td></tr>
<tr><td colspan="6"><table style="width:100%">
 <tr><td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Gingiva" id="softTissue" name="softTissue">  Gingiva</td>
<td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Buccal Mucosa" id="softTissue" name="softTissue">  Buccal Mucosa</td>
<td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Frenal Attachment" id="softTissue" name="softTissue">  Frenal Attachment</td>
<td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Tongue" id="softTissue" name="softTissue">  Tongue</td></tr>
<tr><td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Floor of the mouth" id="softTissue" name="softTissue">  Floor of the mouth</td>
<td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Soft Palate" id="softTissue" name="softTissue">  Soft Palate</td>
<td class="tbcellBorder"><input type="checkbox" disabled="disabled" value="Hard Palate" id="softTissue" name="softTissue">  Hard Palate</td></tr>
</table></td></tr>
<tr><td  class="labelheading1 tbcellCss print_cell" colspan="6"><b>  Hard Tissue Examination</b></td></tr>
<tr><td colspan="3" class="labelheading1 tbcellCss print_cell"><b>Deciduous Dentition</b></td><td colspan="3" class="labelheading1 tbcellCss print_cell"> <b>Missing </b></td></tr>
<tr><td colspan="3" align="center" class="tbcellBorder"><div style="width:70%;"><input type="checkbox" disabled="disabled" id="deciduosDentition"  name="deciduosDentition" value="ULE"> E 
<input type="checkbox" name="deciduosDentition" disabled="disabled" id="deciduosDentition" value="ULD"> D 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="ULC"> C <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="ULB">B 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="ULA"> A | <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="URA"> A <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="URB"> B 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="URC"> C <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="URD">D 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="URE"> E
<hr style="margin-bottom:0px;margin-top:0px; color: black; height: 1px; background-color:black;"/>
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="LLE"> E <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="LLD"> D 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="LLC"> C <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="LLB">B 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="LLA"> A |  <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="LRA"> A <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="LRB"> B 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="LRC"> C <input type="checkbox" disabled="disabled" name="deciduosDentition" id="deciduosDentition" value="LRD">D 
<input type="checkbox" id="deciduosDentition" disabled="disabled" name="deciduosDentition" value="LRE"> E</div>
</td>
<td colspan="3" align="center" class="tbcellBorder"><div style="width:70%;"><input type="checkbox" id="missingTeeth" disabled="disabled" name="missingTeeth" value="ULE"> E <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth"  value="ULD"> D 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="ULC"> C <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="ULB">B 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="ULA"> A  | <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="URA">A <input type="checkbox" disabled="disabled" name="missingTeeth" id="missingTeeth" value="URB"> B 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="URC"> C <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="URD">D 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="URE"> E
<hr style="margin-bottom:0px;margin-top:0px; color: black; height: 1px; background-color:black;"/>
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LLE"> E <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LLD"> D 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LLC"> C <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LLB">B 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LLA"> A  | <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LRA"> A <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LRB"> B 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LRC"> C <input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LRD">D 
<input type="checkbox" disabled="disabled" id="missingTeeth" name="missingTeeth" value="LRE"> E</div></td></tr>
<tr><td colspan="3" class="labelheading1 tbcellCss print_cell"><b>Caries</b></td><td colspan="3" class="labelheading1 tbcellCss print_cell"><b>Root stump / Grossly Decayed</b> </td></tr>
<tr><td colspan="3" align="center" class="tbcellBorder"><div style="width:95%;"><input type="checkbox" disabled="disabled" id="caries" name="caries" value="UL8">8 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="UL7">7 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="UL6">6 <input type="checkbox" id="caries" disabled="disabled" name="caries" value="UL5">5
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="UL4">4 <input type="checkbox" id="caries" disabled="disabled" name="caries" value="UL3"> 3 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="UL2">2 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="UL1">1 | <input type="checkbox" id="caries" disabled="disabled" name="caries" value="UR1">1 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="UR2">2 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="UR3">3 <input type="checkbox" id="caries" disabled="disabled" name="caries" value="UR4">4 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="UR5">5 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="UR6">6 <input type="checkbox" id="caries" disabled="disabled" name="caries" value="UR7">7  <input type="checkbox" disabled="disabled" id="caries" name="caries" value="UR8">8 
<hr style="margin-bottom:0px;margin-top:0px; color: black; height: 1px; background-color:black;"/>
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL8">8 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL7">7 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL6">6 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL5">5
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL4">4 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL3">3 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL2">2 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="LL1">1 | <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR1">1 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR2">2 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR3">3 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR4">4 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR5">5 
<input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR6">6 <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR7">7  <input type="checkbox" disabled="disabled" id="caries" name="caries" value="LR8">8
</div></td>
<td colspan="3" align="center" class="tbcellBorder"><div style="width:98%;"><input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL8">8 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL7">7 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL6">6 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL5">5
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL4">4 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL3">3 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL4">4 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UL1">1 | <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR1">1 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR2">2 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR3">3 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR4">4 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR5">5 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR6">6 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR7">7  <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="UR8">8 
<hr style="margin-bottom:0px;margin-top:0px; color: black; height: 1px; background-color:black;"/>
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL8">8 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL7">7 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL6">6 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL5">5
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL4">4 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL3">3 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL2">2 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LL1">1 | <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR1">1 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR2">2 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR3">3 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR4">4 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR5">5 
<input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR6">6 <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR7">7  <input type="checkbox" disabled="disabled" id="decayed" name="decayed" value="LR8">8
</div></td>
</tr>
<tr><td colspan="3" class="labelheading1 tbcellCss print_cell"><b>Mobile</b></td><td colspan="3" class="labelheading1 tbcellCss print_cell"><b>Attrition / Abrasion</b> </td></tr>
<tr><td colspan="3" align="center" class="tbcellBorder"><div style="width:95%;"><input type="checkbox" id="mobile" disabled="disabled" name="mobile" value="UL8">8 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL7">7 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL6">6 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL5">5
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL4">4 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL3">3 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL4"> 4 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UL1">1 | <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR1">1 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR2">2 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR3">3 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR4">4 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR5">5 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR6">6 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR7">7  <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="UR8">8 
<hr style="margin-bottom:0px;margin-top:0px; color: black; height: 1px; background-color:black;"/>
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL8">8 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL7">7 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL6">6 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL5">5
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL4">4 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL3">3 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL2">2 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LL1">1 | <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR1">1 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR2">2 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR3">3 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR4">4 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR5">5 
<input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR6">6 <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR7">7  <input type="checkbox" disabled="disabled" id="mobile" name="mobile" value="LR8">8
</div></td>
<td colspan="3" align="center" class="tbcellBorder"><div style="width:98%;"><input type="checkbox" id="attrition" name="attrition" disabled="disabled" value="UL8">8 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UL7">7 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UL6">6 <input type="checkbox" id="attrition" disabled="disabled" name="attrition" value="UL5">5
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UL4">4 <input type="checkbox" id="attrition" disabled="disabled" name="attrition" value="UL3">3 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UL4"> 4 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UL1">1 | <input type="checkbox" id="attrition" disabled="disabled" name="attrition" value="UR1">1 <input type="checkbox" disabled="disabled"  id="attrition" name="attrition" value="UR2">2 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UR3">3 <input type="checkbox" id="attrition" disabled="disabled" name="attrition" value="UR4">4 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UR5">5 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UR6">6 <input type="checkbox" id="attrition" disabled="disabled" name="attrition" value="UR7">7  <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="UR8">8 
<hr style="margin-bottom:0px;margin-top:0px; color: black; height: 1px; background-color:black;"/>
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL8">8 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL7">7 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL6">6 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL5">5
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL4">4 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL3">3 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL2">2 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LL1">1 | <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR1">1 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR2">2 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR3">3 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR4">4 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR5">5 
<input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR6">6 <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR7">7  <input type="checkbox" disabled="disabled" id="attrition" name="attrition" value="LR8">8
</div></td>
</tr>
<tr> <td class="labelheading1 tbcellCss print_cell" width="12%" align="left"><b>Previous Dental Treatment</b> </td>
<td align="left" class="tbcellBorder print_cell">${dentalDtls.previousDentalTreatment}</td>
<td class="labelheading1 tbcellCss print_cell" width="12%" align="left"><b>Occlusion</b> </td>
<td align="left" class="tbcellBorder print_cell">${dentalDtls.occlusion}</td>
<td class="labelheading1 tbcellCss print_cell" width="12%" align="left"><b>TMJ</b> </td>
<td align="left" class="tbcellBorder print_cell">${dentalDtls.tmj}</td>

</tr>
<tr><td  class="labelheading1 tbcellCss print_cell" colspan="2"><b>Clinical Probing Depth</b></td><td colspan="4" class="tbcellBorder" align="center">
<input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L8"> 8 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L7"> 7 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L6"> 6 
<input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L5"> 5 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L4"> 4 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L3"> 3 
<input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L2"> 2  <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="L1"> 1 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R1"> 1
<input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R2"> 2  <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R3"> 3 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R4"> 4 
<input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R5"> 5 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R6"> 6 <input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R7"> 7 
<input type="checkbox" disabled="disabled" id="probeDepth" name="probeDepth" value="R8"> 8 
							...
							<table border="0" width="100%" align="center" class="tbcellBorder print_cell">
								...
								<c:if test="${fn:length(genInvestList) >0 }">
									...
									<tr>
										...
										<td colspan="2" width="33%" class="tbcellBorder print_cell"><a href="javascript:fn_openAtachment2('${genInv.LVL}','${genInv.LVL}');">View</a></td>
									</tr>
									</c:forEach>
								</c:if>
...
if('${dentalDtls}' !=''){
	var softTissue=document.getElementsByName("softTissue");
	var softTissueVal;
	if('${dentalDtls.softTissue}'!='')
	{
		softTissueVal='${dentalDtls.softTissue}'.split("~");
