...
function fn_getDocAvail(){ 
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getDocAvailLst&docType='+document.forms[0].docType.value+'&docSpec='+document.forms[0].docSpec.value;
...
function fn_getDocDetails() 
{
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getDocdetails&regNo='+document.forms[0].docAval.value;
	 xmlhttp.onreadystatechange=function()
	{
	    if(xmlhttp.readyState==4)
	    {	
...
function fn_getSurgeryList()
{
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getSurgeryLst&disMainId='+document.forms[0].docSpec.value+'&disSubId='+document.forms[0].subCategory.value;
	 xmlhttp.onreadystatechange=function()
		{
		    if(xmlhttp.readyState==4)
		    {	
...
function fn_addSurgicalDtls()
{
	...
	else
	{
	 ...
	 url = 'preauthDetails.do?actionFlag=getSurgeryDtls&suregryId='+document.forms[0].surgery.value+'&category='+category+'&subCat='+SubCategory;
	 xmlhttp.onreadystatechange=function()
		{
		    if(xmlhttp.readyState==4)
		    {	
	...
	{
		document.forms[0].action="preauthDetails.do?actionFlag=submitPreauth";
