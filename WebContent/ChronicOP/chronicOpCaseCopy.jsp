...
function fn_sendBack(buttonId){
	...
	{
	document.forms[0].action="ClaimsFlow.do?actionFlag=changeChronicClaimForCases&chronicStatus="+chronicStatus+"&actionDone="+buttonId+"&remarks="+remarks+"&chronicNo="+chronicNo+"&roleId="+roleId;
