...
function fn_attachments()
{
	...
	var url="attachmentAction.do?actionFlag=onload&UpdType=chronicAttach&chronicId=${chronicId}&caseAttachmentFlag=Y&caseApprovalFlag="+caseApprovalFlag;      
	//var url="attachmentAction.do?actionFlag=onload&UpdType=chronicAttach&chronicId=${chronicId}&caseAttachmentFlag=Y&caseApprovalFlag="+caseApprovalFlag+'&errSearchType='+parent.errSearchType+'&disSearchType='+parent.disSearchType+'&module='+parent.module;      
	   document.forms[0].action=url;   
...
{	
	...
	{
   var url="chronicAction.do?actionFlag=casePrintForm&chronicId=${chronicId}&showAll=Y";   
   document.forms[0].action=url;   
   document.forms[0].target="bottomFrame";
   document.forms[0].submit();
		}
...
function fn_clinicalNotes()//076
{
		...
		var url="chronicAction.do?actionFlag=ClinicalNotes";
	   document.forms[0].action=url;   
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit(); 
