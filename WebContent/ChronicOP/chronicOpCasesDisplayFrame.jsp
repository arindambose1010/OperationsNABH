...
<frameset rows="0,100%" frameborder="0"  id="mainFrame">
   ...
   <frame id="topFrame" src="chronicAction.do?actionFlag=chronicOpDtls&chronicId=${chronicId}" name="topFrame"  scrolling="auto"></frame>
   <frame id="leftFrame" src="ChronicOP/chronicOpMenus.jsp" name="leftFrame" scrolling="auto"></frame> 
</frameset>
</html>