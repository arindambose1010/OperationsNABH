...
document.forms[0].action = 'medicalAudit.do?actionFlag=saveAnswers&ques='+result+'&remarks='+resultRem+'&actionType='+actionType;
				...
				if(c==true)
					{
						document.getElementById("wrkFlwBtn").disabled=true;
			 			document.forms[0].action = 'medicalAudit.do?actionFlag=startMedicalAuditWorkFlow';
			 			document.forms[0].submit();
					}
	 		}
}
...
function goToInitiateMedAudit(){
	...
	parent.parent.parent.document.getElementById("middleFrame").src = 'medicalAudit.do?actionFlag=getSampleCasesForAudit&backFlag=yes';
	 //document.forms[0].submit();
	
}
function goBack(){
	
	parent.parent.parent.document.getElementById("middleFrame").src = 'medicalAudit.do?actionFlag=getMAworklist&backFlag=yes';
	 //document.forms[0].submit();
}
...
function auditedCases(){
	...
	parent.parent.parent.document.getElementById("middleFrame").src='medicalAudit.do?actionFlag=getAuditedCaseslist&backFlag=yes';
