...
<%-- document.forms[0].action = 'medicalAudit.do?actionFlag=medicalAuditSearchPage';
document.forms[0].submit(); --%>
 }
 ...
 function getSampleCases(){
	 ...
	 if(verify == true){
	 fn_loadImage();
	 document.forms[0].action = 'medicalAudit.do?actionFlag=getSampleCasesForAudit&backFlag=no';
	 document.forms[0].submit(); }
 ...
 function showCase(caseId){
		...
		document.forms[0].action ='casesApprovalAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&caseSearchType=caseIp&casesForApproval=N&ipOpType=IP&errSearchType=N&disSearchType=N&module=medicalAudit';
		document.forms[0].submit();
	}
