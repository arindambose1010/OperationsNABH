...
function fn_openAtachmentCms(filepath)
{  
...
function fn_testBill(){

		var caseId = document.forms[0].billNum.value;

		url='ClaimsFlow.do?actionFlag=checkBill&caseId='+caseId;	
				...
				if(xmlhttp.readyState==4)
					{
						...
						if(result[0]!=null && result[0]!='')
							{
							alert("Bill No already used for case Id "+result[1] );
							document.forms[0].billNum.value="";
							}
...
function fn_afterMsg(caseStatus){
	...
	var module=parent.parent.module;
	 ...
	 if(module=="drugbreakup"){
        if(autoAction!=null && autoAction=="OnloadCaseOpen") 
        	parent.parent.parent.fn_drugBreakupForApproval(); 
        else
        	parent.parent.parent.fn_drugBreakupForApproval();
	...
	//Claims Medical
	else if(module=="claimMed"){
        if(autoAction!=null && autoAction=="OnloadCaseOpen")
        	parent.parent.fn_casesForApprovalClaimMed();  
        else    
		parent.parent.fn_casesForApprovalClaim();
				}
	 else if(module=="claimOrg"){
			
	        if(autoAction!=null && autoAction=="OnloadCaseOpen")
	        	parent.parent.fn_casesForApprovalOrgClaimNabh();  
	        else    
			parent.parent.fn_casesForApprovalClaim();
					}
	//Claims Surgical
	
	else if(module=="claimSurg"){
        if(autoAction!=null && autoAction=="OnloadCaseOpen")
        	parent.parent.fn_casesForApprovalClaimNew();  
        else    
		parent.parent.fn_casesForApprovalClaim();
...
$.post(url,{'caseId':caseId},function(data){
	  ...
	  $('#drugTable > tbody').html("");
	  var len = jsonData.cardDetails.length;
	  if(len!=0){
			 document.getElementById("drugDiv").html="";
	  for(var k=0;k<len;k++){
		    var x = "<tr>";
...
*/ 			x += "</tr>";
			$('#drugTable > tbody:last-child').append(x);
			$('#drugTable').show();
			$("#drugDiv").show();
	  }
	 } else{
		 $('#drugTable').show();
			$("#drugDiv").show();
		 document.getElementById("drugDiv").innerHTML="<b class='emptyData'><---------No Records Found---------></b>";
	 }
/* 	  
...
{ 
	...
	var caseId = '<bean:write name="claimsFlowForm" property="caseId" />';	
			...
			url='ClaimsFlow.do?actionFlag=getAllUsers&sendBackToPPD='+sendBackToPPD+'&caseId='+caseId;	
...
<body onload="fn_onloadDisabled();blink();">
...
<div class="modal fade" id="viewDtlsID"> 
 <div class="modal-dialog" id="modal-lgx">
  ...
  <div class="modal fade" id="myCmsModal" role="dialog">
...
<table border=0 align="center" width="100%" cellSpacing="1" cellPadding="1">
                           <tr>
                              <td width="100%"class="tbheader1">CMS Audit</td>                       
                         </tr>	
                          <tr>
                             <td>&nbsp</td>                    
                         </tr>	
      <tr><td>
        ...
        <logic:present name="claimsFlowForm" property="cmsAuditDtls">
                <bean:size id="size1" name="claimsFlowForm" property="cmsAuditDtls"/>
                <logic:greaterThan value="0" name="size1">                                 
                   ...
                   <!--      <td class="tbheader1">View Attachment(s)</td> -->
                    ...
                    <logic:iterate id="result" name="claimsFlowForm" property="cmsAuditDtls" indexId="sno">
                        <tr align="left">
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<%=sno+1%></td>
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="EMPCODE"/></td>
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="EMP_FULL_NAME"/></td>
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="DSGN_NAME"/></td>
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="PHONE_NUMBER"/></td>                        
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="CR_REMARKS"/></td>
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="REMARKS_ENTRYTIME"/></td>
                        <td class="tbcellCss"  headerClass="tbheader1" >&nbsp;<bean:write name="result" property="CR_ACTION_TAKEN"/></td>
                         ...
                         <logic:present name="claimsFlowForm" property="attachList">
				         <tr>
                              <td width="100%"class="tbheader1">Attachments</td>                       
                         </tr>	
                         </logic:present>
                         <tr><td>				
			<logic:present name="claimsFlowForm" property="attachList">
                      <bean:size id="size2" name="claimsFlowForm" property="attachList"/>
                    ...
                    <table border=0 align="center" width="100%" cellSpacing="1" cellPadding="1">
                        ...
                        <logic:iterate id="result1" name="claimsFlowForm" property="attachList" indexId="sno">
                        <tr align="center">
                        
                        <td align="center"><a  href="#" onclick="javascript:fn_openAtachmentCms('<bean:write name="result1" property="attachFilePath"/>');" data-toggle="modal" data-target=""><bean:write name="result1" property="attachFileName"/></a>
                        </td> 
...
<logic:notEmpty name="claimsFlowForm" property="cmsRiseFlag">

<table width="95%" style="margin:0 auto">

  <tr><td align="center"><a id="aF" href="#" onclick="javascript:fn_cmsRemarks();" data-toggle="modal" data-target="#myCmsModal"><b style="font-size: 17px;">Contested Case Details for Disallowance </b><span style="font-size: 19px;"  class="glyphicon glyphicon-hand-left" > </span><br>
  </a></td></tr>
  </table>
  </logic:notEmpty>
<table width="95%" style="margin:0 auto">
...
<td width="50%" align="left" class="labelheading1 tbcellCss"><fmt:message key="EHF.Claim.PackAmt"/>:&nbsp;&nbsp;<b><bean:write name="claimsFlowForm" property="packageAmt" /></b>
</td>
<!-- <img id="cal1" border='0' src='images/calend.gif'  alt="Calendar" onClick="CalenderWindowOpen('billDt','430','250')"></img></td> -->
</tr>
<!-- Added by Namratha for showing consumable and drug totals -->
...
<td width="50%" align="left" class="labelheading1 tbcellCss"><b><fmt:message key="EHF.Claim.TotalClaimable"/></b>:&nbsp;&nbsp;<b><bean:write name="claimsFlowForm" property="totalClaimAmt" /></b>
</tr>
</logic:notEqual>
<logic:equal property="medicalSurgFlag" value="IPM" name="claimsFlowForm">
<tr>
<td width="40%" align="left" class="labelheading1 tbcellCss">
<table width="100%">
<tr>
<td align="left" class="labelheading1 tbcellCss"><fmt:message key="EHF.Claim.ConsumableAmt"/>:&nbsp;&nbsp;<b><bean:write name="claimsFlowForm" property="totalConsumableAmount" /></b></td>
<td align="left" class="labelheading1 tbcellCss"><fmt:message key="EHF.Claim.DrugAmt"/>:&nbsp;&nbsp;<b><bean:write name="claimsFlowForm" property="totalDrugAmount" /></b></td>
</tr>
</table>
</td>
...
<c:if test="${pendFlag ne 'Y'}">
<tr >
 <td width="50%"  align="left"  class="labelheading1 tbcellCss">Bill Number<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="billNum"  styleId="billNum" title="Enter Bill Number"  onchange="fn_testBill();"  style="width:50%"/></td>
...
<c:if test="${pendFlag eq 'Y'}">
<tr>
 <td width="50%"  align="left"  class="labelheading1 tbcellCss">Bill Number<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="billNum"  styleId="billNum" title="Enter Bill Number"    style="width:50%"  onchange="fn_testBill();" /></td>
</tr>
</c:if>
...
<%-- <c:if test="${UserRole eq 'GP2' && caseStatus eq 'CD21' }">
...
<c:if test="${UserRole ne 'GP6' }">
<c:set var="cexVerifiedDtls" value="${fn:length(claimsFlowForm.cexVerifiedDtls)}"/>
<logic:greaterThan value="0" name="cexVerifiedDtls">
	<tr><td>
		<table class="tbheader" >
			<tr><td align="center"><b>&nbsp;&nbsp;&nbsp;<fmt:message key="EHF.Title.CosumableDetails"/></b></td></tr>
		</table>
	...
	<tr><td align="center">
		<table width="100%">
			<thead class="tbheader">
				<th> CONSUMABLE TYPE</th>
				<th> COSUMABLE NAME </th>
				<th> MEDCO APPLIED UNITS </th>				
				<th> CEX VERIFIED UNITS </th>				
				<th> UNIT AMOUNT</th>
				<th> TOTAL AMOUNT</th> 	
				<th> CEX REMARKS</th>
				<th> ATTACHMENTS </th>
			</thead>
			<logic:iterate name="claimsFlowForm" property="cexVerifiedDtls" id="investDtls" indexId="index">
				<tr>
					<td class="tbcellBorder"> <bean:write name="investDtls" property="WFTYPE" /></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="NAME"/></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="MEDCO_UNITS"/></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="CEX_UNITS"/></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="UNITAMOUNT"/></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="AMOUNT"/></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="REMARKS"/></td>
					<logic:notEmpty  name="investDtls" property="ATTACH">
						<td class="tbcellBorder"><a href="javascript:fn_openAtachmentMedical('<bean:write name="investDtls" property="ATTACH" />');" >View</a></td>
					</logic:notEmpty>
					<logic:empty  name="investDtls" property="ATTACH">
		...
		<tr><td>
		<table>
		<tr><td colspan="3" class="labelheading1 tbcellCss">CEX Verified Amount&nbsp;
<html:text name="claimsFlowForm" property="cexVerifiedAmt" styleId="cexVerifiedAmt" readonly="true" onchange="validateNumber('Final Approve Amount',this)" title="Enter Final Approve Amount"/>
</td>
</tr>
</table>
	</td></tr>
...
<logic:greaterThan value="0" name="investList">
	...
	<tr><td align="center">
		<table width="100%">
			...
			<logic:iterate name="claimsFlowForm" property="investDetails" id="investDtls" indexId="index">
				<tr>
					<td class="tbcellBorder"> <bean:write name="investDtls" property="WFTYPE" /></td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="NAME"/></td>
					<td class="tbcellBorder">
					<%-- <bean:write name="investDtls" property="COUNT" /> --%>
					<text rows="1" id="medcoAppUnits${index}" name="${investDtls.COUNT}" readonly="readonly">${investDtls.COUNT}</text>
					</td>
					<c:if test="${UserRole ne 'GP2'}">
					<td class="tbcellBorder">
					<text rows="1" id="unitAmount${index}" name="${investDtls.UNITAMOUNT}" readonly="readonly">${investDtls.UNITAMOUNT}</text>
					<%-- <bean:write name="investDtls" property="UNITAMOUNT" /> --%>
					</td>
					<td class="tbcellBorder"><bean:write name="investDtls" property="AMOUNT"/></td>
					<td  class="tbcellBorder">
					<select style="width:100%" id="cexApprvUnits${index}" name="${investDtls.ENH_QUAN_CODE}" title="Please Select The Number of Units to which treatment Done">
					<option value="-1">Select</option>
					<c:forEach begin="0" end="${investDtls.COUNT}" varStatus="stats">
					<option value="${stats.index}">${stats.index}</option>
					</c:forEach>
					</select>
					</td>
					<td class="tbcellBorder">
					<textarea rows="3" maxlength="3000" id="unitstxtArea${index}" name="${investDtls.ENH_QUAN_CODE}" onkeydown="return maxLengthPress(this,3000,event)" onkeypress="return validateSplKeyCodes(event);" onchange="validateSpaces(this,'Remarks')"></textarea>
					</td>
					</c:if> 
					<logic:notEmpty  name="investDtls" property="ATTACH">
						<td class="tbcellBorder"><a href="javascript:fn_openAtachmentMedical('<bean:write name="investDtls" property="ATTACH" />');" >View</a></td>
			...
			<c:if test="${UserRole eq 'GP6'}">
						...
						<td></td>
						<td align="center" >
						<button class="but"  type="button"  value="Total Price" style="margin-left: 100%;" onclick="javascript:fn_partialsave();">Verify</button>
						</td>
						</tr>
						</c:if>
		</table>
...
<logic:greaterThan value="0" name="drugList">
	...
	<c:if test="${claimsFlowForm.caseStatus eq 'CD51'||claimsFlowForm.caseStatus eq 'CD140'||claimsFlowForm.caseStatus eq 'CD94'||claimsFlowForm.caseStatus eq 'CD50'||claimsFlowForm.caseStatus eq 'CD193'||claimsFlowForm.caseStatus eq 'CD98'}">
	<tr><td align="center">
...
<tr>
<td>
<c:if test="${claimsFlowForm.caseStatus ne 'CD51'}">
<logic:equal property="medicalSurgFlag" value="IPM" name="claimsFlowForm">
...
<td align="left"><button class="but" id="addDrug"  type="button" name="addDrug" value="Add Drugs" onclick="fn_getDrugQuant();" data-toggle="modal" data-target="#myModal">View Drugs</button>
</td>
<td>
<button class="but" type="button" name="addAttachments" id="addDrugAttachments" value="Add Attachments"  onclick="javascript:fn_addDrugAttachments()" > View Attachments</button></td>
</tr>
</table>
</logic:equal>
</c:if>
...
<tr ><td colspan="3" class="labelheading1 tbcellCss">
Claim Consumables Amount&nbsp;<font color="red">*</font>:&nbsp;&nbsp;
<html:text name="claimsFlowForm" property="cexVerifiedAmt" styleId="cexVerifiedAmt" readonly="true" onchange="validateNumber('Final Approve Amount',this)" title="Enter Final Approve Amount"/>
</td>
</tr>
</logic:equal>
...
<td width="16%"  class="tbcellBorder"><html:text name="claimsFlowForm" property="deduction" styleId="deduction" style="width:90%" maxlength="7" onchange="validateNumber('Deduction Recommended',this)" title="Enter Deduction Recommended" disabled="true"/></td>
...
<td width="16%"  class="tbcellBorder"><html:text name="claimsFlowForm" property="inputs" styleId="inputs" style="width:90%" maxlength="7" onblur="addToDedcution(inputs)" onchange="validateNumber('Inputs',this)" title="Enter Inputs"/></td>
<td width="16%"  class="tbcellBorder"><html:text name="claimsFlowForm" property="profFee" styleId="profFee" style="width:90%" maxlength="7" onblur="addToDedcution(profFee)" onchange="validateNumber('Professional fee bill',this)" title="Enter Professional fee bill"/></td>
<td width="16%"  class="tbcellBorder"><html:text name="claimsFlowForm" property="investBill" styleId="investBill" style="width:90%" maxlength="7" onchange="validateNumber('Investigation Bill',this)" onblur="addToDedcution(investBill)" title="Enter Investigation Bill"/></td>
</tr>
<tr><td width="16%">&nbsp;</td>
<td width="16%">&nbsp;</td>
...
<td width="30%" align="left" class="labelheading1 tbcellCss"><fmt:message key="EHF.Claims.FAprAmt"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="ctdFinAprAmt" styleId="ctdFinAprAmt" maxlength="7" title="Final Approve Amount" disabled="true" style="width:45%" /></td>
</logic:equal>
</tr>
</table>
</td></tr>
...
<!-- <td width="25%" align="left" class="labelheading1 tbcellCss">NABH Amount&nbsp;<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="chNabhAmt" styleId="chNabhAmt" maxlength="7" title="NABH Amount" disabled="true"/></td>-->
<td width="25%" align="left" class="labelheading1 tbcellCss"><fmt:message key="EHF.Claims.FAprAmt"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="chAprAmt" styleId="chAprAmt" maxlength="7" title="Final Approve Amount" readonly="true" style="width:45%" /></td>
<td width="25%" align="left" class="labelheading1 tbcellCss">Penalty Amount:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="penaltyAmount" styleId="penaltyAmount" maxlength="7" title="Penalty Amount" readonly="true" style="width:45%" /></td>
</tr>
</table>
</td></tr>
<tr><td>
...
<!-- <td width="30%" align="left" class="labelheading1 tbcellCss">NABH Amount&nbsp;<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="eoComNabhAmt" styleId="eoComNabhAmt" maxlength="7" title="NABH Amount" disabled="true"/></td>-->
<td width="30%" align="left" class="labelheading1 tbcellCss"><fmt:message key="EHF.Claims.FAprAmt"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;<html:text name="claimsFlowForm" property="eoComAprAmt" styleId="eoComAprAmt" maxlength="7" title="Final Approve Amount" disabled="true" style="width:45%" /></td>
</tr>
</table>
</td></tr>
<tr><td>
...
{	
	...
	var caseId = '<bean:write name="claimsFlowForm" property="caseId" />';
	var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfClaim&caseId="+caseId+"&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&caseApprovalFlag="+caseAppFlag+"&newBornBaby="+newBornBaby;
...
else
{
 ...
 url = "ClaimsFlow.do?actionFlag=updateSentBackCases&caseId="+caseId+"&caseStatus="+caseStatus+"&remarks="+remarks+"&sendBackFlag="+sendBackFlag+"&moduleType=claims";
 xmlhttp.onreadystatechange=function()
	{
	    if(xmlhttp.readyState==4)
	    {	
...
{
	var caseNo='<bean:write name="claimsFlowForm" property="caseId" />';
...
function fn_onloadDisabled(){
	...
	if(roleId=='<fmt:message key="EHF.Claims.Role.MEDCO"/>' && '${claimsFlowForm.billAmt}'!=null&&pendFlag!='Y'&&errFlag!='Yes'){
...
if(document.getElementById("billNum")!=null)
		document.getElementById("billNum").disabled=true;
...
function fn_buttonClicked(buttonId){
	...
	var errFlag = document.forms[0].dispErrInitBlock.value;
	var errMsg =''; 
	var cmsriseFlag='<bean:write name="claimsFlowForm" property="cmsRiseFlag" />';
	if(cmsriseFlag!=null && cmsriseFlag=='Y'){
		if(deductionClicked==null||deductionClicked==''){
			alert('Please click on "Contest Details for Disallowed Amount " link mentioned at top of this page');
...
if(roleId=='<fmt:message key="EHF.Claims.Role.CPD"/>'||roleId=='<fmt:message key="EHF.Claims.Role.COCCMT"/>' ||roleId=='<fmt:message key="EHF.Claims.Role.ORGCMT"/>')
	...
	if(roleId=='<fmt:message key="EHF.Claims.Role.ACO"/>')
		...
		if (buttonId == '<fmt:message key="EHF.Button.Skip"/>')
		    displayMsg = 'Do you want to skip the case?';
		if (buttonId == '<fmt:message key="EHF.Button.Revert"/>')
		    displayMsg = 'Do you want to revert the case?';
		...
		if (!errMsg == '') {
			...
			url = 'preauthDetails.do?actionFlag=checkMandatoryAttch&caseId='+caseId+'&attachType=ehfClaim&callType=Ajax';
		 xmlhttp.onreadystatechange=function()
			{ 
			    if(xmlhttp.readyState==4)
			    {	
				        ...
				        {	  
				        	...
				        	if(resultArray[0]=="SessionExpired"){
				    		...
				    		else if(resultArray[0] =='success')
				        	   {
				    			...
				    			if(roleId=='<fmt:message key="EHF.Claims.Role.CEX"/>' && buttonId=='CD23')
				    				{
				    					...
				    					var alertCont='';
				    					var count=0;
				    					var size = '${investDtlSize}';
				    					var patientType='${claimsFlowForm.medicalSurgFlag}';
				    					if(patientType != null && patientType == 'IPM' && roleId=='<fmt:message key="EHF.Claims.Role.CEX"/>' && buttonId=='CD23')
				    					{
				    						document.getElementById('caseUnitsPar').value='';
				    						for(var i=0;i<parseInt(size);i++)
				    							{
				    								if(document.getElementById('cexApprvUnits'+i)!=null)
				    									{
				    										if(document.getElementById('cexApprvUnits'+i).value=='-1')
				    											{
				    												alertCont='Please select Actual Treated Units';
				    												focusId='cexApprvUnits'+i;
				    											}
				    									}
						    								...
						    								if(document.getElementById('cexApprvUnits'+i)!=null)
						    									{
						    										if(subVal==null)
						    											{
						    												if(document.getElementById('unitstxtArea'+i).value == '' || document.getElementById('unitstxtArea'+i).value == null)
						    													subVal=document.getElementById('cexApprvUnits'+i).getAttribute("name")+'@'+document.getElementById('medcoAppUnits'+i).getAttribute("name")+'@'+document.getElementById('cexApprvUnits'+i).value+'@'+document.getElementById('unitAmount'+i).getAttribute("name")+'@'+'NA';
						    												else
						    												subVal=document.getElementById('cexApprvUnits'+i).getAttribute("name")+'@'+document.getElementById('medcoAppUnits'+i).getAttribute("name")+'@'+document.getElementById('cexApprvUnits'+i).value+'@'+document.getElementById('unitAmount'+i).getAttribute("name")+'@'+document.getElementById('unitstxtArea'+i).value;
						    											}
						    										else
						    											{
						    											if(document.getElementById('unitstxtArea'+i).value == '' || document.getElementById('unitstxtArea'+i).value == null)
...
{   if(document.getElementById(buttonId)!=null)
   ...
   if(roleId=='<fmt:message key="EHF.Claims.Role.CPD"/>'||roleId=='<fmt:message key="EHF.Claims.Role.COCCMT"/>' ||roleId=='<fmt:message key="EHF.Claims.Role.ORGCMT"/>' ||roleId=='<fmt:message key="EHF.Claims.Role.HUBS"/>'){  
	  ...
	  cpdAprAmt = document.getElementById("cpdAprAmtOrg").value;
	   ...
	   var url ="ClaimsFlow.do?actionFlag=saveClaimDtls&CaseId="+document.forms[0].caseId.value+"&actionDone="+buttonId+"&totalClaim="+totalClaim+"&errClaimFlag="+errFlag+"&deduction="+deduction+"&cpdAprAmt="+cpdAprAmt+"&chNabhAmt="+chNabhAmt+"&chfAprAmt="+chfAprAmt+"&ctdNabhAmt="+ctdNabhAmt+"&ctdFinAprAmt="+ctdFinAprAmt;
	   if(roleId=='<fmt:message key="EHF.Claims.Role.CEX"/>'||roleId=='<fmt:message key="EHF.Claims.Role.COCCEX"/>' ||roleId=='<fmt:message key="EHF.Claims.Role.ORGCEX"/>'){  
...
function validateMedco(errFlag)
{
	...
	<c:forEach var="EHFbutton" items="${buttons}" varStatus="status" >
	if((document.getElementById("billNum").value==null || document.getElementById("billNum").value==''||document.getElementById("billNum").value.trim()==null || document.getElementById("billNum").value.trim()=='') && ('${EHFbutton.VALUE}' != 'Initiate Erroneous Claim'))
	{ 
		if(lField=='')
		lField="billNum";
		if(errMsg=='')  errMsg=errMsg+"Please Enter Bill No <br>";
...
function validateCHList(errFlag,buttonId){
	...
	if(document.getElementById("chEntAprAmt").value==null || document.getElementById("chEntAprAmt").value=='')
...
function validateEOCom(errFlag){
    ...
    var claiminitAmt = document.forms[0].claimInitAmt.value;
    if(parseInt(document.getElementById("eoComEntAprAmt").value*1)>parseInt(claiminitAmt*1))
...
function fn_getPkgAmnt(asriCat,icdCat,procCode,index,seqNo,procName)
{
	...
	else
	{
	 ...
	 url = "ClaimsFlow.do?actionFlag=getUniquePrice&caseId="+caseId+"&caseTherapyId="+caseTherapyId+"&ctdApprv="+ctdApprv;
	 xmlhttp.onreadystatechange=function()
		{
		    if(xmlhttp.readyState==4)
		    {	
...
function fn_partialsave()
{
	...
	else
	{
	 ...
	 url = "ClaimsFlow.do?actionFlag=getTotalPrice&caseId="+caseId+"&roleId="+roleId+"&subVal="+subVal;
	 xmlhttp.onreadystatechange=function()
		{
		    if(xmlhttp.readyState==4)
		    {	
			     ...
			     resultArray = resultArray.split("*");
			        ...
			        {
			        	document.getElementById("cexVerifiedAmt").value=resultArray[0].trim();
			        	//document.getElementById("cexRemark").value= "Claim Consumables amount is Rs."+resultArray[0].trim();
	               		 bootbox.alert("Final price for the selected units is "+resultArray[0].trim());
