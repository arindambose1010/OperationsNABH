...
function fn_caseSearch()
{
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getTdsPaymentRecrds&paymentType="+document.forms[0].paymentType.value;
...
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getTdsPaymentRecrds&paymentType=CD125";
     document.forms[0].submit();
}
...
function fn_payNow(buttonId){
	...
	fn_loadImage();
	document.forms[0].action="ClaimsFlow.do?actionFlag=UpdateTdsClaim&paymentType="+document.forms[0].paymentType.value+"&actionDone="+buttonId+"&tdsStatus="+document.forms[0].caseStatus.value;
    document.forms[0].submit();
}
function checkAll(){
...
function fn_Refresh()
{
	...
	document.forms[0].action="ClaimsFlow.do?actionFlag=getTdsPaymentRecrds&paymentType=CD125&schemeType="+schemeTypeSel;
	document.forms[0].submit();
}
function exportToExcel() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getTdsPaymentRecrds&paymentType="+document.forms[0].paymentType.value+"&genFlag=E";
     document.forms[0].submit();
}
function exportToPdf() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getTdsPaymentRecrds&paymentType="+document.forms[0].paymentType.value+"&genFlag=P";
     document.forms[0].submit();
}
</script>
</head>
...
{
	var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfTDS&caseAttachmentFlag=CP";
