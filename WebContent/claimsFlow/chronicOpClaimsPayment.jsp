...
function viewCaseDtls(caseNo){
	...
	var url="ClaimsFlow.do?actionFlag=getCaseDetails&CaseNo="+caseNo;
...
function viewChronicDtls(chronicId){
	...
	var url="chronicAction.do?actionFlag=casePrintForm&printFlag=N&chronicId="+chronicId+"&type=EoView";
	window.open(url,"claimsPayment",'width=1000,height=800,resizable=yes,top=50,left=100,toolbar=no,minimize=no,status=no,memubar=no,location=no,scrollbars=yes');
}
...
function fn_caseSearch()
{
	...
	if(document.forms[0].showScheme.value=='show'){
   	 if(document.forms[0].schemeType.value==''){
   		 ...
   		 document.forms[0].action="ClaimsFlow.do?actionFlag=getChronicClaimsPaymentRecrds&chronicStatus="+document.forms[0].caseStatus.value+"&schemeType="+document.forms[0].schemeType.value;
		 document.forms[0].submit();}
	}else{	
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getChronicClaimsPaymentRecrds&chronicStatus="+document.forms[0].caseStatus.value;
     document.forms[0].submit();
	}
}
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getChronicClaimsPaymentRecrds";
     document.forms[0].submit();
}
...
function fn_payNow(buttonId){
	...
	fn_loadImage();
	document.forms[0].action="ClaimsFlow.do?actionFlag=changeChronicClaimForCases&chronicStatus="+document.forms[0].caseStatus.value+"&actionDone="+buttonId;
    document.forms[0].submit();
}
...
window.close();
	...
	{
	document.forms[0].action="ClaimsFlow.do?actionFlag=getChronicClaimsPaymentRecrds&schemeType="+schemeTypeSel;
	document.forms[0].submit();
	}
}
function exportToExcel() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getChronicClaimsPaymentRecrds&chronicStatus="+document.forms[0].caseStatus.value+"&genFlag=E";
     document.forms[0].submit();
}
function exportToPdf() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getChronicClaimsPaymentRecrds&chronicStatus="+document.forms[0].caseStatus.value+"&genFlag=P";
     document.forms[0].submit();
}
</script>
</head>
...
function fn_attachments(flag)
{
	...
	var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfClaim&caseAttachmentFlag=CP&flag="+flag+"&folderFlag="+folderFlag;
