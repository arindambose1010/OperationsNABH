...
function viewCaseDtls(caseNo){
	...
	var url="ClaimsFlow.do?actionFlag=getCaseDetails&CaseNo="+caseNo+"&paymentType=ErroneousClaim";
...
function fn_caseSearch()
{
	...
	if(document.forms[0].showScheme.value=='show'){
	   	 if(document.forms[0].schemeType.value==''){
	   		 ...
	   		 document.forms[0].action="ClaimsFlow.do?actionFlag=getErrPaymentRecrds&errStatusId="+document.forms[0].caseStatus.value+"&paymentType=ErroneousClaim&schemeType="+document.forms[0].schemeType.value;
			 document.forms[0].submit();}
		}else{	
			 document.forms[0].action="ClaimsFlow.do?actionFlag=getErrPaymentRecrds&errStatusId="+document.forms[0].caseStatus.value+"&paymentType=ErroneousClaim";
		     document.forms[0].submit();
		}
...
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getErrPaymentRecrds&errStatusId=CD109";
     document.forms[0].submit();
}
...
function fn_buttonClicked(buttonId){
    ...
    document.forms[0].action="ClaimsFlow.do?actionFlag=changeClaimForCases&caseStatus="+document.forms[0].caseStatus.value+"&actionDone="+buttonId+"&paymentType=ErroneousClaim";
    document.forms[0].submit();
}
function checkAll(){
	/*var elements = document.getElementsByClassName("selectableCheckbox");
...
function fn_Refresh()
{
	...
	document.forms[0].action="ClaimsFlow.do?actionFlag=getErrPaymentRecrds&errStatusId=CD109&schemeType="+schemeTypeSel;
	document.forms[0].submit();
}
	function exportToExcel() {
		...
		document.forms[0].action = "ClaimsFlow.do?actionFlag=getErrPaymentRecrds&errStatusId="
				+ document.forms[0].caseStatus.value
...
function fn_attachments(flag)
{
	...
	var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfErr&caseAttachmentFlag=CP&flag="+flag+"&folderFlag="+folderFlag;
