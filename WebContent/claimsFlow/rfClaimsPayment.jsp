...
function fn_caseSearch()
{
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getRfPaymentRecrds";
...
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getRfPaymentRecrds&paymentType=CD125";
     document.forms[0].submit();
}
...
function fn_payNow(buttonId){
	...
	fn_loadImage();
	document.forms[0].action="ClaimsFlow.do?actionFlag=UpdateRfClaim&actionDone="+buttonId+"&RfStatus="+document.forms[0].caseStatus.value;
    document.forms[0].submit();
}
function checkAll(){
...
function exportToExcel() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getRfPaymentRecrds&genFlag=E";
     document.forms[0].submit();
}
function exportToPdf() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getRfPaymentRecrds&genFlag=P";
     document.forms[0].submit();
}
</script>
</head>
