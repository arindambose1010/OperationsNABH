...
function fn_caseSearch()
{
	...
	if(document.forms[0].showScheme.value=='show'){
   	 if(document.forms[0].schemeType.value==''){
   		 ...
   		 document.forms[0].action="ClaimsFlow.do?actionFlag=getClaimsPaymentRecrds&caseStatus="+document.forms[0].caseStatus.value+"&schemeType="+document.forms[0].schemeType.value;
		 document.forms[0].submit();}
	}else{	
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getClaimsPaymentRecrds&caseStatus="+document.forms[0].caseStatus.value;
     document.forms[0].submit();
	}
}
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getClaimsPaymentRecrds&caseStatus=CD93";
     document.forms[0].submit();
}
...
function fn_payNow(buttonId){
	...
	document.forms[0].action="ClaimsFlow.do?actionFlag=changeClaimForCases&caseStatus="+document.forms[0].caseStatus.value+"&actionDone="+buttonId;
    document.forms[0].submit();
}
function checkAll(){
...
function fn_Refresh()
{
	...
	document.forms[0].action="ClaimsFlow.do?actionFlag=getClaimsPaymentRecrds&caseStatus="+caseStatus+"&schemeType="+schemeTypeSel;
	document.forms[0].submit();
}
function exportToExcel() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getClaimsPaymentRecrds&caseStatus="+document.forms[0].caseStatus.value+"&genFlag=E";
     document.forms[0].submit();
}
...
function exportToPdf() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ClaimsFlow.do?actionFlag=getClaimsPaymentRecrds&caseStatus="+document.forms[0].caseStatus.value+"&genFlag=P";
     document.forms[0].submit();
}
</script>
</head>
