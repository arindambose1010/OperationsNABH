...
<frameset rows="0,100%" border="1" id="mainFrame">
   <frame id="topFrame" src="annualCheckUp.htm?actionFlag=viewAhcPrintPage&ahcId=${ahcId}&casesSearchFlag=${casesSearchFlag}" name="topFrame" scrolling="auto"></frame> 
   <frame id="leftFrame" src="AnnualCheckUp/AhcMenus.jsp" name="leftFrame" scrolling="auto"></frame> 
</frameset>
