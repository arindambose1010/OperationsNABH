...
{ 
    ...
    if(checkSimilarUpload(attchcnt,type,'ahcAttachments') == 1 )
    {
        ...
        fn_loadImage();
        document.FileAttachment.action="attachmentAction.do?actionFlag=upldEnrollAttach&actionVal=ahcAttachments&casesSearchFlag=${casesSearchFlag}&ahcId=${ahcId}&UpdType=${UpdType}";
...
function fn_deleteAttachmentsConfirm(result)
{
	...
	document.FileAttachment.action="attachmentAction.do?actionFlag=removeAhcAttachments&UpdType=${UpdType}&ahcId=${ahcId}";
    document.FileAttachment.submit();
	}
</script>
