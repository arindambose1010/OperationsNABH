...
<logic:iterate name="annualCheckUpForm" property="annualList" 	id="annualList">
				...
				<tr>
					<td align="center" colspan="1" class="tbcellBorder"><a href="javascript:openAppl('<bean:write name="annualList" property="patientNo" />')"
						onclick=""><bean:write name="annualList" property="patientNo" /></a></td>
