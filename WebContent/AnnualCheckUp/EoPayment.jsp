...
function viewCaseDtls(ahccId){
	...
	var url="ahcClaimsAction.do?actionFlag=getCaseDetails&ahcId="+ahcId;
...
function fn_caseSearch()
{
	...
	if(document.forms[0].showScheme.value=='show'){
   	 if(document.forms[0].schemeType.value==''){
   		 ...
   		 document.forms[0].action="ahcClaimsAction.do?actionFlag=getClaimsPaymentRecrds&status="+document.forms[0].status.value+"&schemeType="+document.forms[0].schemeType.value;
		 document.forms[0].submit();}
	}else{	
	 document.forms[0].action="ahcClaimsAction.do?actionFlag=getClaimsPaymentRecrds&status="+document.forms[0].status.value;
     document.forms[0].submit();
	}
}
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="ahcClaimsAction.do?actionFlag=getClaimsPaymentRecrds&status=CD93";
     document.forms[0].submit();
}
...
function fn_payNow(buttonId){
	...
	fn_loadImage();
	document.forms[0].action="ahcClaimsAction.do?actionFlag=updateClaimForPayment&status="+document.forms[0].status.value+"&actionDone="+buttonId;
    document.forms[0].submit();
}
function checkAll(){
...
function fn_Refresh()
{
	...
	document.forms[0].action="ahcClaimsAction.do?actionFlag=claimPayments&status=CD385&schemeType="+schemeTypeSel;
	document.forms[0].submit();
}
function exportToExcel() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ahcClaimsAction.do?actionFlag=claimPayments&status="+document.forms[0].status.value+"&genFlag=E";
     document.forms[0].submit();
}
function exportToPdf() {
	...
	if(document.getElementById("toDate").value!="" && document.getElementById("fromDate").value==""){
	 ...
	 document.forms[0].action="ahcClaimsAction.do?actionFlag=claimPayments&status="+document.forms[0].status.value+"&genFlag=P";
     document.forms[0].submit();
}
