...
function loadPrint(){
	var url='annualCheckUpAction.do?actionFlag=printAhcForm&casesSearchFlag=${casesSearchFlag}&ahcId='+'${ahcId}'; 
...
{
	var url="ahcClaimsAction.do?actionFlag=viewAhcAttachments&casesSearchFlag=${casesSearchFlag}&ahcId=${ahcId}";      
...
function fn_claim()
{
	var url="ahcClaimsAction.do?actionFlag=claimsPage&casesSearchFlag=${casesSearchFlag}&ahcId=${ahcId}";	 
	document.forms[0].action=url;   
	document.forms[0].target="bottomFrame";
	document.forms[0].submit(); 
}
