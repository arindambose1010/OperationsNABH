...
<div class="container mainDiv" style="width:91%;">
 ...
 <a href="javascript:fn_viewAttach('${fileList.crId}','${fileList.lineItemNo}')" id='${fileList.attachFileName}'><span title="Click to view attachment" class="labelheading1" style="font-size: 1.25em;">${fileList.attachFileName}</span></a>
 <span>&nbsp;&nbsp;</span>
   </c:forEach> 
 </td>
 </tr>
                ...
                <tr><td>                
                    ...
                    <logic:iterate id="result" name="ceoApprovalsForm" property="signOffActionRemarkList" indexId="sno">
                        ...
                        <logic:equal value="Y" name="result" property="ATTACH_EXISTS">
                            <td class=tbcellCss>&nbsp;
                                <a href="javascript:viewRemarkWiseAttach('<bean:write property="CR_ID" name="result" />','<bean:write property="LINEITEMNO" name="result" />')" title="Please click here to view attachment..." > View Attachments 
                                </a>
                            </td>
                        </logic:equal>
