...
<body >
	<TABLE id="Table1" cellSpacing="0" cellPadding="2" width="500" align="center" border="0">
		<tr>
			<td colspan="2"><img src="images/digital-signature.gif"></td>
		</tr>
		<tr>
			<td colspan="2" background="images/bg-key.gif" height="100" valign=top style="PADDING-TOP: 167PX;background-repeat: no-repeat"><br>
				...
				<TR>
					...
					<TD><a href="javascript:checkAndSubmit()"><img src="images/SIGN-IN.gif" title="Register"/></a></td>
				</TR>
				</TABLE>
			</TD>
		</TR>
