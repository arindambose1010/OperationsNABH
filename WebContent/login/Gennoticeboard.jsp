...
function test(){
	...
	var xmlhttp;
	   ...
	   else
	   {
	    ...
	    url ="loginAction.do?actionFlag=getcontactDetails";
	       ...
	       {	
	           ...
	           {	
                   ...
                   if(arr[1]!=null && arr[0]!=null)
                   {
                       ...
                       s='<p style="text-align:right"><a href="javascript:edit()"><img src="images/edit.png" title="Edit" style="no-repeat #fff; height:22px; width:22px; vertical-align:middle; border:0;"></a></p>';
...
function getEnrolledRep(){
	...
	var xmlhttp;
	   ...
	   else
	   {
	    ...
	    url ="loginAction.do?actionFlag=getEnrolledDetails";
...
function edit(){
	...
	document.getElementById("updatePage").src='editEmpDtlsAction.do?actionFlag=onLoad';
...
<div id="popupEditEmpDtls"   style="width: 450px; height:430px;"  >  
    <a id="popupEditEmpDtlsClose" ><img  src="images/fileclose.png"/></a>
    <br>
