...
<link href="css/themes/<%=themeColour%>/commonEhfCss.css"
	rel="stylesheet" type="text/css" media="screen">
<link href="css/themes/<%=themeColour%>/style.css"
	rel="stylesheet" type="text/css" media="screen">
...
function fn_htmlPages()
{
	...
	document.getElementById("menuFramePage").src='loginAction.do?actionFlag=getMenus&loginType='+document.forms[0].loginType.value;
	redirectDefaultPage();
}
function redirectDefaultPage(){
	...
	if('${roleName}' != "" && '${roleName}' == 'Pensioner')
		{
		document.getElementById("middleFrame").src='login/PensionerInstructions.jsp';
		}
	...
	{
		document.getElementById("middleFrame").src='login/EmployeeInstructions.jsp';	
	}
	else if('${roleName}' != "" && '${roleName}' == 'DDO')
	{
		
		document.getElementById("middleFrame").src='empEnrolmntAction.do?actionFlag=getDDOPendingData';	
	}
	...
	{
		document.getElementById("middleFrame").src='login/LoginFramePage.jsp';
	}
