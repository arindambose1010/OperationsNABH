...
function fn_getManuals(id)
{
	...
	var url = "trainingMaterialsAction.do?actionFlag=getManuals&id="+id;
...
<ul class="tabs"> 
	...
	<div id="view1"> 
		<div class="faq"><ul>
				...
				<li><a >Who will do the registration in hospital ?</a>
				...
				<li><a >How can I recognize Aarogyamithra ?</a>
		...
		<p style="float:right;"><a id="FAQ">More</a></p>
	</div> 
	<div id="view2"> 
		<div class="training">
			<ul>
...
<ul class="rightLinks"> 
    ...
    <li><a  id="KC"><img src="../images/s_KC.jpg" alt="Knowledge Centre" style="margin-left:5px;"/></a></li>
	<li><a id="104Services"><img src="../images/needhelp.jpg" alt="Need Help" style="margin-left:5px"/></a></li>
   </ul>  
</div>
<div class="Clear">&nbsp;</div>
</div>  
