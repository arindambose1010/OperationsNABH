...
function fn_emailSubscription(){		
	var url='requestInfo.do?actionFlag=emailSubscription';				
...
function test(){
	   ...
	   xmlhttp.onreadystatechange=function()
	   {
	       ...
	       {	
	           ...
	           {	
                 ...
                 if(arr[1]!=null && arr[0]!=null)
                 {
                    ...
                    // s=s+'<tr><tr><tr><td></td><td></td><td><a href="javascript:edit()"><img src="images/editProfile.png" title="Edit" style="no-repeat #fff; height:25px; width:40px; vertical-align:middle; border:0;"></a></td></tr></table>';
	    ...
	    var url ="loginAction.do?actionFlag=getcontactDetailsForEhfmUsers"; 
...
<div id="PenInst_left">
   <div id="pen_profile">
   <div id="pen_profile_top" style="background:url('images/profile_top.png');height:23px;width:211px;"></div>
   <div id="pen_profile_middle" style="background:url('images/profile_middle.png');width:211px;">
   <div id="ajaxDiv">
    ...
    <div id="pen_profile_bottom" style="background:url('images/profile_bottom.png');height:22px;width:211px;"></div>
   </div>
   <ul id="PenInfo_links">
	<li><a >
	<img title="IT Helpline"  src="images/IThelpline.jpg"  alt="IT Helpline"></a></li>
    </ul>
...
<div id="PenInst_right">
  <div id="PenInst_CMmsg">
   <!--<p id="PenInst_cmphoto"><img src="images/CM2.png" alt="Chief Minister" /></p>-->
...
<script src="js/genafterlogin.js" type="text/javascript"></script>  
</body>
</html>