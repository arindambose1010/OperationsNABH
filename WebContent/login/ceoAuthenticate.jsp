 ...
 xmlhttp.onreadystatechange=function()
   {
	...
	url = 'loginAction.do?actionFlag=generateOTP&callType=Ajax&mobileNum='+mobileNum;
...
if(otp!=null){
	...
	if(document.getElementById("digiVerify").checked)
	{
		...
		document.forms[0].action='loginAction.do?actionFlag=checkLogin&digiCheck=Y' ;
...
else
{
	...
	document.forms[0].action='loginAction.do?actionFlag=checkLogin&otpCheck=Y';
...
<div class="container login">
  	...
  	<img src="images/lock1.png" style="width:25px;height:25px;"><label id="signIn">Sign In</label>
  </div>
  	</div>
	<br><br>
