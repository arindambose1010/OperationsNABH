...
{
    document.forms[0].action="loginAction.do?actionFlag=reloadPage";
	document.forms[0].submit();
}
...
function fn_changePassword() {
  ...
  //Added by G.Namratha for admin sanction workflow
  	...
  	{
  		fn_loadImage();
  		document.getElementById("middleFrame").src='adminSanction.do?actionFlag=sanctionForm';
  	}
  	function fn_sancWorkFlow()
  	{
  		fn_loadImage();
  		document.getElementById("middleFrame").src='adminSanction.do?actionFlag=sanctionWorkflow&userId=${UserID}';
  	}
  	function fn_sancStatus()
  	{
  		
  		document.getElementById("middleFrame").src='adminSanction.do?actionFlag=viewSanctionStatus';
  	}	

  	function fn_dashboard()
  	{
  		
  		document.getElementById("middleFrame").src='adminSanction.do?actionFlag=getDashBoard';
  	}

  	function fn_operations()
  	{
  		
  		document.getElementById("middleFrame").src='casesSearchAction.do?actionFlag=OnloadCaseSearch&caseSearchType=caseIp&casesForApproval=Y&module=preauth&ceoFlag=Y';
  	}
function fn_refresh()
{
...
function fn_ceoWorkList(){
	//fn_loadImage();
	document.getElementById("middleFrame").src='CeoWorkListAction.do?actionVal=GETCEOWORKLIST';
}
function fn_othrStateCeoWorkList(){
	//fn_loadImage();
	document.getElementById("middleFrame").src='CeoWorkListAction.do?actionVal=GETCEOWORKLIST&menu=othrSt';
}
function fn_ceoEDCWorkList(){	
	document.getElementById("middleFrame").src='CeoWorkListAction.do?actionVal=GETEDCCEOWORKLIST';		
}
function fn_PendingAprvl()
{
	//fn_loadImage();
 	document.getElementById("middleFrame").src='ceoWorklist.do?flag=pendingApprvls';
}
  ...
  <div class="modal-dialog"> 
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="themes">
        <li class="theme1"><a href="fn_changeTheme('default');" >default</a></li>
        <li class="theme2"><a href="fn_changeTheme('navyblue');" >blue</a></li>
        <li class="theme3"><a href="fn_changeTheme('darkgreen');" >green</a></li></ul>
      </div>
