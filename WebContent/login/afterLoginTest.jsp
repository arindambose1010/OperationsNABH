	 ...
	 xmlhttp.onreadystatechange=function()
		{
	 	...
	 	url = 'loginAction.do?actionFlag=saveLoginDtls&idAdress='+ip;
...
{	
	var url = "/OperationsNABH/trainingMaterialsAction.do?actionFlag=getManuals&id="+id;
...
{
	var url = "/OperationsNABH/trainingMaterialsAction.do?actionFlag=dentalGuidelines&id="+id;
	window.open(url,'opManuals','width=700, height=450, top=80,left=80,toolbar=no,resize=no,scrollbar=no');	
}
...
<div>
	...
	<div id="noticeboard" class="pull-right col-xs-12 col-sm-12 col-md-9 col-lg-9">
	  ...
	  <c:if test="${showMessageAP eq 'Y' }">
        ...
        <div><a href="fn_dentalGuidelines(this.id)" id="Dental Guidelines" title="Dental Guidelines Manual(PDF that opens in a new window)"><b><font color="#005000">Guidelines to NWHs regarding Dental Specialty (S18).Click here To Download</font></b></a></div>
		</marquee>
		</c:if>
	...
	<c:if test="${showMessageTG eq 'Y' }">
        ...
        <div>
        	<c:if test="${hospDentType eq 'clinic' || hospDentType eq 'hospital' }">
	        	<a href="fn_NWHGuidelines(this.id)" id="Gudielines03_03_2016" title="Revised Dental Guide lines(PDF that opens in a new window)"><b><font color="#005000">Revised Dental Guide lines (Click here for details) </font></b></a>
	        	<a href="fn_NWHGuidelines(this.id)"  id="utilizationGuidelines" title="Revised Dental Guide lines AnnexureII(PDF that opens in a new window)"><b><font color="#005000">(Click here for AnnexureII) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></b></a>
	        </c:if>	
        	 <a href="fn_NWHGuidelines(this.id)" id="EHS" title="NWH Guidelines Manual(PDF that opens in a new window)"><b><font color="#005000">05.10.2015:Circular for all NWH empanelment of all available specialities in the NWHs under Aarogyasri and EHS(click here for details)</font></b></a> 
        </div>
		</marquee>
		</c:if> 
...
<c:if test="${showMessageTG eq 'Y' }">
	...
	<c:if test="${openAM eq 'N'}">
		...
		<marquee SCROLLAMOUNT=3 onmouseover="this.stop();"  onmouseout="this.start();">
        <div><a href="fn_dentalGuidelines(this.id)" id="Dental Guidelines" onclick="fn_dentalGuidelines(this.id)" title="Dental Guidelines Manual(PDF that opens in a new window)"><b><font color="#005000">Guidelines to NWHs regarding Dental Specialty (S18).Click here To Download</font></b></a></div>
		</marquee>
		</c:if>
		...
		<c:if test="${isMedco eq 'Y' }">
			<li><span class="glyphicon glyphicon-chevron-right arrow"></span><b style="color:black;">NOTE:Please download the circular <a href="javascript:fn_getManuals(this.id)" id="SCA" style="color:red;">SCA extension up to 15.08.2016</a></b><img src="images/new-icon.gif" alt="New" height="22" width="35"></li>
			<li><span class="glyphicon glyphicon-chevron-right arrow"></span><b style="color:black;">NOTE:Please download the circular<a href="fn_getManuals(this.id)" id="Circular" style="color:red;"> Fraud Alert : Charity Scams</a></b><img src="images/new-icon.gif" alt="New" height="22" width="35"></li>
			</c:if>
			<li><span class="glyphicon glyphicon-chevron-right arrow"></span>Preauthorizations kept pending has to be updated within 30 days, otherwise Pre authorization request  will be auto cancelled.  </li>
		    <li><span class="glyphicon glyphicon-chevron-right arrow"></span>For Pre authorization approved cases, surgery has to be updated in 30 days, otherwise pre authorization approval will be auto cancelled. </li>
		    <li><span class="glyphicon glyphicon-chevron-right arrow"></span>Surgery updated cases has to discharged in 60 days, otherwise case will be auto cancelled</li>	
...
<div class="panel-group pull-right col-xs-12 col-sm-12 col-md-8 col-md-8" id="accordion">
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in"> 
      <div class="panel-body">
        <ul>
				<li><span class="glyphicon glyphicon-chevron-right arrow"></span><a >What is Registration ?</a>
				...
				<li><span class="glyphicon glyphicon-chevron-right arrow"></span><a >Who will do the registration in hospital ?</a>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse">
      ...
      <ul>
				<li><a href="fn_getManuals(this.id)" id="Claims Processing"  title="Claims Processing(PDF that opens in a new window)"> 1. Claims Processing material</a></li>
				<li><a href="fn_getManuals(this.id)"  id="Followup Claims" title="Followup Claims(PDF that opens in a new window)"> 2. Followup Claims material</a></li>
				<li><a href="fn_getManuals(this.id)"  id="Registration Usermanual" title="Registration Usermanual(PDF that opens in a new window)"> 3. Registration  material</a></li>
				<li><a href="fn_getManuals(this.id)"  id="IP and OP Registration and Preauthorisation Process" title="IP & OP Registration and Preauthorisation(PDF that opens in a new window)"> 4. IP and OP Registration and Preauthorisation Process material</a></li>
				<li><a href="fn_getManuals(this.id)" id="Chronic OP User Manual" title="Chronic OP User Manual(PDF that opens in a new window)"> 5. Chronic OP User Manual</a></li>
				<li><a href="fn_getManuals(this.id)" id="Preauth - Enhancement" title="Preauth - Enhancement Manual(PDF that opens in a new window)">6. Preauth - Enhancement</a></li>
