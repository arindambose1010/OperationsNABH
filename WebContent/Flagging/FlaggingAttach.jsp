	...
	function openAttach(caseId,flagId,flagDocId)
		{
		 	...
		 	var url = "flaggingAction.do?actionFlag=getAttachments&caseId="+caseId+"&flagId="+flagId+"&flagDocId="+flagDocId;
			...
			/* document.forms[0].action="flaggingAction.do?actionFlag=getAttachments&caseId="+caseId+"&flagId="+flagId+"&flagDocId="+flagDocId;
						...
						<logic:iterate name="flagAttachments" id="flagAttach" indexId="eid">
							<tr>
								<td class="labelheading1 tbcellCss" align="center" >
									<font color="black"><%= eid.intValue()+1 %>.</font><a href="javascript:openAttach('<bean:write name="flagAttach" property="caseId"/>',
