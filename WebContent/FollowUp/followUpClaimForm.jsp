...
var url="followUpAction.do?actionFlag=printDTRS&followUpId="+document.forms[0].followUpId.value+"&caseId="+document.forms[0].caseId.value+"&scheme_id="+scheme_id;
...
{
var scheme_id= '${scheme_id}';
var url="followUpAction.do?actionFlag=printPrescription&followUpId="+document.forms[0].followUpId.value+"&caseId="+document.forms[0].caseId.value+"&scheme_id="+scheme_id;
window.open(url,"",'width=1150,height=600,resizable=yes,top=100,left=0,titlebar=no,menubar=no,toolbar=no,scrollbars=yes');
}
...
document.forms[0].action="followUpAction.do?actionFlag=caseSearch&refreshFlag=Y&casesForApproval="+caseApprovalFlag+"&viewFlag=N&patientScheme="+patientScheme;
...
var url='followUpAction.do?actionFlag=getFollowUpDtls&CaseId='+caseId+'&backFlg=N&followUpid='+followUPId+'&viewFlag=Y';
//document.forms[0].submit();
...
var url = "followUpAction.do?actionFlag=viewClinicalData&followUpId="+document.forms[0].followUpId.value;
...
<tr>
<td >
<a href="javascript:this.style.color = 'brown';fn_openAtachment('<bean:write name="result" property="savedName"/>','<bean:write name="result" property="savedName"/>');return false;"><bean:write name="result" property="actualName"/></a>
</td>
</tr>
</c:if>
</logic:iterate>
...
<tr>
<td >
<a href="javascript:this.style.color = 'brown';fn_openAtachment('<bean:write name="resultC" property="savedName"/>','<bean:write name="resultC" property="savedName"/>');return false;"><bean:write name="resultC" property="actualName"/></a>
</td>
</tr>
</c:if>
</logic:iterate>
...
<tr>
<td>
<a href="javascript:this.style.color = 'brown';fn_openAtachment('<bean:write name="resultD" property="savedName"/>','<bean:write name="resultD" property="savedName"/>');return false;"><bean:write name="resultD" property="actualName"/></a>
</td>
</tr>
</c:if>
</logic:iterate>
...
<tr>
<td >
<a href="javascript:this.style.color = 'brown';fn_openAtachment('<bean:write name="resultE" property="savedName"/>','<bean:write name="resultE" property="savedName"/>');return false;"><bean:write name="resultE" property="actualName"/></a>
</td>
</tr>
</c:if>
</logic:iterate>
...
else
{
 ...
 url = "followUpAction.do?actionFlag=updateSentBackCases&followupId="+followupId+"&followupStatus="+followupStatus+"&remarks="+remarks+"&sendBackFlag="+sendBackFlag+"&moduleType=followUp";
...
{
var caseApprovalFlag = '${casesForApproval}';
var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfFollowUp&followupId="+document.forms[0].followUpId.value+"&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&caseApprovalFlag=Y";
...
url = 'followUpAction.do?actionFlag=checkMandatoryAttch&followUpId='+document.forms[0].followUpId.value+'&attachType=ehfFollowUp&callType=Ajax';
 xmlhttp.onreadystatechange=function()
{ 
if(xmlhttp.readyState==4)
{
...
document.forms[0].action="followUpAction.do?actionFlag=saveFollowupClaim&followUpid="+document.forms[0].followUpId.value+"&CaseId="+document.forms[0].caseId.value+"&clinicalId="+document.forms[0].clinicalId.value+"&actionDone="+buttonId+"&casesForApproval="+caseApprovalFlag+"&OnloadCaseOpen="+OnloadCaseOpen; 
document.forms[0].submit(); 
}
