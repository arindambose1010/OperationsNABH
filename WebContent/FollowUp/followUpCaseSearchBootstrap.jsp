...
return false;
        ...
        document.forms[0].action="followUpAction.do?actionFlag=saveFollowupClaimCh&actionDone="+buttonId;
...
{		
	document.forms[0].action='followUpAction.do?actionFlag=getCaseDtls&CaseId='+caseId+'&status='+arg;		
	document.forms[0].submit();
}
function fn_openFollowUpDtls(caseId,followUPId){

	document.forms[0].action='followUpAction.do?actionFlag=getFollowUpDtls&CaseId='+caseId+'&followUpid='+followUPId+'&casesForApproval='+document.forms[0].casesForApprovalFlag.value+'&viewFlag=Y';	
	document.forms[0].submit();
}
...
function caseSearch(button)
	...
	if(document.forms[0].followUpStatus.value=='' &&
				...
				{	
		            if(document.forms[0].showScheme.value=='show'){	
		                  if(document.forms[0].schemeType.value==''){
                              ...
                              if(pendingFlag=="Y")
                            	  document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y&schemeType="+document.forms[0].schemeType.value+"&patientScheme="+patientScheme+"&pendingFlag="+pendingFlag;
                            	  else
		                	      document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y&schemeType="+document.forms[0].schemeType.value+"&patientScheme="+patientScheme;
		                      document.forms[0].submit();
		                      }}else{
		...
		return;
				...
				if(document.forms[0].showScheme.value=='show'){
					 ...
					 if(pendingFlag=="Y")
					 document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y&patientScheme="+patientScheme+"&pendingFlag="+pendingFlag;
					 else
					 document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y&patientScheme="+patientScheme;
						}
         document.forms[0].submit();
				}
	}
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=N&patientScheme="+patientScheme;
     document.forms[0].submit();
	}
