...
function viewCaseDtls(followUpId,caseId,cochlearYN){
	...
	if(cochlearYN=='Y')
		...
		url="followUpAction.do?actionFlag=getFpCaseDetails&FollowUpId="+followUpId+"&caseId="+caseId+"&cochlearYN="+cochlearYN;
...
function fn_caseSearch()
{
	...
	if(flpArr[1]!=null && flpArr[1]=='Cochlear')
		cochlearSearch='Y';
	 document.forms[0].action="followUpAction.do?actionFlag=getFPPaymentRecrds&followUpStatus="+flpArr[0]+"&cochlearSearch="+cochlearSearch;
...
function fn_reset()
{
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="followUpAction.do?actionFlag=getFPPaymentRecrds&followUpStatus=CD104";
     document.forms[0].submit();
}
...
function fn_payNow(buttonId){
	...
	fn_loadImage();
	document.forms[0].action="followUpAction.do?actionFlag=changeFPClaimForCases&followUpStatus="+document.forms[0].followUpStatus.value+"&actionDone="+buttonId;
    document.forms[0].submit();
}
function checkAll(){
	/*var elements = document.getElementsByClassName("selectableCheckbox");
...
function fn_Refresh()
{
	...
	if(flpStat=='' ||flpStat==null)
		flpStat='CD140';
	 document.forms[0].action="followUpAction.do?actionFlag=getFPPaymentRecrds&followUpStatus="+flpStat+"&schemeType="+schemeTypeSel;
		document.forms[0].submit();
	}
	...
	function exportToExcel() {
		...
		if(document.getElementById("followUpStatus").value=="" ){
		 ...
		 document.forms[0].action="followUpAction.do?actionFlag=getFPPaymentRecrds&followUpStatus="+document.forms[0].followUpStatus.value+"&genFlag=E";
	     document.forms[0].submit();
	}
	function exportToPdf() {
		if(document.getElementById("followUpStatus").value=="" ){
		 ...
		 document.forms[0].action="followUpAction.do?actionFlag=getFPPaymentRecrds&followUpStatus="
...
<div id="processImagetable" style="width:100%;position:absolute;z-index:60;height:100%;display: none">
	...
	function fn_attachments(flag) {
		...
		var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfFollowUp&caseAttachmentFlag=CP&flag="
