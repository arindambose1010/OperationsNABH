		...
		function fn_attachments()
			{	
				...
				if(casesForApproval!=null && casesForApproval=='Y')
					cochRem='${cochRem}';
				var url = "attachmentAction.do?actionFlag=onload&UpdType=ehfCochlearFollowUp&cochFollowupId=${followUpId}&caseAttachmentFlag=Y&PreauthFlag=N&openWin=Y&cochRem="+cochRem+"&caseApprovalFlag=${casesForApproval}&cochCount="+cochCount;
