...
function caseSearch(button)
	...
	if(document.forms[0].followUpStatus.value=='' &&
				...
				{	
		            if(document.forms[0].showScheme.value=='show'){	
		                  if(document.forms[0].schemeType.value==''){
		                	  ...
		                	  document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y&schemeType="+document.forms[0].schemeType.value;
		                      document.forms[0].submit();
		                      }}else{
		...
		return;
		 ...
		 document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y&schemeType="+document.forms[0].schemeType.value;
					...
					document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=Y";
					}
         document.forms[0].submit();
				}
	}
	...
	document.getElementById("toDate").value="";
	 ...
	 document.forms[0].action="followUpAction.do?actionFlag=caseSearch&searchFlag=N";
     document.forms[0].submit();
	}
